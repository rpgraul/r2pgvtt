...
- [ ] **Task 1: Ajuste do `tables.ts` (Single Source of Truth)**
...
- [ ] **Task 2: Ajuste do `gameState.svelte.ts` (Sincronização)**
...
-[ ] **Task 3: Ajuste do `diceStore.svelte.js` (Lógica Centralizada)**
...
-[ ] **Task 4: Limpeza drástica nos Componentes de UI (Fim das Duplicações)**
