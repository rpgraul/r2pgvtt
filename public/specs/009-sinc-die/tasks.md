...
- [x] **Task 1: Limpeza do Supabase e Layout (`tables.ts` e `+layout.svelte`)**
...
- [x] **Task 2: Refatorar o Room Channel (`gameState.svelte.ts`)**
...
- [x] **Task 3: Atualizar o Alerta Remoto (`diceStore.svelte.js`)**
...
- [x] **Task 4: Propagar a Cor nas Rolagens (`ChatSidebar`, `FAB`, `DiceRoller`)**
