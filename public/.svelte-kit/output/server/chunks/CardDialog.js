...
function RichTextEditor($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<!--]--> <div class="prose prose-invert max-w-none p-4 min-h-[200px] focus:outline-none"></div></div> `);
    {
      $$renderer2.push("<!--[-1-->");
    }
    $$renderer2.push(`<!--]-->`);
          ...
          DialogContent($$renderer4, {
            ...
            children: ($$renderer5) => {
              DialogTitle($$renderer5, {
                children: ($$renderer6) => {
                  $$renderer6.push(`<!---->${escape_html(editItem ? "Editar Card" : "Criar Card")}`);
                },
                $$slots: { default: true }
              });
              $$renderer5.push(`<!----> `);
              DialogDescription($$renderer5, {
                children: ($$renderer6) => {
                  $$renderer6.push(`<!---->Preencha os detalhes do card. Use o editor de texto para formatar o conteúdo.`);
                },
                $$slots: { default: true }
              });
              $$renderer5.push(`<!----> <div class="space-y-4 py-4"><div class="space-y-2"><label class="text-sm font-medium" for="card-title">Título</label> `);
              Input($$renderer5, {
                id: "card-title",
              ...
              $$renderer5.push(`<!----></div> <div class="grid grid-cols-2 gap-4"><div class="space-y-2"><label class="text-sm font-medium" for="card-category">Categoria</label> `);
              Select($$renderer5, {
                id: "card-category",
                items: categories,
                get value() {
              ...
              $$renderer5.push(`<!----></div> <div class="space-y-2"><label class="text-sm font-medium" for="card-tags">Tags</label> `);
              Input($$renderer5, {
                id: "card-tags",
              ...
              $$renderer5.push(`<!----></div></div> <div class="space-y-2"><label class="text-sm font-medium" for="card-image">URL da Imagem</label> `);
              Input($$renderer5, {
                id: "card-image",
                placeholder: "https://...",
                get value() {
              ...
              if (imagemUrl) {
                $$renderer5.push("<!--[0-->");
                $$renderer5.push(`<div class="aspect-video w-full max-w-xs mx-auto rounded-lg overflow-hidden bg-muted"><img${attr("src", imagemUrl)} alt="Preview" class="w-full h-full object-cover"/></div>`);
              } else {
                $$renderer5.push("<!--[-1-->");
              }
              ...
              $$renderer5.push(`<!----> <label class="text-sm" for="card-visibility">Visível para jogadores</label></div> <div class="space-y-2"><label class="text-sm font-medium">Conteúdo</label> `);
              ...
              $$renderer5.push(`<!----></div></div> <div class="flex justify-between pt-4 border-t"><div>`);
              if (editItem) {
                $$renderer5.push("<!--[0-->");
                Button($$renderer5, {
                  variant: "destructive",
