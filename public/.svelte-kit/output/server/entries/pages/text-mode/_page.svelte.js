...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    function $$render_inner($$renderer3) {
      $$renderer3.push(
        `<main class="container px-4 py-6 h-[calc(100vh-64px)]"><div class="flex items-center justify-between mb-6"><h1 class="text-2xl font-bold">Notas</h1> <div class="flex gap-2">`,
      );
      Button($$renderer3, {
      ...
      $$renderer3.push(
        `<!----></div></div> <div class="grid grid-cols-1 md:grid-cols-4 gap-6 h-[calc(100%-80px)]"><div class="md:col-span-1 h-full"><div class="rounded-lg border bg-card h-full flex flex-col"><div class="p-3 border-b flex items-center justify-between"><h2 class="font-semibold flex items-center gap-2">`,
      );
            ...
            for (
              ...
              if (item.tags && item.tags.length > 0) {
                ...
                for (
                  ...
                  $$renderer4.push(
                    `<span class="text-xs bg-muted px-1.5 py-0.5 rounded">${escape_html(tag)}</span>`,
                  );
                }
                $$renderer4.push(`<!--]--></div>`);
              } else {
      ...
      $$renderer3.push(`<!----></div></div> <div class="md:col-span-3 h-full">`);
      {
        $$renderer3.push('<!--[-1-->');
        $$renderer3.push(
          `<div class="rounded-lg border border-dashed p-12 text-center h-full flex items-center justify-center"><div>`,
        );
        File_text($$renderer3, { class: 'w-16 h-16 mx-auto text-muted-foreground mb-4' });
        $$renderer3.push(
          `<!----> <p class="text-muted-foreground">Selecione uma nota para editar</p></div></div>`,
        );
      }
