import { c as pe, a as L, f as Be, t as ot } from './wRaPAkex.js';
import { o as Ud, a as qd } from './DiGqoWnr.js';
import {
  h as G,
  p as kn,
  c as V,
...
import { d as Bi, a as _i } from './CnkBgILj.js';
import { i as gr } from './CctNoNeD.js';
import { a as fs, c as hs, b as ps, s as ms, i as Jd, B as Y, r as Gd } from './DgSRL2mV.js';
import { b as Xd } from './CeCyYOpZ.js';
import { b as Yd } from './DLhqrG2k.js';
import { l as ke, s as xe, p as dn } from './DQIjwT0e.js';
import { I as Qe } from './CUvZ4cP1.js';
import './sV_nQZLa.js';
import { I as ve, s as Se } from './C6o-dkjc.js';
function Qd(n, e) {
...
function sa(n, e, t) {
  for (let r = 0; ; r++) {
    ...
    if (s.content.size || i.content.size) {
      let o = sa(s.content, i.content, t + 1);
      if (o != null) return o;
    }
    t += s.nodeSize;
  }
...
class b {
            ...
            : l.isLeaf
              ? s
                ...
                : l.type.spec.leafText
                  ...
                  : ''
              : '';
          l.isBlock && ((l.isLeaf && c) || l.isTextblock) && r && (o ? (o = !1) : (i += r)),
            (i += c);
        },
        0,
      ),
  ...
  append(e) {
    ...
    let t = this.lastChild,
      ...
      i = 0;
    for (
      t.isText && t.sameMarkup(r) && ((s[s.length - 1] = t.withText(t.text + r.text)), (i = 1));
      i < e.content.length;
      i++
    )
      s.push(e.content[i]);
  ...
  findIndex(e) {
    ...
    for (let t = 0, r = 0; ; t++) {
      let s = this.child(t),
        i = r + s.nodeSize;
      if (i >= e) return i == e ? sr(t + 1, i) : sr(t, r);
      r = i;
    }
  }
  toString() {
  ...
  static from(e) {
    ...
    if (e.attrs) return new b([e], e.nodeSize);
...
function Sr(n, e) {
  ...
  if (t) {
    ...
    for (let r = 0; r < n.length; r++) if (!Sr(n[r], e[r])) return !1;
  } else {
    for (let r in n) if (!(r in e) || !Sr(n[r], e[r])) return !1;
...
let U = class ci {
  ...
  addToSet(e) {
    ...
    for (let s = 0; s < e.length; s++) {
      ...
      if (this.type.excludes(i.type)) t || (t = e.slice(0, s));
        ...
        !r && i.type.rank > this.type.rank && (t || (t = e.slice(0, s)), t.push(this), (r = !0)),
          t && t.push(i);
      }
    }
  ...
  eq(e) {
    return this == e || (this.type == e.type && Sr(this.attrs, e.attrs));
  }
  toJSON() {
  ...
  static setFrom(e) {
    if (!e || (Array.isArray(e) && e.length == 0)) return ci.none;
...
class w {
  ...
  removeBetween(e, t) {
    return new w(
      oa(this.content, e + this.openStart, t + this.openStart),
      this.openStart,
      this.openEnd,
    );
  }
  ...
  static maxOpen(e, t = !0) {
    ...
    for (let i = e.firstChild; i && !i.isLeaf && (t || !i.type.spec.isolating); i = i.firstChild)
      r++;
    for (let i = e.lastChild; i && !i.isLeaf && (t || !i.type.spec.isolating); i = i.lastChild) s++;
    return new w(e, r, s);
  }
}
...
function oa(n, e, t) {
  ...
  return n.replaceChild(r, i.copy(oa(i.content, e - s - 1, t - s - 1)));
}
function la(n, e, t, r) {
  ...
  let l = la(o.content, e - i - 1, t, o);
  return l && n.replaceChild(s, o.copy(l));
}
function gu(n, e, t) {
  if (t.openStart > n.depth) throw new Mr('Inserted content deeper than insertion position');
  if (n.depth - t.openStart != e.depth - t.openEnd) throw new Mr('Inconsistent open depths');
  return aa(n, e, t, 0);
}
function aa(n, e, t, r) {
  let s = n.index(r),
  ...
  if (s == e.index(r) && r < n.depth - t.openStart) {
    ...
    if (!t.openStart && !t.openEnd && n.depth == r && e.depth == r) {
      ...
      let { start: o, end: l } = yu(t, n);
      return Ut(i, da(n, o, l, e, r));
    }
  else return Ut(i, wr(n, e, r));
}
function ca(n, e) {
  if (!e.type.compatibleContent(n.type))
    throw new Mr('Cannot join ' + e.type.name + ' onto ' + n.type.name);
}
function di(n, e, t) {
  let r = n.node(t);
  return ca(r, e.node(t)), r;
}
function Kt(n, e) {
  let t = e.length - 1;
...
function Dn(n, e, t, r) {
  ...
  n && ((i = n.index(t)), n.depth > t ? i++ : n.textOffset && (Kt(n.nodeAfter, r), i++));
  for (let l = i; l < o; l++) Kt(s.child(l), r);
...
function da(n, e, t, r, s) {
  let i = n.depth > s && di(n, e, s + 1),
    o = r.depth > s && di(t, r, s + 1),
    l = [];
  return (
    Dn(null, n, s, l),
    i && o && e.index(s) == t.index(s)
      ? (ca(i, o), Kt(Ut(i, da(n, e, t, r, s + 1)), l))
      : (i && Kt(Ut(i, wr(n, e, s + 1)), l), Dn(e, t, s, l), o && Kt(Ut(o, wr(t, r, s + 1)), l)),
    Dn(r, null, s, l),
    new b(l)
  );
}
...
function yu(n, e) {
  ...
  for (let i = t - 1; i >= 0; i--) s = e.node(i).copy(b.from(s));
  return {
...
class jn {
  ...
  blockRange(e = this, t) {
    ...
    for (let r = this.depth - (this.parent.inlineContent || this.pos == e.pos ? 1 : 0); r >= 0; r--)
      if (e.pos <= this.end(r) && (!t || t(this.node(r)))) return new Cr(this, e, r);
    return null;
  }
  sameParent(e) {
  ...
  static resolveCached(e, t) {
    ...
    else $o.set(e, (r = new bu()));
    let s = (r.elts[r.i] = jn.resolve(e, t));
    return (r.i = (r.i + 1) % ku), s;
  }
}
class bu {
  constructor() {
...
class nt {
  ...
  hasMarkup(e, t, r) {
    return (
      this.type == e &&
      Sr(this.attrs, t || e.defaultAttrs || xu) &&
  ...
  replace(e, t, r) {
    return gu(this.resolve(e), this.resolve(t), r);
  }
  nodeAt(e) {
    for (let t = this; ; ) {
  ...
  toString() {
    ...
    return this.content.size && (e += '(' + this.content.toStringInner() + ')'), ua(this.marks, e);
  }
  contentMatchAt(e) {
  ...
  canReplace(e, t, r = b.empty, s = 0, i = r.childCount) {
    ...
    for (let a = s; a < i; a++) if (!this.type.allowsMarks(r.child(a).marks)) return !1;
    return !0;
  }
...
class Tr extends nt {
  constructor(e, t, r, s) {
    if ((super(e, t, null, s), !r)) throw new RangeError('Empty text nodes are not allowed');
    this.text = r;
  }
  toString() {
    return this.type.spec.toDebugString
      ? this.type.spec.toDebugString(this)
      : ua(this.marks, JSON.stringify(this.text));
  }
  get textContent() {
    return this.text;
  }
...
class Xt {
  ...
  static parse(e, t) {
    let r = new vu(e, t);
    if (r.next == null) return Xt.empty;
    let s = fa(r);
  ...
  compatible(e) {
    for (let t = 0; t < this.next.length; t++)
      for (let r = 0; r < e.next.length; r++) if (this.next[t].type == e.next[r].type) return !0;
    return !1;
  }
    ...
    for (; r.length; ) {
      ...
      for (let o = 0; o < i.next.length; o++) {
        ...
        !l.isLeaf &&
          ...
          !(l.name in t) &&
          (!s.type || a.validEnd) &&
          (r.push({ match: l.contentMatch, type: l, via: s }), (t[l.name] = !0));
      }
    }
    return null;
  }
  ...
  toString() {
    ...
    function t(r) {
      e.push(r);
      for (let s = 0; s < r.next.length; s++) e.indexOf(r.next[s].next) == -1 && t(r.next[s].next);
    }
    return (
      t(this),
      e
...
function Eu(n) {
  ...
  function i(o, l) {
    if (o.type == 'choice') return o.exprs.reduce((a, c) => a.concat(i(c, l)), []);
    if (o.type == 'seq')
      for (let a = 0; ; a++) {
        let c = i(o.exprs[a], l);
  ...
  function t(r) {
    ...
    r.forEach((o) => {
      n[o].forEach(({ term: l, to: a }) => {
        if (!l) return;
        let c;
        for (let d = 0; d < s.length; d++) s[d][0] == l && (c = s[d][1]);
        Po(n, a).forEach((d) => {
          c || s.push([l, (c = [])]), c.indexOf(d) == -1 && c.push(d);
        });
      });
    });
    let i = (e[r.join(',')] = new Xt(r.indexOf(n.length - 1) > -1));
...
function ga(n, e, t, r) {
  for (let s in e)
    if (!(s in n)) throw new RangeError(`Unsupported attribute ${s} for ${t} of type ${s}`);
  for (let s in n) {
    let i = n[s];
...
function ya(n, e) {
  let t = Object.create(null);
  if (e) for (let r in e) t[r] = new Iu(n, r, e[r]);
  return t;
}
let Lo = class ba {
  constructor(e, t, r) {
    (this.name = e),
      ...
      (this.attrs = ya(e, r.attrs)),
      (this.defaultAttrs = pa(this.attrs)),
  ...
  get isLeaf() {
    return this.contentMatch == Xt.empty;
  }
  get isAtom() {
  ...
  computeAttrs(e) {
    return !e && this.defaultAttrs ? this.defaultAttrs : ma(this.attrs, e);
  }
  create(e = null, t, r) {
    if (this.isText) throw new Error("NodeType.create can't construct text nodes");
    return new nt(this, this.computeAttrs(e), b.from(t), U.setFrom(r));
  }
  createChecked(e = null, t, r) {
    return (
      (t = b.from(t)), this.checkContent(t), new nt(this, this.computeAttrs(e), t, U.setFrom(r))
    );
  }
  createAndFill(e = null, t, r) {
    ...
    let s = this.contentMatch.matchFragment(t),
      i = s && s.fillBefore(b.empty, !0);
    return i ? new nt(this, e, t.append(i), U.setFrom(r)) : null;
  }
  validContent(e) {
  ...
  static compile(e, t) {
    ...
    e.forEach((i, o) => (r[i] = new ba(i, t, o)));
...
class Iu {
  constructor(e, t, r) {
    (this.hasDefault = Object.prototype.hasOwnProperty.call(r, 'default')),
      ...
      (this.validate = typeof r.validate == 'string' ? Ou(e, t, r.validate) : r.validate);
  }
  get isRequired() {
...
class gs {
  constructor(e, t, r, s) {
    (this.name = e),
      ...
      (this.schema = r),
      (this.spec = s),
      (this.attrs = ya(e, s.attrs)),
      (this.excluded = null);
    let i = pa(this.attrs);
    this.instance = i ? new U(this, i) : null;
  }
  create(e = null) {
    return !e && this.instance ? this.instance : new U(this, ma(this.attrs, e));
  }
  static compile(e, t) {
    let r = Object.create(null),
      s = 0;
    return e.forEach((i, o) => (r[i] = new gs(i, s++, t, o))), r;
  }
  removeFromSet(e) {
...
class ka {
  constructor(e) {
    ...
    (t.nodes = Ee.from(e.nodes)),
      (t.marks = Ee.from(e.marks || {})),
      (this.nodes = Lo.compile(this.spec.nodes, this)),
      (this.marks = gs.compile(this.spec.marks, this));
    let r = Object.create(null);
    for (let s in this.nodes) {
      ...
      let i = this.nodes[s],
        ...
        l = i.spec.marks;
      if (
        ((i.contentMatch = r[o] || (r[o] = Xt.parse(o, this.nodes))),
      ...
      i.markSet =
        l == '_' ? null : l ? zo(this, l.split(' ')) : l == '' || !i.inlineContent ? [] : null;
    }
    for (let s in this.marks) {
      let i = this.marks[s],
        o = i.spec.excludes;
      i.excluded = o == null ? [i] : o == '' ? [] : zo(this, o.split(' '));
    }
    (this.nodeFromJSON = (s) => nt.fromJSON(this, s)),
...
class At {
  ...
  parseSlice(e, t = {}) {
    ...
    return r.addAll(e, U.none, t.from, t.to), w.maxOpen(r.finish());
  }
  matchTag(e, t, r) {
  ...
  static schemaRules(e) {
    ...
    for (let s in e.marks) {
      ...
      i &&
        i.forEach((o) => {
          r((o = Ho(o))), o.mark || o.ignore || o.clearMark || (o.mark = s);
        });
    }
    for (let s in e.nodes) {
      ...
      i &&
        i.forEach((o) => {
          r((o = Ho(o))), o.node || o.ignore || o.mark || (o.node = s);
        });
    }
    return t;
  }
  static fromSchema(e) {
    return e.cached.domParser || (e.cached.domParser = new At(e, At.schemaRules(e)));
  }
}
const xa = {
    address: !0,
  ...
  Ru = { head: !0, noscript: !0, object: !0, script: !0, style: !0, title: !0 },
  va = { ol: !0, ul: !0 },
  Wn = 1,
  ui = 2,
  $n = 4;
...
class ir {
  constructor(e, t, r, s, i, o) {
    (this.type = e),
      ...
      (this.match = i || (o & $n ? null : e.contentMatch));
  }
  findWrapping(e) {
    if (!this.match) {
      if (!this.type) return [];
  ...
  finish(e) {
    ...
    return (
      !e && this.match && (t = t.append(this.match.fillBefore(b.empty, !0))),
  ...
  inlineContext(e) {
    return this.type
      ...
      : this.content.length
        ...
        : e.parentNode && !xa.hasOwnProperty(e.parentNode.nodeName.toLowerCase());
  }
}
class _o {
  constructor(e, t, r) {
    ...
    let s = t.topNode,
      i,
      o = Bo(null, t.preserveWhitespace, 0) | (r ? $n : 0);
    s
      ? (i = new ir(s.type, s.attrs, U.none, !0, t.topMatch || s.type.contentMatch, o))
      : r
        ? (i = new ir(null, null, U.none, !0, null, o))
        : (i = new ir(e.schema.topNodeType, null, U.none, !0, null, o)),
      (this.nodes = [i]),
  ...
  addTextNode(e, t) {
    let r = e.nodeValue,
      s = this.top,
      i = s.options & ui ? 'full' : this.localPreserveWS || (s.options & Wn) > 0,
...
`,
  ...
  addElement(e, t, r) {
    ...
    let o = e.nodeName.toLowerCase(),
      l;
    va.hasOwnProperty(o) && this.parser.normalizeLists && Pu(e);
    let a =
      (this.options.ruleFromNode && this.options.ruleFromNode(e)) ||
      (l = this.parser.matchTag(e, this, r));
    e: if (a ? a.ignore : Ru.hasOwnProperty(o)) this.findInside(e), this.ignoreFallback(e, t);
...
`),
  ...
  addElementByRule(e, t, r, s) {
    ...
    if (o && o.isLeaf) this.findInside(e);
      ...
      this.findInside(e),
        t.getContent(e, this.parser.schema).forEach((a) => this.insertNode(a, r, !1));
    else {
      let a = e;
  ...
  addAll(e, t, r, s) {
    let i = r || 0;
    for (
      let o = r ? e.childNodes[r] : e.firstChild, l = s == null ? null : e.childNodes[s];
      o != l;
      o = o.nextSibling, ++i
    )
  ...
  findPlace(e, t, r) {
    ...
    for (let o = this.open, l = 0; o >= 0; o--) {
      let a = this.nodes[o],
        c = a.findWrapping(e);
      if (c && (!s || s.length > c.length + l) && ((s = c), (i = a), !c.length)) break;
      if (a.solid) {
        if (r) break;
        l += 2;
      }
  ...
  insertNode(e, t, r) {
    ...
    if (s) {
      ...
      for (let l of s.concat(e.marks))
        (i.type ? i.type.allowsMarkType(l.type) : Fo(l.type, e.type)) && (o = l.addToSet(o));
  ...
  enterInner(e, t, r, s = !1, i) {
    ...
    let l = Bo(e, i, o.options);
    o.options & $n && o.content.length == 0 && (l |= $n);
    let a = U.none;
    return (
      (r = r.filter((c) =>
        (o.type ? o.type.allowsMarkType(c.type) : Fo(c.type, e)) ? ((a = c.addToSet(a)), !1) : !0,
      )),
      this.nodes.push(new ir(e, t, a, s, null, l)),
      this.open++,
      r
    );
  }
      ...
      o = (l, a) => {
        for (; l >= 0; l--) {
          ...
          if (c == '') {
            ...
            let d =
              a > 0 || (a == 0 && s) ? this.nodes[a].type : r && a >= i ? r.node(a - i).type : null;
    ...
    let i = [],
      o = (l) => {
        ...
        for (let a = 0; a < l.edgeCount; a++) {
          ...
          if (c == e || (i.indexOf(d) < 0 && o(d))) return !0;
        }
      };
...
class tn {
  ...
  serializeNodeInner(e, t) {
    let { dom: r, contentDOM: s } = yr(zs(t), this.nodes[e.type.name](e), null, e.attrs);
    if (s) {
  ...
  serializeMark(e, t, r = {}) {
    ...
    return s && yr(zs(r), s(e, t), null, e.attrs);
  }
  ...
  static fromSchema(e) {
    return (
      ...
      (e.cached.domSerializer = new tn(this.nodesFromSchema(e), this.marksFromSchema(e)))
    );
  }
...
function zu(n) {
  let e = jo.get(n);
  return e === void 0 && jo.set(n, (e = Bu(n))), e;
}
function Bu(n) {
  let e = null;
  function t(r) {
...
class fi {
  ...
  get deletedBefore() {
    return (this.delInfo & (wa | br)) > 0;
  }
  get deletedAfter() {
    return (this.delInfo & (Ca | br)) > 0;
  }
  get deletedAcross() {
...
class je {
  constructor(e, t = !1) {
    if (((this.ranges = e), (this.inverted = t), !e.length && je.empty)) return je.empty;
  }
  recover(e) {
    let t = 0,
      r = Wo(e);
    if (!this.inverted)
      for (let s = 0; s < r; s++) t += this.ranges[s * 3 + 2] - this.ranges[s * 3 + 1];
    ...
    for (let l = 0; l < this.ranges.length; l += 3) {
      ...
      if (e <= u) {
        let f = c ? (e == a ? -1 : e == u ? 1 : t) : t,
          h = a + s + (f < 0 ? 0 : d);
        if (r) return h;
        let p = e == (t < 0 ? a : u) ? null : _u(l / 3, e - a),
          m = e == a ? Ca : e == u ? wa : br;
        return (t < 0 ? e != a : e != u) && (m |= Ta), new fi(h, m, p);
      }
      s += d - c;
    }
    return r ? e + s : new fi(e + s, 0, null);
  }
  touches(e, t) {
    let r = 0,
      s = Wo(t),
...
class $e {
  ...
  static jsonID(e, t) {
    if (e in Bs) throw new RangeError('Duplicate use of step JSON ID ' + e);
...
class ae {
  ...
  static fromReplace(e, t, r, s) {
    try {
      ...
      if (i instanceof Mr) return ae.fail(i.message);
      throw i;
    }
  }
}
function Hi(n, e, t) {
  ...
  for (let s = 0; s < n.childCount; s++) {
    let i = n.child(s);
    i.content.size && (i = i.copy(Hi(i.content, e, i))), i.isInline && (i = e(i, t, s)), r.push(i);
  }
...
class Ct extends $e {
  ...
  merge(e) {
    return e instanceof Ct && e.mark.eq(this.mark) && this.from <= e.to && this.to >= e.from
      ? new Ct(Math.min(this.from, e.from), Math.max(this.to, e.to), this.mark)
      : null;
  }
  toJSON() {
...
class tt extends $e {
  ...
  apply(e) {
    let t = e.slice(this.from, this.to),
      r = new w(
        Hi(t.content, (s) => s.mark(this.mark.removeFromSet(s.marks)), e),
        t.openStart,
        t.openEnd,
      );
  ...
  merge(e) {
    return e instanceof tt && e.mark.eq(this.mark) && this.from <= e.to && this.to >= e.from
      ? new tt(Math.min(this.from, e.from), Math.max(this.to, e.to), this.mark)
      : null;
  }
  toJSON() {
...
class Tt extends $e {
  ...
  apply(e) {
    ...
    if (!t) return ae.fail("No node at mark step's position");
    let r = t.type.create(t.attrs, null, this.mark.addToSet(t.marks));
    return ae.fromReplace(e, this.pos, this.pos + 1, new w(b.from(r), 0, t.isLeaf ? 0 : 1));
  }
  invert(e) {
    let t = e.nodeAt(this.pos);
    if (t) {
      ...
      if (r.length == t.marks.length) {
        for (let s = 0; s < t.marks.length; s++)
          if (!t.marks[s].isInSet(r)) return new Tt(this.pos, t.marks[s]);
...
$e.jsonID('removeNodeMark', Yt);
class le extends $e {
  constructor(e, t, r, s = !1) {
    super(), (this.from = e), (this.to = t), (this.slice = r), (this.structure = s);
  }
  apply(e) {
    return this.structure && hi(e, this.from, this.to)
      ? ae.fail('Structure replace would overwrite content')
      : ae.fromReplace(e, this.from, this.to, this.slice);
  }
  getMap() {
  ...
  map(e) {
    let t = e.mapResult(this.to, -1),
      r = this.from == this.to && le.MAP_BIAS < 0 ? t : e.mapResult(this.from, 1);
    return r.deletedAcross && t.deletedAcross
      ? null
      : new le(r.pos, Math.max(r.pos, t.pos), this.slice, this.structure);
  }
  merge(e) {
    if (!(e instanceof le) || e.structure || this.structure) return null;
  ...
  static fromJSON(e, t) {
    ...
    return new le(t.from, t.to, w.fromJSON(e, t.slice), !!t.structure);
  }
}
le.MAP_BIAS = 1;
$e.jsonID('replace', le);
class ye extends $e {
  ...
  apply(e) {
    if (this.structure && (hi(e, this.from, this.gapFrom) || hi(e, this.gapTo, this.to)))
      return ae.fail('Structure gap-replace would overwrite content');
    let t = e.slice(this.gapFrom, this.gapTo);
    if (t.openStart || t.openEnd) return ae.fail('Gap is not a flat range');
  ...
  map(e) {
    ...
    return (t.deletedAcross && r.deletedAcross) || s < t.pos || i > r.pos
      ? null
      : new ye(t.pos, r.pos, s, i, this.slice, this.insert, this.structure);
  }
  toJSON() {
    let e = {
  ...
  static fromJSON(e, t) {
    ...
    return new ye(
      ...
      t.gapFrom,
      t.gapTo,
      w.fromJSON(e, t.slice),
      t.insert,
      !!t.structure,
    );
  }
}
$e.jsonID('replaceAround', ye);
function hi(n, e, t) {
  let r = n.resolve(e),
    s = t - e,
    i = r.depth;
  for (; s > 0 && i > 0 && r.indexAfter(i) == r.node(i).childCount; ) i--, s--;
  if (s > 0) {
  ...
  n.doc.nodesBetween(e, t, (a, c, d) => {
    ...
    if (!r.isInSet(u) && d.type.allowsMarkType(r.type)) {
      ...
      for (let m = 0; m < u.length; m++)
        u[m].isInSet(p) ||
          (o && o.to == f && o.mark.eq(u[m]) ? (o.to = h) : s.push((o = new tt(f, h, u[m]))));
      l && l.to == f ? (l.to = h) : i.push((l = new Ct(f, h, r)));
    }
  }),
    ...
    if (a && a.length) {
      ...
      for (let d = 0; d < a.length; d++) {
        ...
        for (let h = 0; h < s.length; h++) {
          let p = s[h];
          p.step == i - 1 && u.eq(s[h].style) && (f = p);
        }
        f ? ((f.to = c), (f.step = i)) : s.push({ style: u, from: Math.max(l, e), to: c, step: i });
      }
    }
  }),
    s.forEach((o) => n.step(new tt(o.from, o.to, o.style)));
}
function Fi(n, e, t, r = t.contentMatch, s = !0) {
  ...
  for (let a = 0; a < i.childCount; a++) {
    ...
    if (!u) o.push(new le(l, d, w.empty));
    else {
      r = u;
      for (let f = 0; f < c.marks.length; f++)
        t.allowsMarkType(c.marks[f].type) || n.step(new tt(l, d, c.marks[f]));
      if (s && c.isText && t.whitespace != 'pre') {
        let f,
          h = /\r?\n|\r/g,
          p;
        for (; (f = h.exec(c.text)); )
          p || (p = new w(b.from(t.schema.text(' ', t.allowedMarks(c.marks))), 0, 0)),
            o.push(new le(l + f.index, l + f.index + f[0].length, p));
      }
    }
    l = d;
  }
...
function vn(n) {
  ...
  for (let r = n.depth, s = 0, i = 0; ; --r) {
    ...
    if (r == 0 || o.type.spec.isolating || !ju(o, l, a)) break;
...
function Wu(n, e, t) {
  ...
  n.step(new ye(a, c, o, l, new w(d.append(f), u, h), d.size - u, !0));
}
function Vi(n, e, t = null, r = n) {
  let s = Ku(n, e),
    i = s && Uu(r, e);
  return i ? s.map(Ko).concat({ type: e, attrs: t }).concat(i.map(Ko)) : null;
}
function Ko(n) {
...
function qu(n, e, t) {
  ...
  let s = e.start,
    i = e.end;
  n.step(new ye(s, i, s, i, new w(r, 0, 0), t.length, !0));
}
function Ju(n, e, t, r, s) {
  ...
  n.doc.nodesBetween(e, t, (o, l) => {
    ...
    if (o.isTextblock && !o.hasMarkup(r, a) && Gu(n.doc, n.mapping.slice(i).map(l), r)) {
      let c = null;
      ...
      c === !1 && Aa(n, o, l, i), Fi(n, n.mapping.slice(i).map(l, 1), r, void 0, c === null);
      let d = n.mapping.slice(i),
        u = d.map(l, 1),
        f = d.map(l + o.nodeSize, 1);
      return (
        n.step(new ye(u, f, u + 1, f - 1, new w(b.from(r.create(a, null, o.marks)), 0, 0), 1, !0)),
        c === !0 && Ea(n, o, l, i),
        !1
      );
    }
...
function Xu(n, e, t, r, s) {
  ...
  n.step(new ye(e, e + i.nodeSize, e + 1, e + i.nodeSize - 1, new w(b.from(o), 0, 0), 1, !0));
}
function mt(n, e, t = 1, r) {
  let s = n.resolve(e),
    i = s.depth - t,
...
function Yu(n, e, t = 1, r) {
  ...
  n.step(new le(e, e, new w(i.append(o), t, t), !0));
}
function Pt(n, e) {
  let t = n.resolve(e),
    r = t.index();
  return Na(t.nodeBefore, t.nodeAfter) && t.parent.canReplace(r, r + 1);
}
function Qu(n, e) {
...
function ys(n, e, t = -1) {
  ...
  for (let s = r.depth; ; s--) {
    ...
    if (
      ...
      i && !i.isTextblock && Na(i, o) && r.node(s).canReplace(l, l + 1))
    )
      return e;
    if (s == 0) break;
...
function Zu(n, e, t) {
  ...
  if (s && o.inlineContent) {
    let d = o.whitespace == 'pre',
      u = !!o.contentMatch.matchType(s);
    d && !u ? (r = !1) : !d && u && (r = !0);
  }
  let l = n.steps.length;
  if (r === !1) {
    let d = n.doc.resolve(e + t);
    Aa(n, d.node(), d.before(), l);
  }
  o.inlineContent && Fi(n, e + t - 1, o, i.node().contentMatchAt(i.index()), r == null);
  let a = n.mapping.slice(l),
    c = a.map(e - t);
  if ((n.step(new le(c, a.map(e + t, -1), w.empty, !0)), r === !0)) {
    let d = n.doc.resolve(c);
    Ea(n, d.node(), d.before(), n.steps.length);
  }
  return n;
}
function ef(n, e, t) {
...
function bs(n, e, t = e, r = w.empty) {
  if (e == t && !r.size) return null;
  let s = n.resolve(e),
    i = n.resolve(t);
  return Ia(s, i, r) ? new le(e, t, r) : new tf(s, i, r).fit();
}
function Ia(n, e, t) {
  return (
    !t.openStart &&
...
class tf {
  constructor(e, t, r) {
    ...
    for (let s = 0; s <= e.depth; s++) {
      let i = e.node(s);
      this.frontier.push({ type: i.type, match: i.contentMatchAt(e.indexAfter(s)) });
    }
    for (let s = e.depth; s > 0; s--) this.placed = b.from(e.node(s).copy(this.placed));
  }
  get depth() {
  ...
  fit() {
    ...
    let i = this.placed,
      o = r.depth,
      l = s.depth;
    for (; o && l && i.childCount == 1; ) (i = i.firstChild.content), o--, l--;
    let a = new w(i, o, l);
    return e > -1
      ? new ye(r.pos, e, this.$to.pos, this.$to.end(), a, t)
      : a.size || r.pos != this.$to.pos
        ? new le(r.pos, s.pos, a)
        : null;
  }
  findFittable() {
    ...
    for (let t = 1; t <= 2; t++)
      for (let r = t == 1 ? e : this.unplaced.openStart; r >= 0; r--) {
        let s,
          i = null;
        r
          ? ((i = _s(this.unplaced.content, r - 1).firstChild), (s = i.content))
        ...
        for (let l = this.depth; l >= 0; l--) {
          ...
          if (
            t == 1 &&
            (o
              ? c.matchType(o.type) || (u = c.fillBefore(b.from(o), !1))
  ...
  openMore() {
    ...
    return !s.childCount || s.firstChild.isLeaf
      ? !1
      : ((this.unplaced = new w(e, t + 1, Math.max(r, s.size + t >= e.size - r ? t + 1 : 0))), !0);
  }
  dropNode() {
    let { content: e, openStart: t, openEnd: r } = this.unplaced,
      s = _s(e, t);
    if (s.childCount <= 1 && t > 0) {
      ...
      this.unplaced = new w(En(e, t - 1, 1), t - 1, i ? t - 1 : r);
    } else this.unplaced = new w(En(e, t, 1), t, r);
  }
  placeNodes({ sliceDepth: e, frontierDepth: t, parent: r, inject: s, wrap: i }) {
    ...
    if (s) {
      for (let m = 0; m < s.childCount; m++) d.push(s.child(m));
      u = u.matchFragment(s);
    }
    ...
    for (; c < l.childCount; ) {
      ...
      c++,
        (c > 1 || a == 0 || m.content.size) &&
          ((u = g),
          d.push(Da(m.mark(f.allowedMarks(m.marks)), c == 1 ? a : 0, c == l.childCount ? h : -1)));
    }
    let p = c == l.childCount;
    p || (h = -1),
      (this.placed = An(this.placed, t, b.from(d))),
    ...
    this.unplaced = p
      ? e == 0
        ? w.empty
        : new w(En(o.content, e - 1, 1), e - 1, h < 0 ? o.openEnd : e - 1)
      : new w(En(o.content, e, c), o.openStart, o.openEnd);
  }
  mustMoveInline() {
  ...
  openFrontierNode(e, t = null, r) {
    ...
    (s.match = s.match.matchType(e)),
      (this.placed = An(this.placed, this.depth, b.from(e.create(t, r)))),
...
function En(n, e, t) {
  return e == 0
    ...
    : n.replaceChild(0, n.firstChild.copy(En(n.firstChild.content, e - 1, t)));
}
function An(n, e, t) {
  return e == 0
    ? n.append(t)
    : n.replaceChild(n.childCount - 1, n.lastChild.copy(An(n.lastChild.content, e - 1, t)));
}
function _s(n, e) {
...
function Da(n, e, t) {
  ...
  let r = n.content;
  return (
    e > 1 && (r = r.replaceChild(0, Da(r.firstChild, e - 1, r.childCount == 1 ? t - 1 : 0))),
    e > 0 &&
      ((r = n.type.contentMatch.fillBefore(r).append(r)),
      t <= 0 && (r = r.append(n.type.contentMatch.matchFragment(r).fillBefore(b.empty, !0)))),
    n.copy(r)
  );
}
function Hs(n, e, t, r, s) {
  ...
  return l && !nf(t, i.content, o) ? l : null;
}
function nf(n, e, t) {
...
function sf(n, e, t, r) {
  ...
  let s = n.doc.resolve(e),
    i = n.doc.resolve(t);
  if (Ia(s, i, r)) return n.step(new le(e, t, r));
  let o = Ra(s, i);
  ...
  for (let f = d - 1; f >= 0; f--) {
    let h = c[f],
      p = rf(h.type);
    if (p && !h.sameMarkup(s.node(Math.abs(l) - 1))) d = f;
      ...
      for (let m = 0; m < o.length; m++) {
        ...
        if (v.canReplaceWith(T, T, p.type, p.marks))
          return n.replace(
            s.before(g),
            y ? i.after(g) : t,
            new w($a(r.content, 0, r.openStart, h), h, r.openEnd),
          );
      }
  }
...
function $a(n, e, t, r, s) {
  if (e < t) {
    let i = n.firstChild;
    n = n.replaceChild(0, i.copy($a(i.content, e + 1, t, r, i)));
  }
  if (e > r) {
...
class un extends $e {
  ...
  apply(e) {
    let t = e.nodeAt(this.pos);
    if (!t) return ae.fail("No node at attribute step's position");
    let r = Object.create(null);
    for (let i in t.attrs) r[i] = t.attrs[i];
    r[this.attr] = this.value;
    let s = t.type.create(r, null, t.marks);
    return ae.fromReplace(e, this.pos, this.pos + 1, new w(b.from(s), 0, t.isLeaf ? 0 : 1));
  }
  getMap() {
    return je.empty;
  }
...
class Pa {
  ...
  setBlockType(e, t = e, r, s = null) {
    return Ju(this, e, t, r, s), this;
  }
  setNodeMarkup(e, t, r = null, s) {
    return Xu(this, e, t, r, s), this;
  }
  ...
  removeNodeMark(e, t) {
    ...
    if (t instanceof U) t.isInSet(r.marks) && this.step(new Yt(e, t));
    else {
      let s = r.marks,
        i,
        o = [];
      for (; (i = t.isInSet(s)); ) o.push(new Yt(e, i)), (s = i.removeFromSet(s));
  ...
  clearIncompatible(e, t, r) {
    return Fi(this, e, t, r), this;
  }
}
const Fs = Object.create(null);
class _ {
  constructor(e, t, r) {
    (this.$anchor = e), (this.$head = t), (this.ranges = r || [new af(e.min(t), e.max(t))]);
  }
  get anchor() {
  ...
  replace(e, t = w.empty) {
    ...
    for (let l = 0; l < o.length; l++) {
      let { $from: a, $to: c } = o[l],
        d = e.mapping.slice(i);
      e.replaceRange(d.map(a.pos), d.map(c.pos), l ? w.empty : t),
        l == 0 && Jo(e, i, (r ? r.isInline : s && s.isTextblock) ? -1 : 1);
    }
  }
  replaceWith(e, t) {
    ...
    for (let i = 0; i < s.length; i++) {
      let { $from: o, $to: l } = s[i],
        ...
        c = a.map(o.pos),
        d = a.map(l.pos);
      i ? e.deleteRange(c, d) : (e.replaceRangeWith(c, d, t), Jo(e, r, t.isInline ? -1 : 1));
    }
  }
  static findFrom(e, t, r = !1) {
    let s = e.parent.inlineContent ? new R(e) : on(e.node(0), e.parent, e.pos, e.index(), t, r);
    if (s) return s;
    for (let i = e.depth - 1; i >= 0; i--) {
      let o =
        t < 0
          ? on(e.node(0), e.node(i), e.before(i + 1), e.index(i), t, r)
          : on(e.node(0), e.node(i), e.after(i + 1), e.index(i) + 1, t, r);
      if (o) return o;
    }
    return null;
  }
  ...
  static atStart(e) {
    return on(e, e, 0, 0, 1) || new We(e);
  }
  static atEnd(e) {
    return on(e, e, e.content.size, e.childCount, -1) || new We(e);
  }
  static fromJSON(e, t) {
  ...
  static jsonID(e, t) {
    if (e in Fs) throw new RangeError('Duplicate use of selection JSON ID ' + e);
...
class R extends _ {
  ...
  map(e, t) {
    ...
    return new R(s.parent.inlineContent ? s : r, r);
  }
  replace(e, t = w.empty) {
  ...
  static between(e, t, r) {
    ...
    if (((!r || s) && (r = s >= 0 ? 1 : -1), !t.parent.inlineContent)) {
      ...
      if (i) t = i.$head;
      else return _.near(t, r);
    }
    return (
      e.parent.inlineContent ||
        (s == 0
          ? (e = t)
          : ((e = (_.findFrom(e, -r, !0) || _.findFrom(e, r, !0)).$anchor),
            e.pos < t.pos != s < 0 && (e = t))),
      new R(e, t)
    );
  }
...
class ji {
  ...
  map(e) {
    ...
    return t ? new ks(r, r) : new ji(r);
  }
  resolve(e) {
    let t = e.resolve(this.anchor),
      r = t.nodeAfter;
    return r && D.isSelectable(r) ? new D(t) : _.near(t);
  }
}
class We extends _ {
  constructor(e) {
...
function on(n, e, t, r, s, i = !1) {
  if (e.inlineContent) return R.create(n, t);
  for (let o = r - (s > 0 ? 0 : 1); s > 0 ? o < e.childCount : o >= 0; o += s) {
    let l = e.child(o);
    if (l.isAtom) {
      if (!i && D.isSelectable(l)) return D.create(n, t - (s < 0 ? l.nodeSize : 0));
    } else {
      let a = on(n, l, t + s, s < 0 ? l.childCount : 0, s, i);
      if (a) return a;
    }
    t += l.nodeSize * s;
  }
...
function Jo(n, e, t) {
  ...
  if (r < e) return;
  let s = n.steps[r];
  if (!(s instanceof le || s instanceof ye)) return;
...
class df extends Pa {
  ...
  setSelection(e) {
    ...
    return (
      (this.curSelection = e),
      (this.curSelectionFor = this.steps.length),
      (this.updated = (this.updated | Go) & ~or),
  ...
  ensureMarks(e) {
    return (
      U.sameSet(this.storedMarks || this.selection.$from.marks(), e) || this.setStoredMarks(e), this
    );
  }
  addStoredMark(e) {
  ...
  replaceSelectionWith(e, t = !0) {
    ...
    return (
      t &&
        (e = e.mark(
          this.storedMarks || (r.empty ? r.$from.marks() : r.$from.marksAcross(r.$to) || U.none),
        )),
  ...
  insertText(e, t, r) {
    ...
    if (t == null) return e ? this.replaceSelectionWith(s.text(e), !0) : this.deleteSelection();
    {
      ...
      t &&
        t.forEach((r) => {
          ...
          this.plugins.push(r),
            ...
            r.spec.state && this.fields.push(new Nn(r.key, r.spec.state, r));
        });
  }
}
class cn {
  ...
  static create(e) {
    let t = new Vs(e.doc ? e.doc.type.schema : e.schema, e.plugins),
      r = new cn(t);
    for (let s = 0; s < t.fields.length; s++) r[t.fields[s].name] = t.fields[s].init(e, r);
    return r;
  }
  reconfigure(e) {
    let t = new Vs(this.schema, e.plugins),
      r = t.fields,
      s = new cn(t);
  ...
  static fromJSON(e, t, r) {
    ...
    let s = new Vs(e.schema, e.plugins),
      i = new cn(s);
    return (
      s.fields.forEach((o) => {
        if (o.name == 'doc') i.doc = nt.fromJSON(e.schema, t.doc);
        else if (o.name == 'selection') i.selection = _.fromJSON(i.doc, t.selection);
...
function La(n, e, t) {
  for (let r in n) {
    let s = n[r];
    s instanceof Function ? (s = s.bind(e)) : r == 'handleDOMEvents' && (s = La(s, e, {})),
      (t[r] = s);
  }
  return t;
}
class Z {
  constructor(e) {
    (this.spec = e),
      (this.props = {}),
      e.props && La(e.props, this, this.props),
      (this.key = e.key ? e.key.key : za('plugin'));
  }
  getState(e) {
    return e[this.key];
  }
...
const _a = (n, e, t) => {
    ...
    let i = s.nodeBefore;
    if (Ja(n, s, e, -1)) return !0;
    if (r.parent.content.size == 0 && (pn(i, 'end') || D.isSelectable(i)))
      for (let o = r.depth; ; o--) {
        let l = bs(n.doc, r.before(o), r.after(o), w.empty);
        if (l && l.slice.size < l.to - l.from) {
          if (e) {
            let a = n.tr.step(l);
            a.setSelection(
              pn(i, 'end')
                ? _.findFrom(a.doc.resolve(a.mapping.map(s.pos, -1)), -1)
                : D.create(a.doc, s.pos - i.nodeSize),
            ),
              e(a.scrollIntoView());
          }
          return !0;
...
function Ha(n, e, t) {
  ...
  let c = bs(n.doc, i, a, w.empty);
  if (!c || c.from != i || (c instanceof le && c.slice.size >= a - i)) return !1;
  if (t) {
    let d = n.tr.step(c);
...
const Fa = (n, e, t) => {
  ...
  return !o || !D.isSelectable(o)
    ? !1
    : (e && e(n.tr.setSelection(D.create(n.doc, i.pos - o.nodeSize)).scrollIntoView()), !0);
};
function Ki(n) {
...
const ja = (n, e, t) => {
    ...
    let i = s.nodeAfter;
    if (Ja(n, s, e, 1)) return !0;
    if (r.parent.content.size == 0 && (pn(i, 'start') || D.isSelectable(i))) {
      let o = bs(n.doc, r.before(), r.after(), w.empty);
      if (o && o.slice.size < o.to - o.from) {
        if (e) {
          let l = n.tr.step(o);
          l.setSelection(
            pn(i, 'start')
              ? _.findFrom(l.doc.resolve(l.mapping.map(s.pos)), 1)
              : D.create(l.doc, l.mapping.map(s.pos)),
          ),
            e(l.scrollIntoView());
        }
        return !0;
...
const pf = (n, e) => {
    let t = n.selection,
      ...
      s;
    if (r) {
      if (t.node.isTextblock || !Pt(n.doc, t.from)) return !1;
      s = t.from;
    } else if (((s = ys(n.doc, t.from, -1)), s == null)) return !1;
    if (e) {
      let i = n.tr.join(s);
      r && i.setSelection(D.create(i.doc, s - n.doc.resolve(s).nodeBefore.nodeSize)),
        e(i.scrollIntoView());
    }
    return !0;
  },
  mf = (n, e) => {
    let t = n.selection,
      r;
    if (t instanceof D) {
      if (t.node.isTextblock || !Pt(n.doc, t.to)) return !1;
      r = t.to;
    } else if (((r = ys(n.doc, t.to, 1)), r == null)) return !1;
...
const yf = (n, e) => {
  ...
  Ua = (n, e) => {
    let t = n.selection,
      { $from: r, $to: s } = t;
    if (t instanceof We || r.parent.inlineContent || s.parent.inlineContent) return !1;
    let i = qi(s.parent.contentMatchAt(s.indexAfter()));
  ...
  qa = (n, e) => {
    ...
    if (t.depth > 1 && t.after() != t.end(-1)) {
      let i = t.before();
      if (mt(n.doc, i)) return e && e(n.tr.split(i).scrollIntoView()), !0;
    }
    let r = t.blockRange(),
      s = r && vn(r);
...
function bf(n) {
  return (e, t) => {
    ...
    if (e.selection instanceof D && e.selection.node.isBlock)
      return !r.parentOffset || !mt(e.doc, r.pos)
        ? !1
    ...
    for (let h = r.depth; ; h--)
      if (r.node(h).isBlock) {
        (a = r.end(h) == r.pos + (r.depth - h)),
          ...
          (l = qi(r.node(h - 1).contentMatchAt(r.indexAfter(h - 1)))),
    ...
    let d = e.tr;
    (e.selection instanceof R || e.selection instanceof We) && d.deleteSelection();
    let u = d.mapping.map(r.pos),
      f = mt(d.doc, u, i.length, i);
    if ((f || ((i[0] = l ? { type: l } : null), (f = mt(d.doc, u, i.length, i))), !f)) return !1;
    if ((d.split(u, i.length, i), !a && c && r.node(o).type != l)) {
      let h = d.mapping.map(r.before(o)),
        p = d.doc.resolve(h);
      l &&
        r.node(o - 1).canReplaceWith(p.index(), p.index() + 1, l) &&
        d.setNodeMarkup(d.mapping.map(r.before(o)), l);
    }
...
const kf = bf(),
  xf = (n, e) => {
    let { $from: t, to: r } = n.selection,
      s,
      i = t.sharedDepth(r);
    return i == 0 ? !1 : ((s = t.before(i)), e && e(n.tr.setSelection(D.create(n.doc, s))), !0);
  };
function vf(n, e, t) {
  let r = e.nodeBefore,
    s = e.nodeAfter,
  ...
  return !r || !s || !r.type.compatibleContent(s.type)
    ...
    : !r.content.size && e.parent.canReplace(i - 1, i)
      ...
      : !e.parent.canReplace(i, i + 1) || !(s.isTextblock || Pt(n.doc, e.pos))
        ? !1
...
function Ja(n, e, t, r) {
  ...
  if (
    ...
    if (t) {
      let h = e.pos + i.nodeSize,
        p = b.empty;
      for (let y = o.length - 1; y >= 0; y--) p = b.from(o[y].create(null, p));
      p = b.from(s.copy(p));
      let m = n.tr.step(new ye(e.pos - 1, h, e.pos, h, new w(p, 1, 0), o.length, !0)),
        g = m.doc.resolve(h + 2 * o.length);
      g.nodeAfter && g.nodeAfter.type == s.type && Pt(m.doc, g.pos) && m.join(g.pos),
        t(m.scrollIntoView());
    }
    return !0;
  }
  let d = i.type.spec.isolating || (r > 0 && a) ? null : _.findFrom(e, 1),
  ...
  if (c && pn(i, 'start', !0) && pn(s, 'end')) {
    ...
    if (h.canReplace(h.childCount, h.childCount, m.content)) {
      if (t) {
        let y = b.empty;
        for (let T = p.length - 1; T >= 0; T--) y = b.from(p[T].copy(y));
        let v = n.tr.step(
          new ye(
            e.pos - p.length,
            e.pos + i.nodeSize,
...
function Ga(n) {
  return function (e, t) {
    ...
    return s.node(i).isTextblock
      ? (t && t(e.tr.setSelection(R.create(e.doc, n < 0 ? s.start(i) : s.end(i)))), !0)
      : !1;
  };
}
const Sf = Ga(-1),
...
function Cf(n, e = null) {
  return function (t, r) {
    ...
    if (!o) return !1;
    let l = r ? t.tr : null;
    return Tf(l, o, n, e) ? (r && r(l.scrollIntoView()), !0) : !1;
  };
}
function Tf(n, e, t, r = null) {
  let s = !1,
    i = e,
    o = e.$from.doc;
  if (e.depth >= 2 && e.$from.node(e.depth - 1).type.compatibleContent(t) && e.startIndex == 0) {
    ...
    (i = new Cr(a, a, e.depth)),
      e.endIndex < e.parent.childCount &&
        (e = new Cr(e.$from, o.resolve(e.$to.end(e.depth)), e.depth)),
      (s = !0);
  }
  let l = Vi(i, t, r, e);
  return l ? (n && Ef(n, e, l, s, t), !0) : !1;
}
function Ef(n, e, t, r, s) {
  let i = b.empty;
  for (let d = t.length - 1; d >= 0; d--) i = b.from(t[d].type.create(t[d].attrs, i));
  n.step(new ye(e.start - (r ? 2 : 0), e.end, e.start, e.end, new w(i, 0, 0), t.length, !0));
  let o = 0;
  for (let d = 0; d < t.length; d++) t[d].type == s && (o = d + 1);
  let l = t.length - o,
    a = e.start + t.length - (r ? 2 : 0),
    c = e.parent;
  for (let d = e.startIndex, u = e.endIndex, f = !0; d < u; d++, f = !1)
    !f && mt(n.doc, a, l) && (n.split(a, l), (a += 2 * l)), (a += c.child(d).nodeSize);
  return n;
}
function Af(n) {
  return function (e, t) {
    ...
    return i ? (t ? (r.node(i.depth - 1).type == n ? Nf(e, t, n, i) : Of(e, t, i)) : !0) : !1;
  };
}
function Nf(n, e, t, r) {
  let s = n.tr,
    ...
    o = r.$to.end(r.depth);
  i < o &&
    (s.step(new ye(i - 1, o, i, o, new w(b.from(t.create(null, r.parent.copy())), 1, 0), 1, !0)),
    (r = new Cr(s.doc.resolve(r.$from.pos), s.doc.resolve(o), r.depth)));
  const l = vn(r);
  if (l == null) return !1;
  s.lift(r, l);
  let a = s.doc.resolve(s.mapping.map(i, -1) - 1);
  return (
    Pt(s.doc, a.pos) && a.nodeBefore.type == a.nodeAfter.type && s.join(a.pos),
    e(s.scrollIntoView()),
    !0
  );
}
function Of(n, e, t) {
  ...
  let l = t.startIndex == 0,
    ...
    c = i.node(-1),
    d = i.index(-1);
  if (!c.canReplace(d + (l ? 0 : 1), d + 1, o.content.append(a ? b.empty : b.from(s)))) return !1;
  let u = i.pos,
    f = u + o.nodeSize;
  return (
    r.step(
      new ye(
        ...
        f - 1,
        new w(
          (l ? b.empty : b.from(s.copy(b.empty))).append(a ? b.empty : b.from(s.copy(b.empty))),
          l ? 0 : 1,
          a ? 0 : 1,
        ),
        l ? 0 : 1,
  ...
  return function (e, t) {
    ...
    if (t) {
      let c = a.lastChild && a.lastChild.type == l.type,
        d = b.from(c ? n.create() : null),
        u = new w(b.from(n.create(null, b.from(l.type.create(null, d)))), c ? 3 : 1, 0),
        f = i.start,
        h = i.end;
      t(e.tr.step(new ye(f - (c ? 3 : 1), h, f, h, u, 1, !0)).scrollIntoView());
    }
    return !0;
  };
}
...
function Zo(n, e, t, r, s) {
  for (var i; ; ) {
    if (n == t && e == r) return !0;
    if (e == (s < 0 ? 0 : Je(n))) {
      let o = n.parentNode;
      if (!o || o.nodeType != 1 || er(n) || $f.test(n.nodeName) || n.contentEditable == 'false')
        return !1;
      (e = Ae(n) + (s < 0 ? 0 : 1)), (n = o);
    } else if (n.nodeType == 1) {
      let o = n.childNodes[e + (s < 0 ? -1 : 0)];
      if (o.nodeType == 1 && o.contentEditable == 'false')
        if (!((i = o.pmViewDesc) === null || i === void 0) && i.ignoreForSelection) e += s;
        else return !1;
      else (n = o), (e = s < 0 ? Je(n) : 0);
    } else return !1;
  }
}
function Je(n) {
...
function Rf(n, e) {
  for (;;) {
    ...
    } else if (n.parentNode && !er(n)) (e = Ae(n)), (n = n.parentNode);
    else return null;
  }
}
function Pf(n, e) {
  for (;;) {
    ...
    } else if (n.parentNode && !er(n)) (e = Ae(n) + 1), (n = n.parentNode);
    else return null;
  }
}
function Lf(n, e, t) {
  for (let r = e == 0, s = e == Je(n); r || s; ) {
    if (n == t) return !0;
    let i = Ae(n);
...
const xs = function (n) {
  return n.focusNode && Qt(n.focusNode, n.focusOffset, n.anchorNode, n.anchorOffset);
};
function Ht(n, e) {
...
function Bf(n, e, t) {
  if (n.caretPositionFromPoint)
    try {
      ...
      if (r) return { node: r.offsetNode, offset: Math.min(Je(r.offsetNode), r.offset) };
    } catch {}
  if (n.caretRangeFromPoint) {
    let r = n.caretRangeFromPoint(e, t);
    if (r) return { node: r.startContainer, offset: Math.min(Je(r.startContainer), r.startOffset) };
  }
}
const lt = typeof navigator < 'u' ? navigator : null,
  el = typeof document < 'u' ? document : null,
  Lt = (lt && lt.userAgent) || '',
  mi = /Edge\/(\d+)/.exec(Lt),
  Xa = /MSIE \d/.exec(Lt),
  gi = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(Lt),
  Fe = !!(Xa || gi || mi),
  Nt = Xa ? document.documentMode : gi ? +gi[1] : mi ? +mi[1] : 0,
  Ge = !Fe && /gecko\/(\d+)/i.test(Lt);
Ge && +(/Firefox\/(\d+)/.exec(Lt) || [0, 0])[1];
const yi = !Fe && /Chrome\/(\d+)/.exec(Lt),
  Oe = !!yi,
  Ya = yi ? +yi[1] : 0,
  De = !Fe && !!lt && /Apple Computer/.test(lt.vendor),
  gn = De && (/Mobile\/\w+/.test(Lt) || (!!lt && lt.maxTouchPoints > 2)),
  qe = gn || (lt ? /Mac/.test(lt.platform) : !1),
  Qa = lt ? /Win/.test(lt.platform) : !1,
  pt = /Android \d/.test(Lt),
  tr = !!el && 'webkitFontSmoothing' in el.documentElement.style,
  _f = tr ? +(/\bAppleWebKit\/(\d+)/.exec(navigator.userAgent) || [0, 0])[1] : 0;
function Hf(n) {
  ...
  for (let o = t || n.dom; o; ) {
    ...
    if (
      (e.top < c.top + ct(r, 'top')
        ? (u = -(c.top - e.top + ct(s, 'top')))
        : e.bottom > c.bottom - ct(r, 'bottom') &&
          (u =
            e.bottom - e.top > c.bottom - c.top
              ? e.top + ct(s, 'top') - c.top
              : e.bottom - c.bottom + ct(s, 'bottom')),
      e.left < c.left + ct(r, 'left')
        ? (d = -(c.left - e.left + ct(s, 'left')))
        : e.right > c.right - ct(r, 'right') && (d = e.right - c.right + ct(s, 'right')),
      d || u)
    )
...
function Vf(n) {
  ...
  return { refDOM: r, refTop: s, stack: Za(n.dom) };
}
function Za(n) {
  let e = [],
    t = n.ownerDocument;
...
function jf({ refDOM: n, refTop: e, stack: t }) {
      ...
      if (p.top <= o && p.bottom >= l) {
        ...
        if (m < r) {
          (t = d),
            (r = m),
            (s =
              m && t.nodeType == 3 ? { left: p.right < e.left ? p.right : p.left, top: e.top } : e),
...
function nc(n, e, t) {
  ...
  if (r && t.top < t.bottom)
    for (
      let s = Math.max(
          0,
          Math.min(r - 1, Math.floor((r * (e.top - t.top)) / (t.bottom - t.top)) - 2),
        ),
        i = s;
      ;
    ) {
...
function Gf(n, e) {
  ...
  if (!o || !n.dom.contains(o.nodeType != 1 ? o.parentNode : o)) {
    ...
    if (!Gi(e, c) || ((o = nc(n.dom, e, c)), !o)) return null;
  }
  if (De) for (let c = o; r && c; c = mn(c)) c.draggable && (r = void 0);
  if (((o = Uf(o, e)), r)) {
    if (
      Ge &&
      r.nodeType == 1 &&
...
function rc(n, e, t) {
  let { node: r, offset: s, atom: i } = n.docView.domFromPos(e, t < 0 ? -1 : 1),
    o = tr || Ge;
  if (r.nodeType == 3)
    if (o && (Xf.test(r.nodeValue) || (t < 0 ? !s : s == r.nodeValue.length))) {
      let a = kt(ht(r, s, s), t);
      if (Ge && s && /\s/.test(r.nodeValue[s - 1]) && s < r.nodeValue.length) {
        let c = kt(ht(r, s - 1, s - 1), -1);
        if (c.top == a.top) {
          let d = kt(ht(r, s, s + 1), -1);
          if (d.top != a.top) return Sn(d, d.left < c.left);
        }
      }
      return a;
    } else {
        ...
        t < 0 && !s
          ...
          : t >= 0 && s == r.nodeValue.length
            ...
            : t < 0
              ? a--
              : c++,
        Sn(kt(ht(r, a, c), d), d < 0)
      );
    }
  if (!n.state.doc.resolve(e - (i || 0)).parent.inlineContent) {
    if (i == null && s && (t < 0 || s == Je(r))) {
      let a = r.childNodes[s - 1];
      if (a.nodeType == 1) return Ws(a.getBoundingClientRect(), !1);
    }
    if (i == null && s < Je(r)) {
      let a = r.childNodes[s];
      if (a.nodeType == 1) return Ws(a.getBoundingClientRect(), !0);
    }
      ...
      c =
        a.nodeType == 3
          ...
          : a.nodeType == 1 && (a.nodeName != 'BR' || !a.nextSibling)
            ? a
            : null;
    if (c) return Sn(kt(c, 1), !1);
  }
  if (i == null && s < Je(r)) {
    let a = r.childNodes[s];
    for (; a.pmViewDesc && a.pmViewDesc.ignoreForCoords; ) a = a.nextSibling;
    let c = a ? (a.nodeType == 3 ? ht(a, 0, o ? 0 : 1) : a.nodeType == 1 ? a : null) : null;
    if (c) return Sn(kt(c, -1), !0);
  }
  return Sn(kt(r.nodeType == 3 ? ht(r) : r, -t), t >= 0);
}
function Sn(n, e) {
...
function Yf(n, e, t) {
  ...
  return sc(n, e, () => {
    ...
    for (let l = i.firstChild; l; l = l.nextSibling) {
      ...
      else if (l.nodeType == 3) a = ht(l, 0, l.nodeValue.length).getClientRects();
      else continue;
...
function Zf(n, e, t) {
  ...
  let s = r.parentOffset,
    ...
    l = n.domSelection();
  return l
    ? !Qf.test(r.parent.textContent) || !l.modify
      ? t == 'left' || t == 'backward'
        ? i
        : o
      : sc(n, e, () => {
...
function eh(n, e, t) {
  return rl == e && sl == t
    ? il
    : ((rl = e), (sl = t), (il = t == 'up' || t == 'down' ? Yf(n, e, t) : Zf(n, e, t)));
}
const Xe = 0,
  ol = 1,
  Ft = 2,
...
class nr {
  ...
  localPosFromDOM(e, t, r) {
    if (this.contentDOM && this.contentDOM.contains(e.nodeType == 1 ? e : e.parentNode))
      if (r < 0) {
        ...
        for (; i && !((o = i.pmViewDesc) && o.parent == this); ) i = i.previousSibling;
    ...
    let s;
    if (e == this.dom && this.contentDOM) s = t > Ae(this.contentDOM);
  ...
  domFromPos(e, t) {
    ...
    for (let i; r && !(i = this.children[r - 1]).size && i instanceof ic && i.side >= 0; r--);
    if (t <= 0) {
      let i,
        o = !0;
      for (
      ...
      return i && t && o && !i.border && !i.domAtom
        ...
        : { node: this.contentDOM, offset: i ? Ae(i.dom) + 1 : 0 };
    } else {
      let i,
        o = !0;
      for (
      ...
      return i && o && !i.border && !i.domAtom
        ? i.domFromPos(0, t)
        : { node: this.contentDOM, offset: i ? Ae(i.dom) : this.contentDOM.childNodes.length };
    }
  }
  parseRange(e, t, r = 0) {
  ...
  setSelection(e, t, r, s = !1) {
    ...
    for (let h = 0, p = 0; h < this.children.length; h++) {
      let m = this.children[h],
        g = p + m.size;
      if (i > p && o < g) return m.setSelection(e - p - m.border, t - p - m.border, r, s);
      p = g;
    }
...
`
    ...
    if (Ge && d.focusNode && d.focusNode != a.node && d.focusNode.nodeType == 1) {
      let h = d.focusNode.childNodes[d.focusOffset];
      h && h.contentEditable == 'false' && (s = !0);
    }
    if (
      !(s || (u && De)) &&
      Qt(l.node, l.offset, d.anchorNode, d.anchorOffset) &&
      Qt(a.node, a.offset, d.focusNode, d.focusOffset)
    )
      return;
    let f = !1;
    if ((c.extend || e == t) && !(u && Ge)) {
...
class Zt extends nr {
  ...
  static create(e, t, r, s) {
    let i = s.nodeViews[t.type.name],
      o = i && i(t, s, r);
    return (
      (!o || !o.dom) && (o = tn.renderSpec(document, t.type.spec.toDOM(t, r), null, t.attrs)),
      new Zt(e, t, o.dom, o.contentDOM || o.dom, o)
    );
  }
  parseRule() {
    return this.dirty & at || this.mark.type.spec.reparseInView
      ? null
  ...
  slice(e, t, r) {
    let s = Zt.create(this.parent, this.mark, !0, r),
      i = this.children,
      o = this.size;
    t < o && (i = ki(i, t, o, r)), e > 0 && (i = ki(i, 0, e, r));
...
class Ot extends nr {
  ...
  static create(e, t, r, s, i, o) {
    ...
    if (t.isText) {
      ...
      d ||
        ({ dom: d, contentDOM: u } = tn.renderSpec(document, t.type.spec.toDOM(t), null, t.attrs));
    !u &&
      !t.isText &&
      d.nodeName != 'BR' &&
    ...
    return (
      (d = cc(d, r, t)),
      c
        ? (a = new nh(e, t, r, s, d, u || null, f, c, i, o + 1))
        : t.isText
          ? new vs(e, t, r, s, d, f, i)
          : new Ot(e, t, r, s, d, u || null, f, i, o + 1)
    );
  }
  parseRule() {
  ...
  matchesNode(e, t, r) {
    return this.dirty == Xe && e.eq(this.node) && Er(t, this.outerDeco) && r.eq(this.innerDeco);
  }
  get size() {
    ...
    lh(
      ...
      (c, d, u) => {
        c.spec.marks
          ...
          : c.type.side >= 0 &&
            !u &&
            a.syncToMarks(d == this.node.childCount ? U.none : this.node.child(d).marks, r, e, d),
          a.placeWidget(c, e, s);
      },
      (c, d, u, f) => {
      ...
      (a.changed || this.dirty == Ft) &&
        ...
        lc(this.contentDOM, this.children, e),
        gn && ah(this.dom));
  }
  localCompositionInfo(e, t) {
    let { from: r, to: s } = e.state.selection;
    if (!(e.state.selection instanceof R) || r < t || s > t + this.node.content.size) return null;
    let i = e.input.compositionNode;
    if (!i || !this.dom.contains(i.parentNode)) return null;
    if (this.node.inlineContent) {
      let o = i.nodeValue,
        l = ch(this.node.content, o, r - t, s - t);
  ...
  protectLocalComposition(e, { node: t, pos: r, text: s }) {
    ...
    let o = new th(this, i, t, s);
    e.input.compositionNodes.push(o), (this.children = ki(this.children, r, r + s.length, e, o));
  }
  update(e, t, r, s) {
    return this.dirty == at || !e.sameMarkup(this.node) ? !1 : (this.updateInner(e, t, r, s), !0);
  }
  updateInner(e, t, r, s) {
  ...
  updateOuterDeco(e) {
    if (Er(e, this.outerDeco)) return;
    let t = this.nodeDOM.nodeType != 1,
      r = this.dom;
    (this.dom = ac(this.dom, this.nodeDOM, bi(this.outerDeco, this.node, t), bi(e, this.node, t))),
...
function ll(n, e, t, r, s) {
  cc(r, e, n);
  let i = new Ot(void 0, n, e, t, r, r, r, s, 0);
...
class vs extends Ot {
  ...
  update(e, t, r, s) {
    return this.dirty == at || (this.dirty != Xe && !this.inParent()) || !e.sameMarkup(this.node)
      ? !1
      : (this.updateOuterDeco(t),
        (this.dirty != Xe || e.text != this.node.text) &&
  ...
  slice(e, t, r) {
    ...
    return new vs(this.parent, s, this.outerDeco, this.innerDeco, i, i, r);
  }
  markDirty(e, t) {
    super.markDirty(e, t),
...
function lc(n, e, t) {
  ...
  for (let i = 0; i < e.length; i++) {
    ...
    if (o instanceof Zt) {
      ...
      lc(o.contentDOM, o.children, t), (r = a ? a.nextSibling : n.firstChild);
    }
  }
  for (; r; ) (r = al(r)), (s = !0);
...
Rn.prototype = Object.create(null);
const Vt = [new Rn()];
function bi(n, e, t) {
  ...
  for (let i = 0; i < n.length; i++) {
    ...
    if (o) {
      o.nodeName && s.push((r = new Rn(o.nodeName)));
      for (let l in o) {
        let a = o[l];
        a != null &&
          (t && s.length == 1 && s.push((r = new Rn(e.isInline ? 'span' : 'div'))),
          l == 'class'
...
function rh(n, e, t) {
  ...
  if (e.class != t.class) {
    ...
    for (let i = 0; i < r.length; i++) s.indexOf(r[i]) == -1 && n.classList.remove(r[i]);
    for (let i = 0; i < s.length; i++) r.indexOf(s[i]) == -1 && n.classList.add(s[i]);
...
function cc(n, e, t) {
  return ac(n, n, Vt, bi(e, t, n.nodeType != 1));
}
function Er(n, e) {
  if (n.length != e.length) return !1;
...
class sh {
  constructor(e, t, r) {
    (this.lock = t),
      ...
      (this.changed = !1),
      (this.top = e),
      (this.preMatch = ih(e.node.content, e));
  }
  destroyBetween(e, t) {
    if (e != t) {
  ...
  syncToMarks(e, t, r, s) {
    ...
    for (; o < e.length; ) {
      ...
      if (a > -1)
        ...
        let d = Zt.create(this.top, e[o], t, r);
  ...
  updateNodeAt(e, t, r, s, i) {
    ...
    return (
      o.dirty == at && o.dom == o.contentDOM && (o.dirty = Ft),
      o.update(e, t, r, i) ? (this.destroyBetween(this.index, s), this.index++, !0) : !1
    );
  }
  ...
  updateNextNode(e, t, r, s, i, o) {
    for (let l = this.index; l < this.top.children.length; l++) {
      ...
      if (a instanceof Ot) {
        ...
        if (!f && (u = this.recreateWrapper(a, e, t, r, s, o)))
          return (
            this.destroyBetween(this.index, l),
            (this.top.children[this.index] = u),
            u.contentDOM && ((u.dirty = Ft), u.updateChildren(s, o + 1), (u.dirty = Xe)),
            (this.changed = !0),
            this.index++,
            !0
          );
  ...
  addTextblockHacks() {
    let e = this.top.children[this.index - 1],
      t = this.top;
    for (; e instanceof Zt; ) (t = e), (e = t.children[t.children.length - 1]);
    (!e ||
      !(e instanceof vs) ||
      /\n$/.test(e.node.text) ||
      (this.view.requiresGeckoHackNode && /\s$/.test(e.node.text))) &&
      ((De || Oe) && e && e.dom.contentEditable == 'false' && this.addHackNode('IMG', t),
  ...
  addHackNode(e, t) {
    if (t == this.top && this.index < t.children.length && t.children[this.index].matchesHack(e))
      ...
      let s = new oc(this.top, [], r, null);
      t != this.top ? t.children.push(s) : t.children.splice(this.index++, 0, s),
        (this.changed = !0);
    }
  }
  isLocked(e) {
  ...
  e: for (; s > 0; ) {
    ...
    for (;;)
      if (r) {
        ...
        if (c instanceof Zt) (t = c), (r = c.children.length);
        else {
          (l = c), r--;
          break;
        }
...
function lh(n, e, t, r) {
  ...
  for (let c = 0; ; ) {
    ...
    } else for (; o < s.length && s[o].to < p; ) o++;
  ...
  for (let o = 0, l = 0; o < n.length; o++) {
    ...
    c >= t || d <= e
      ...
      : (c < e && i.push(a.slice(0, e - c, r)),
        s && (i.push(s), (s = void 0)),
        d > t && i.push(a.slice(t - c, a.size, r)));
  }
  return i;
}
function Xi(n, e = null) {
  ...
  if (xs(t)) {
    ...
    if (
      ...
      D.isSelectable(u) &&
      s.parent &&
      !(u.isInline && Lf(t.focusNode, t.focusOffset, s.dom))
    ) {
      let f = s.posBefore;
...
function dc(n) {
  return n.editable
    ? n.hasFocus()
    : fc(n) && document.activeElement && document.activeElement.contains(n.dom);
}
function gt(n, e = !1) {
  ...
  if ((uc(n, t), !!dc(n))) {
    if (!e && n.input.mouseDown && n.input.mouseDown.allowDefault && Oe) {
      ...
      if (
        r.anchorNode &&
        s.anchorNode &&
        Qt(r.anchorNode, r.anchorOffset, s.anchorNode, s.anchorOffset)
      ) {
        (n.input.mouseDown.delayedSelectionSync = !0), n.domObserver.setCurSelection();
        return;
      }
    }
    if ((n.domObserver.disconnectSelection(), n.cursorWrapper)) uh(n);
    else {
      ...
      cl &&
        !(t instanceof R) &&
        (t.$from.parent.inlineContent || (i = dl(n, t.from)),
        !t.empty && !t.$from.parent.inlineContent && (o = dl(n, t.to))),
...
function Ks(n) {
  return (
    ...
    De && n.draggable && ((n.draggable = !1), (n.wasDraggable = !0)),
    n
  );
}
function ul(n) {
  ...
  e.addEventListener(
    ...
    (n.input.hideSelectionGuard = () => {
      (t.anchorNode != r || t.anchorOffset != s) &&
        (e.removeEventListener('selectionchange', n.input.hideSelectionGuard),
        setTimeout(() => {
          (!dc(n) || n.state.selection.visible) &&
            n.dom.classList.remove('ProseMirror-hideselection');
        }, 20));
    }),
  );
...
function uh(n) {
  ...
  r ? e.collapse(t.parentNode, Ae(t) + 1) : e.collapse(t, 0),
    !r && !n.state.selection.visible && Fe && Nt <= 11 && ((t.disabled = !0), (t.disabled = !1));
}
function uc(n, e) {
  if (e instanceof D) {
...
function Yi(n, e, t, r) {
  return n.someProp('createSelectionBetween', (s) => s(n, e, t)) || R.between(e, t, r);
}
function hl(n) {
  return n.editable && !n.hasFocus() ? !1 : fc(n);
}
function fc(n) {
...
function fh(n) {
  ...
  return Qt(e.node, e.offset, t.anchorNode, t.anchorOffset);
}
function xi(n, e) {
...
function pl(n, e, t) {
  ...
  if (r instanceof R)
    if (t.indexOf('s') > -1) {
      ...
      return xt(n, new R(r.$anchor, o));
    } else if (r.empty) {
      if (n.endOfTextblock(e > 0 ? 'forward' : 'backward')) {
        let s = xi(n.state, e);
        return s && s instanceof D ? xt(n, s) : !1;
        ...
        return i.isAtom || ((o = n.docView.descAt(l)) && !o.contentDOM)
          ? D.isSelectable(i)
            ? xt(n, new D(e < 0 ? n.state.doc.resolve(s.pos - i.nodeSize) : s))
            : tr
              ? xt(n, new R(n.state.doc.resolve(e < 0 ? l : l + i.nodeSize)))
              : !1
          : !1;
      }
    } else return !1;
  else {
    if (r instanceof D && r.node.isInline) return xt(n, new R(e > 0 ? r.$to : r.$from));
    {
      let s = xi(n.state, e);
      return s ? xt(n, s) : !1;
    }
...
function hh(n) {
  ...
  let s,
    i,
    o = !1;
  for (Ge && t.nodeType == 1 && r < Ar(t) && Pn(t.childNodes[r], -1) && (o = !0); ; )
    if (r > 0) {
      ...
      if (hc(t)) break;
      {
        ...
        for (; l && Pn(l, -1); ) (s = t.parentNode), (i = Ae(l)), (l = l.previousSibling);
        if (l) (t = l), (r = Ar(t));
        else {
...
function ph(n) {
  ...
  for (;;)
    if (r < s) {
      ...
      {
        let l = t.nextSibling;
        for (; l && Pn(l, 1); ) (i = l.parentNode), (o = Ae(l) + 1), (l = l.nextSibling);
        if (l) (t = l), (r = 0), (s = Ar(t));
        else {
          if (((t = t.parentNode), t == n.dom)) break;
          r = s = 0;
...
function mh(n, e) {
  for (; n && e == n.childNodes.length && !er(n); ) (e = Ae(n) + 1), (n = n.parentNode);
...
function gh(n, e) {
  for (; n && !e && !er(n); ) (e = Ae(n)), (n = n.parentNode);
  for (; n && e; ) {
...
function vi(n, e, t) {
  if (e.nodeType != 3) {
    let i, o;
    (o = mh(e, t)) ? ((e = o), (t = 0)) : (i = gh(e, t)) && ((e = i), (t = i.nodeValue.length));
  }
...
function ml(n, e) {
  ...
  if (!(Oe || Qa) && t.parent.inlineContent) {
...
function gl(n, e, t) {
  let r = n.state.selection;
  if ((r instanceof R && !r.empty) || t.indexOf('s') > -1 || (qe && t.indexOf('m') > -1)) return !1;
  let { $from: s, $to: i } = r;
  if (!s.parent.inlineContent || n.endOfTextblock(e < 0 ? 'up' : 'down')) {
    let o = xi(n.state, e);
    if (o && o instanceof D) return xt(n, o);
  }
  if (!s.parent.inlineContent) {
    let o = e < 0 ? s : i,
      l = r instanceof We ? _.near(o, e) : _.findFrom(o, e);
    return l ? xt(n, l) : !1;
  }
  return !1;
}
function yl(n, e) {
  if (!(n.state.selection instanceof R)) return !0;
  ...
  if (i && !i.isText) {
    let o = n.state.tr;
    return (
      e < 0 ? o.delete(t.pos - i.nodeSize, t.pos) : o.delete(t.pos, t.pos + i.nodeSize),
      n.dispatch(o),
      !0
    );
  }
...
function yh(n) {
  ...
  if (e && e.nodeType == 1 && t == 0 && e.firstChild && e.firstChild.contentEditable == 'false') {
    let r = e.firstChild;
    bl(n, r, 'true'), setTimeout(() => bl(n, r, 'false'), 20);
  }
  return !1;
}
function bh(n) {
...
function kh(n, e) {
  let t = e.keyCode,
    r = bh(e);
  if (t == 8 || (qe && t == 72 && r == 'c')) return yl(n, -1) || sn(n, -1);
  if ((t == 46 && !e.shiftKey) || (qe && t == 68 && r == 'c')) return yl(n, 1) || sn(n, 1);
  if (t == 13 || t == 27) return !0;
  if (t == 37 || (qe && t == 66 && r == 'c')) {
    let s = t == 37 ? (ml(n, n.state.selection.from) == 'ltr' ? -1 : 1) : -1;
    return pl(n, s, r) || sn(n, s);
  } else if (t == 39 || (qe && t == 70 && r == 'c')) {
    let s = t == 39 ? (ml(n, n.state.selection.from) == 'ltr' ? 1 : -1) : 1;
    return pl(n, s, r) || sn(n, s);
  } else {
    if (t == 38 || (qe && t == 80 && r == 'c')) return gl(n, -1, r) || sn(n, -1);
    if (t == 40 || (qe && t == 78 && r == 'c')) return yh(n) || gl(n, 1, r) || sn(n, 1);
    if (r == (qe ? 'm' : 'c') && (t == 66 || t == 73 || t == 89 || t == 90)) return !0;
  }
  return !1;
}
function Qi(n, e) {
  ...
  let c = a.firstChild,
    d,
    u = 0;
  for (; c && c.nodeType == 1 && (d = bc[c.nodeName.toLowerCase()]); ) {
  ...
  c &&
    c.nodeType == 1 &&
    c.setAttribute('data-pm-slice', `${s} ${i}${u ? ` -${u}` : ''} ${JSON.stringify(t)}`);
  let f =
...
`,
    ...
    let u = n.someProp('clipboardTextParser', (f) => f(e, s, r, n));
    if (u) l = u;
    else {
      let f = s.marks(),
        { schema: h } = n.state,
  ...
  if (
    ...
    l = Ch(kl(l, +d[1], +d[2]), d[4]);
  else if (((l = w.maxOpen(vh(l.content, s), !0)), l.openStart || l.openEnd)) {
    let u = 0,
      f = 0;
    for (
    ...
    if (
      (n.forEach((l) => {
        ...
        let a = s.findWrapping(l.type),
          c;
        if (!a) return (o = null);
        if ((c = o.length && i.length && gc(a, i, l, o[o.length - 1], 0))) o[o.length - 1] = c;
        else {
          o.length && (o[o.length - 1] = yc(o[o.length - 1], i.length));
          let d = mc(l, a);
...
function gc(n, e, t, r, s) {
  if (s < n.length && s < e.length && n[s] == e[s]) {
    let i = gc(n, e, t, r.lastChild, s + 1);
    ...
    if (r.contentMatchAt(r.childCount).matchType(s == n.length - 1 ? t.type : n[s + 1]))
      return r.copy(r.content.append(b.from(mc(t, n, s + 1))));
  }
}
function yc(n, e) {
  if (e == 0) return n;
  let t = n.content.replaceChild(n.childCount - 1, yc(n.lastChild, e - 1)),
    r = n.contentMatchAt(n.childCount).fillBefore(b.empty, !0);
  return n.copy(t.append(r));
}
function Si(n, e, t, r, s, i) {
  let o = e < 0 ? n.firstChild : n.lastChild,
    l = o.content;
  return (
    n.childCount > 1 && (i = 0),
    s < r - 1 && (l = Si(l, e, t, r, s + 1, i)),
    s >= t &&
      (l =
        e < 0
          ? o
              ...
              .fillBefore(l, i <= s)
              .append(l)
          : l.append(o.contentMatchAt(o.childCount).fillBefore(b.empty, !0))),
    n.replaceChild(e < 0 ? 0 : n.childCount - 1, o.copy(l))
  );
}
function kl(n, e, t) {
  return (
    e < n.openStart && (n = new w(Si(n.content, -1, e, n.openStart, 0, n.openEnd), e, n.openEnd)),
    t < n.openEnd && (n = new w(Si(n.content, 1, t, n.openEnd, 0, 0), n.openStart, t)),
    n
  );
}
const bc = {
...
function Sh(n) {
  ...
  return e
    ? (Us ||
        (Us = e.defaultPolicy || e.createPolicy('ProseMirrorClipboard', { createHTML: (t) => t })),
      Us.createHTML(n))
    : n;
}
function Mh(n) {
  ...
  let t = kc().createElement('div'),
    r = /<([a-z][^>\s]+)/i.exec(n),
    s;
  if (
    ((s = r && bc[r[1].toLowerCase()]) &&
      (n =
        s.map((i) => '<' + i + '>').join('') +
        n +
        s
  ...
  for (let e in Le) {
    ...
    n.dom.addEventListener(
      ...
      (n.input.eventHandlers[e] = (r) => {
        Oh(n, r) && !Zi(n, r) && (n.editable || !(r.type in ze)) && t(n, r);
      }),
      Th[e] ? { passive: !0 } : void 0,
    );
  }
  De && n.dom.addEventListener('input', () => null), Mi(n);
}
function Et(n, e) {
  ...
  n.someProp('handleDOMEvents', (e) => {
    for (let t in e)
      n.input.eventHandlers[t] ||
        n.dom.addEventListener(t, (n.input.eventHandlers[t] = (r) => Zi(n, r)));
  });
}
function Zi(n, e) {
...
function Ih(n, e) {
  !Zi(n, e) && Le[e.type] && (n.editable || !(e.type in ze)) && Le[e.type](n, e);
}
ze.keydown = (n, e) => {
  let t = e;
  if (
    ...
    if (
      ...
      gn && t.keyCode == 13 && !t.ctrlKey && !t.altKey && !t.metaKey)
    ) {
      let r = Date.now();
      (n.input.lastIOSEnter = r),
        (n.input.lastIOSEnterFallbackTimeout = setTimeout(() => {
          n.input.lastIOSEnter == r &&
            (n.someProp('handleKeyDown', (s) => s(n, Ht(13, 'Enter'))), (n.input.lastIOSEnter = 0));
        }, 200));
    } else
      n.someProp('handleKeyDown', (r) => r(n, t)) || kh(n, t) ? t.preventDefault() : Et(n, 'key');
};
ze.keyup = (n, e) => {
...
ze.keypress = (n, e) => {
  let t = e;
  if (vc(n, t) || !t.charCode || (t.ctrlKey && !t.altKey) || (qe && t.metaKey)) return;
...
function $h(n, e) {
  ...
  let t = n.state.doc.resolve(e),
    r = t.nodeAfter;
  return r && r.isAtom && D.isSelectable(r) ? (fn(n, new D(t)), !0) : !1;
}
function Rh(n, e) {
  if (e == -1) return !1;
  let t = n.state.selection,
  ...
  for (let o = i.depth + 1; o > 0; o--) {
    ...
    if (D.isSelectable(l)) {
      r && t.$from.depth > 0 && o >= t.$from.depth && i.before(t.$from.depth + 1) == t.$from.pos
        ? (s = i.before(t.$from.depth))
        : (s = i.before(o));
      break;
    }
  }
  return s != null ? (fn(n, D.create(n.state.doc, s)), !0) : !1;
}
function Ph(n, e, t, r, s) {
  return (
    eo(n, 'handleClickOn', e, t, r) ||
...
function Lh(n, e, t, r) {
  return (
    eo(n, 'handleDoubleClickOn', e, t, r) || n.someProp('handleDoubleClick', (s) => s(n, e, r))
  );
}
function zh(n, e, t, r) {
  return (
    eo(n, 'handleTripleClickOn', e, t, r) ||
...
function Bh(n, e, t) {
  ...
  let r = n.state.doc;
  if (e == -1) return r.inlineContent ? (fn(n, R.create(r, 0, r.content.size)), !0) : !1;
  let s = r.resolve(e);
  for (let i = s.depth + 1; i > 0; i--) {
    let o = i > s.depth ? s.nodeAfter : s.node(i),
      l = s.before(i);
    if (o.inlineContent) fn(n, R.create(r, l + 1, l + 1 + o.content.size));
    else if (D.isSelectable(o)) fn(n, D.create(r, l));
    else continue;
    return !0;
  }
}
...
Le.mousedown = (n, e) => {
  ...
  s - n.input.lastClick.time < 500 &&
    Dh(t, n.input.lastClick) &&
    !t[xc] &&
    n.input.lastClick.button == t.button &&
    (n.input.lastClick.type == 'singleClick'
      ? (i = 'doubleClick')
      : n.input.lastClick.type == 'doubleClick' && (i = 'tripleClick')),
    (n.input.lastClick = { time: s, x: t.clientX, y: t.clientY, type: i, button: t.button });
  let o = n.posAtCoords(Ss(t));
  o &&
    (i == 'singleClick'
      ? (n.input.mouseDown && n.input.mouseDown.done(), (n.input.mouseDown = new _h(n, o, t, !!r)))
      : (i == 'doubleClick' ? Lh : zh)(n, o.pos, o.inside, t)
        ? t.preventDefault()
        : Et(n, 'pointer'));
};
class _h {
  constructor(e, t, r, s) {
    ...
    r.button == 0 &&
      ((i.type.spec.draggable && i.type.spec.selectable !== !1) ||
        (c instanceof D && c.from <= o && c.to > o)) &&
      (this.mightDrag = {
        node: i,
        pos: o,
  ...
  up(e) {
    ...
    let t = this.pos;
    this.view.state.doc != this.startDoc && (t = this.view.posAtCoords(Ss(e))),
      this.updateAllowDefault(e),
      this.allowDefault || !t
        ? Et(this.view, 'pointer')
        : Ph(this.view, t.pos, t.inside, e, this.selectNode)
          ? e.preventDefault()
          : e.button == 0 &&
              (this.flushed ||
                (De && this.mightDrag && !this.mightDrag.node.isAtom) ||
                (Oe &&
            ...
            ? (fn(this.view, _.near(this.view.state.doc.resolve(t.pos))), e.preventDefault())
            : Et(this.view, 'pointer');
  }
  move(e) {
...
Le.touchstart = (n) => {
  (n.input.lastTouch = Date.now()), to(n), Et(n, 'pointer');
};
Le.touchmove = (n) => {
  (n.input.lastTouch = Date.now()), Et(n, 'pointer');
};
Le.contextmenu = (n) => to(n);
function vc(n, e) {
  return n.composing
    ? !0
    : De && Math.abs(e.timeStamp - n.input.compositionEndedAt) < 500
...
ze.compositionstart = ze.compositionupdate = (n) => {
  if (!n.composing) {
    ...
    if (
      ...
      (Nr(n, !e.selection.empty),
      Ge && e.selection.empty && t.parentOffset && !t.textOffset && t.nodeBefore.marks.length)
    ) {
      let r = n.domSelectionRange();
...
function Mc(n) {
  for (
    n.composing && ((n.input.composing = !1), (n.input.compositionEndedAt = jh()));
...
function Vh(n) {
  ...
  let t = Rf(e.focusNode, e.focusOffset),
    r = Pf(e.focusNode, e.focusOffset);
  if (t && r && t != r) {
    let s = r.pmViewDesc,
...
function Nr(n, e = !1) {
  if (!(pt && n.domObserver.flushingSoon >= 0)) {
    if ((n.domObserver.forceFlush(), Mc(n), e || (n.docView && n.docView.dirty))) {
      let t = Xi(n),
        r = n.state.selection;
      return (
        t && !t.eq(r)
...
const qn = (Fe && Nt < 15) || (gn && _f < 604);
Le.copy = ze.cut = (n, e) => {
  let t = e,
    r = n.state.selection,
    s = t.type == 'cut';
  if (r.empty) return;
  let i = qn ? null : t.clipboardData,
    o = r.content(),
    { dom: l, text: a } = Qi(n, o);
  i
    ? (t.preventDefault(),
    ...
    : Wh(n, l),
    s && n.dispatch(n.state.tr.deleteSelection().scrollIntoView().setMeta('uiEvent', 'cut'));
};
function Kh(n) {
...
function Uh(n, e) {
  ...
  setTimeout(() => {
    n.focus(),
      ...
      t ? Jn(n, r.value, null, s, e) : Jn(n, r.textContent, r.innerHTML, s, e);
  }, 50);
}
function Jn(n, e, t, r, s) {
  let i = pc(n, e, t, r, n.state.selection.$from);
  if (n.someProp('handlePaste', (a) => a(n, s, i || w.empty))) return !0;
  if (!i) return !1;
  let o = Kh(i),
    l = o ? n.state.tr.replaceSelectionWith(o, r) : n.state.tr.replaceSelection(i);
...
ze.paste = (n, e) => {
  let t = e;
  if (n.composing && !pt) return;
  let r = qn ? null : t.clipboardData,
    s = n.input.shiftKey && n.input.lastKeyCode != 45;
  r && Jn(n, wc(r), r.getData('text/html'), s, t) ? t.preventDefault() : Uh(n, t);
};
class Cc {
  constructor(e, t, r) {
...
Le.dragstart = (n, e) => {
  ...
  let s = n.state.selection,
    i = s.empty ? null : n.posAtCoords(Ss(t)),
    o;
  if (!(i && i.pos >= s.from && i.pos <= (s instanceof D ? s.to - 1 : s.to))) {
    if (r && r.mightDrag) o = D.create(n.state.doc, r.mightDrag.pos);
    else if (t.target && t.target.nodeType == 1) {
      let u = n.docView.nearestDesc(t.target, !0);
      u && u.node.type.spec.draggable && u != n.docView && (o = D.create(n.state.doc, u.posBefore));
    }
  }
  let l = (o || n.state.selection).content(),
    { dom: a, text: c, slice: d } = Qi(n, l);
  (!t.dataTransfer.files.length || !Oe || Ya > 120) && t.dataTransfer.clearData(),
    t.dataTransfer.setData(qn ? 'Text' : 'text/html', a.innerHTML),
    (t.dataTransfer.effectAllowed = 'copyMove'),
    qn || t.dataTransfer.setData('text/plain', c),
    (n.dragging = new Cc(d, Tc(n, t), o));
};
Le.dragend = (n) => {
  let e = n.dragging;
  window.setTimeout(() => {
...
function Jh(n, e, t) {
  ...
  i
    ...
    : (i = pc(n, wc(e.dataTransfer), qn ? null : e.dataTransfer.getData('text/html'), !1, s));
  let o = !!(t && Tc(n, e));
  if (n.someProp('handleDrop', (h) => h(n, e, i || w.empty, o))) {
    e.preventDefault();
    return;
  }
  if (!i) return;
  e.preventDefault();
  let l = i ? Oa(n.state.doc, s.pos, i) : s.pos;
  l == null && (l = s.pos);
  let a = n.state.tr;
  if (o) {
    let { node: h } = t;
  ...
  if (
    ...
    a.mapping.maps[a.mapping.maps.length - 1].forEach((p, m, g, y) => (h = y)),
      a.setSelection(Yi(n, f, a.doc.resolve(h)));
  }
...
Le.beforeinput = (n, e) => {
  if (Oe && pt && e.inputType == 'deleteContentBackward') {
    n.domObserver.flushSoon();
    let { domChangeCount: r } = n.input;
    setTimeout(() => {
      if (
        n.input.domChangeCount != r ||
        (n.dom.blur(), n.focus(), n.someProp('handleKeyDown', (i) => i(n, Ht(8, 'Backspace'))))
      )
        return;
...
class Or {
  constructor(e, t) {
    (this.toDOM = e), (this.spec = t || qt), (this.side = this.spec.side || 0);
  }
  map(e, t, r, s) {
    let { pos: i, deleted: o } = e.mapResult(t.from + s, this.side < 0 ? -1 : 1);
    return o ? null : new Pe(i - r, i - r, this);
  }
  valid() {
    return !0;
  }
    ...
    return (
      ...
      (e instanceof Or &&
        ((this.spec.key && this.spec.key == e.spec.key) ||
          (this.toDOM == e.toDOM && Gn(this.spec, e.spec))))
    );
  }
  destroy(e) {
...
class It {
  ...
  map(e, t, r, s) {
    ...
    return i >= o ? null : new Pe(i, o, this);
  }
  valid(e, t) {
    return t.from < t.to;
  }
  eq(e) {
    return this == e || (e instanceof It && Gn(this.attrs, e.attrs) && Gn(this.spec, e.spec));
  }
  static is(e) {
...
class no {
  ...
  map(e, t, r, s) {
    ...
    return o.deleted || o.pos <= i.pos ? null : new Pe(i.pos - r, o.pos - r, this);
  }
  valid(e, t) {
  ...
  eq(e) {
    return this == e || (e instanceof no && Gn(this.attrs, e.attrs) && Gn(this.spec, e.spec));
  }
  destroy() {}
}
class Pe {
  ...
  static widget(e, t, r) {
    return new Pe(e, e, new Or(t, r));
  }
  static inline(e, t, r, s) {
    return new Pe(e, t, new It(r, s));
  }
  static node(e, t, r, s) {
    return new Pe(e, t, new no(r, s));
  }
  get spec() {
...
class Q {
  ...
  static create(e, t) {
    return t.length ? Ir(t, e, 0, qt) : Ie;
  }
  find(e, t, r) {
    let s = [];
  ...
  map(e, t, r) {
    return this == Ie || e.maps.length == 0 ? this : this.mapInner(e, t, 0, 0, r || qt);
  }
  mapInner(e, t, r, s, i) {
    let o;
    ...
    return this.children.length
      ? Gh(this.children, o || [], e, t, r, s, i)
      : o
        ? new Q(o.sort(Jt), ln)
        : Ie;
  }
  add(e, t) {
    return t.length ? (this == Ie ? Q.create(e, t) : this.addInner(e, t, 0)) : this;
  }
  addInner(e, t, r) {
    let s,
      i = 0;
    e.forEach((l, a) => {
      ...
      if ((d = Ac(t, l, c))) {
        ...
        s[i] == a
          ? (s[i + 2] = s[i + 2].addInner(l, d, c + 1))
          : s.splice(i, 0, a, a + l.nodeSize, Ir(d, l, c + 1, qt)),
          (i += 3);
      }
    });
    let o = Ec(i ? Nc(t) : t, -r);
    for (let l = 0; l < o.length; l++) o[l].type.valid(e, o[l]) || o.splice(l--, 1);
    return new Q(o.length ? this.local.concat(o).sort(Jt) : this.local, s || this.children);
  }
  remove(e) {
  ...
  removeInner(e, t) {
    ...
    return r == this.children && s == this.local ? this : s.length || r.length ? new Q(s, r) : Ie;
  }
  forChild(e, t) {
...
class Mt {
  ...
  map(e, t) {
    const r = this.members.map((s) => s.map(e, t, qt));
    return Mt.from(r);
  }
  forChild(e, t) {
    if (t.isLeaf) return Q.empty;
    ...
    for (let s = 0; s < this.members.length; s++) {
      ...
      i != Ie && (i instanceof Mt ? (r = r.concat(i.members)) : r.push(i));
    }
    return Mt.from(r);
  }
  eq(e) {
    if (!(e instanceof Mt) || e.members.length != this.members.length) return !1;
      ...
      default:
        return new Mt(
          e.every((t) => t instanceof Q)
            ? e
            : e.reduce((t, r) => t.concat(r instanceof Q ? r : r.members), []),
        );
    }
  }
  forEachSet(e) {
  ...
  for (let c = 0, d = i; c < t.maps.length; c++) {
    ...
    t.maps[c].forEach((f, h, p, m) => {
      ...
      for (let y = 0; y < l.length; y += 3) {
        let v = l[y + 1];
        if (v < 0 || f > v + d - u) continue;
        let T = l[y] + d - u;
        h >= T ? (l[y + 1] = f <= T ? -2 : -1) : f >= d && g && ((l[y] += g), (l[y + 1] += g));
      }
      u += g;
    }),
      (d = t.maps[c].map(d, -1));
...
function Ec(n, e) {
  ...
  for (let r = 0; r < n.length; r++) {
    let s = n[r];
    t.push(new Pe(s.from + e, s.to + e, s.type));
  }
  return t;
}
function Xh(n, e, t, r, s, i, o) {
  function l(a, c) {
...
function Ir(n, e, t, r) {
  ...
  e.forEach((l, a) => {
    ...
    if (c) {
      ...
      d != Ie && s.push(a, a + l.nodeSize, d);
    }
  });
  let o = Ec(i ? Nc(n) : n, -t).sort(Jt);
  for (let l = 0; l < o.length; l++)
    o[l].type.valid(e, o[l]) || (r.onRemove && r.onRemove(o[l].spec), o.splice(l--, 1));
  return o.length || s.length ? new Q(o, s) : Ie;
}
function Jt(n, e) {
      ...
      for (let s = t + 1; s < e.length; s++) {
        ...
        if (i.from == r.from) {
          i.to != r.to &&
            ...
            vl(e, s + 1, i.copy(r.to, i.to)));
          continue;
        } else {
          i.from < r.to &&
            (e == n && (e = n.slice()),
            (e[t] = r.copy(r.from, i.from)),
            vl(e, s, r.copy(i.from, r.to)));
          break;
        }
      }
  }
...
class ep {
      ...
      (this.observer =
        ...
        new window.MutationObserver((r) => {
          ...
          r.some(
            ...
            ? this.flushSoon()
            : De && e.composing && r.some((s) => s.type == 'childList' && s.target.nodeName == 'TR')
  ...
  start() {
    this.observer && (this.observer.takeRecords(), this.observer.observe(this.view.dom, Yh)),
      this.onCharData &&
  ...
  onSelectionChange() {
    if (hl(this.view)) {
      ...
      if (Fe && Nt <= 11 && !this.view.state.selection.empty) {
        let e = this.view.domSelectionRange();
        if (e.focusNode && Qt(e.focusNode, e.focusOffset, e.anchorNode, e.anchorOffset))
  ...
  ignoreSelectionChange(e) {
    ...
    let t = new Set(),
      r;
    for (let i = e.focusNode; i; i = mn(i)) t.add(i);
  ...
  flush() {
    ...
    if (
      ...
      if (d.length == 2) {
        ...
        for (let f of d) {
          let h = f.parentNode;
          h && h.nodeName == 'LI' && (!u || rp(e, u) != h) && f.remove();
        }
      }
    }
    let c = null;
    ...
    xs(r) &&
    (c = Xi(e)) &&
    c.eq(_.near(e.state.doc.resolve(0), 1))
      ? ((e.input.lastFocus = 0), gt(e), this.currentSelection.set(r), e.scrollToSelection())
      : (i > -1 || s) &&
        (i > -1 && (e.docView.markDirty(i, o), tp(e)),
        e.input.badSafariComposition && ((e.input.badSafariComposition = !1), sp(e, a)),
  ...
  registerMutation(e, t) {
    ...
    if (e.type == 'childList') {
      ...
      let s = e.previousSibling,
        i = e.nextSibling;
      if (Fe && Nt <= 11 && e.addedNodes.length)
        for (let d = 0; d < e.addedNodes.length; d++) {
      ...
      let o = s && s.parentNode == e.target ? Ae(s) + 1 : 0,
        l = r.localPosFromDOM(e.target, o, -1),
        a = i && i.parentNode == e.target ? Ae(i) : e.target.childNodes.length,
...
function tp(n) {
  if (
    ...
    if (((n.requiresGeckoHackNode = Ge), Ml)) return;
    console.warn(
...
function wl(n, e) {
  ...
  return (
    Qt(o.node, o.offset, s, i) && ([t, r, s, i] = [s, i, t, r]),
...
function ip(n, e, t) {
  let { node: r, fromOffset: s, toOffset: i, from: o, to: l } = n.docView.parseRange(e, t),
  ...
  if (
    (d &&
      ...
      xs(a) || c.push({ node: a.focusNode, offset: a.focusOffset })),
    Oe && n.input.lastKeyCode === 8)
  )
    for (let g = i; g > s; g--) {
  ...
  let u = n.state.doc,
    f = n.someProp('domParser') || At.fromSchema(n.state.schema),
    h = u.resolve(o),
    p = null,
    m = f.parse(r, {
      topNode: h.parent,
...
function ap(n, e, t, r, s) {
  ...
  if (((n.input.compositionPendingChanges = 0), e < 0)) {
    ...
    if (P && !n.state.selection.eq(P)) {
      if (
        ...
        n.someProp('handleKeyDown', (de) => de(n, Ht(13, 'Enter')))
      )
        return;
      let I = n.state.tr.setSelection(P);
      M == 'pointer' ? I.setMeta('pointer', !0) : M == 'key' && I.scrollIntoView(),
        i && I.setMeta('composition', i),
        n.dispatch(I);
    }
    return;
  }
  ...
  let p = up(u.content, c.doc.content, c.from, f, h);
  if (
    (p && n.input.domChangeCount++,
    ((gn && n.input.lastIOSEnter > Date.now() - 225) || pt) &&
      s.some((M) => M.nodeType == 1 && !lp.test(M.nodeName)) &&
      (!p || p.endA >= p.endB) &&
      n.someProp('handleKeyDown', (M) => M(n, Ht(13, 'Enter'))))
  ) {
  ...
  if (!p)
    if (
      ...
      if (c.sel) {
        let M = Cl(n, n.state.doc, c.sel);
        if (M && !M.eq(n.state.selection)) {
          let P = n.state.tr.setSelection(M);
          i && P.setMeta('composition', i), n.dispatch(P);
        }
      }
      return;
    }
  n.state.selection.from < n.state.selection.to &&
    p.start == p.endB &&
    n.state.selection instanceof R &&
  ...
  let m = c.doc.resolveNoCache(p.start - c.from),
    ...
    y = d.resolve(p.start),
    v = m.sameParent(g) && m.parent.inlineContent && y.end() >= p.endA;
  if (
    ((gn &&
      n.input.lastIOSEnter > Date.now() - 225 &&
      (!v || s.some((M) => M.nodeName == 'DIV' || M.nodeName == 'P'))) ||
      (!v &&
  ...
  if (
    ...
    dp(d, p.start, p.endA, m, g) &&
    n.someProp('handleKeyDown', (M) => M(n, Ht(8, 'Backspace')))
  ) {
    pt && Oe && n.domObserver.suppressSelectionUpdates();
    return;
  }
  Oe && p.endB == p.start && (n.input.lastChromeDelete = Date.now()),
    pt &&
      !v &&
      m.start() != g.start() &&
      g.parentOffset == 0 &&
      ...
      setTimeout(() => {
        n.someProp('handleKeyDown', function (M) {
          return M(n, Ht(13, 'Enter'));
        });
      }, 20));
  let T = p.start,
    O = p.endA,
    S = (M) => {
      let P = M || n.state.tr.replace(T, O, c.doc.slice(p.start - c.from, p.endB - c.from));
      if (c.sel) {
        let I = Cl(n, P.doc, c.sel);
        I &&
          !(
            (Oe &&
              n.composing &&
              ...
              (I.head == T || I.head == P.mapping.map(O) - 1)) ||
            (Fe && I.empty && I.head == T)
          ) &&
          P.setSelection(I);
      }
  ...
  if (v)
    if (m.pos == g.pos) {
      Fe &&
        Nt <= 11 &&
        m.parentOffset == 0 &&
        (n.domObserver.suppressSelectionUpdates(), setTimeout(() => gt(n), 20));
      let M = S(n.state.tr.delete(T, O)),
      ...
      let M = S(n.state.tr);
      $.type == 'add' ? M.addMark(T, O, $.mark) : M.removeMark(T, O, $.mark), n.dispatch(M);
    } else if (
      m.parent.child(m.index()).isText &&
      m.index() == g.index() - (g.textOffset ? 0 : 1)
    ) {
      let M = m.parent.textBetween(m.parentOffset, g.parentOffset),
        P = () => S(n.state.tr.insertText(M, T, O));
      n.someProp('handleTextInput', (I) => I(n, T, O, M, P)) || n.dispatch(P());
    } else n.dispatch(S());
  else n.dispatch(S());
}
function Cl(n, e, t) {
  return Math.max(t.anchor, t.head) > e.content.size
    ? null
    : Yi(n, e.resolve(t.anchor), e.resolve(t.head));
}
function cp(n, e) {
  let t = n.firstChild.marks,
    ...
    l,
    a;
  for (let d = 0; d < r.length; d++) s = r[d].removeFromSet(s);
  ...
  if (b.from(c).eq(n)) return { mark: l, type: o };
}
function dp(n, e, t, r, s) {
  if (t - e <= s.pos - r.pos || Js(r, !0, !1) < s.pos) return !1;
  let i = n.resolve(e);
  if (!r.parent.isTextblock) {
    let l = i.nodeAfter;
  ...
  let o = n.resolve(Js(i, !0, !0));
  return !o.parent.isTextblock || o.pos > t || Js(o, !0, !1) < t
    ? !1
...
function Js(n, e, t) {
  let r = n.depth,
    s = e ? n.end() : n.pos;
  for (; r > 0 && (e || n.indexAfter(r) == n.node(r).childCount); ) r--, s++, (e = !1);
  if (t) {
...
function up(n, e, t, r, s) {
  ...
  if (o < i && n.size < e.size) {
    let a = r <= i && r >= o ? i - r : 0;
    (i -= a),
      i && i < e.size && Tl(e.textBetween(i - 1, i + 1)) && (i += a ? 1 : -1),
      (l = i + (l - o)),
      (o = i);
  } else if (l < i) {
    let a = r <= i && r >= l ? i - r : 0;
    (i -= a),
      i && i < n.size && Tl(n.textBetween(i - 1, i + 1)) && (i += a ? 1 : -1),
      (o = i + (o - l)),
      (l = i);
  }
...
class Oc {
  constructor(e, t) {
    (this._root = null),
      ...
      (this.editable = Nl(this)),
      Al(this),
      (this.nodeViews = Ol(this)),
      (this.docView = ll(this.state.doc, El(this), qs(this), this.dom, this)),
      (this.domObserver = new ep(this, (r, s, i, o) => ap(this, r, s, i, o))),
  ...
  update(e) {
    e.handleDOMEvents != this._props.handleDOMEvents && Mi(this);
    let t = this._props;
    (this._props = e),
      e.plugins && (e.plugins.forEach(Il), (this.directPlugins = e.plugins)),
  ...
  updateStateInner(e, t) {
    ...
    let s = this.state,
      i = !1,
      o = !1;
    e.storedMarks && this.composing && (Mc(this), (o = !0)), (this.state = e);
    let l = s.plugins != e.plugins || this._props.plugins != t.plugins;
    if (l || this._props.plugins != t.plugins || this._props.nodeViews != t.nodeViews) {
      let h = Ol(this);
      hp(h, this.nodeViews) && ((this.nodeViews = h), (i = !0));
    }
    (l || t.handleDOMEvents != this._props.handleDOMEvents) && Mi(this),
      (this.editable = Nl(this)),
      Al(this);
    let a = qs(this),
      c = El(this),
    ...
    let f = d == 'preserve' && o && this.dom.style.overflowAnchor == null && Vf(this);
    if (o) {
      ...
      !(
        ...
        ? gt(this, h)
        : (uc(this, e.selection), this.domObserver.setCurSelection()),
        this.domObserver.start();
    }
    ...
    if (!(!e || !this.dom.contains(e.nodeType == 1 ? e : e.parentNode))) {
      if (!this.someProp('handleScrollToSelection', (t) => t(this)))
        if (this.state.selection instanceof D) {
          ...
          t.nodeType == 1 && tl(this, t.getBoundingClientRect(), e);
        } else tl(this, this.coordsAtPos(this.state.selection.head, 1), e);
    }
  }
  destroyPluginViews() {
    let e;
  ...
  updateDraggedNode(e, t) {
    let r = e.node,
      s = -1;
    if (r.from < this.state.doc.content.size && this.state.doc.nodeAt(r.from) == r.node) s = r.from;
    else {
    ...
    this.dragging = new Cc(e.slice, e.move, s < 0 ? void 0 : D.create(this.state.doc, s));
  }
  someProp(e, t) {
  ...
  focus() {
    this.domObserver.stop(), this.editable && Wf(this.dom), gt(this), this.domObserver.start();
  }
  get root() {
    let e = this._root;
    if (e == null) {
  ...
  destroy() {
    this.docView &&
      ...
      this.mounted
        ? (this.docView.update(this.state.doc, [], qs(this), this), (this.dom.textContent = ''))
  ...
  domSelectionRange() {
    ...
    return e
      ? (De &&
          ...
          zf(this.dom.ownerDocument) == this.dom &&
          np(this, e)) ||
          e
...
Oc.prototype.dispatch = function (n) {
...
function El(n) {
  ...
  return (
    ...
    [Pe.node(0, n.state.doc.content.size, e)]
  );
}
function Al(n) {
  if (n.markCursor) {
    ...
    (e.className = 'ProseMirror-separator'),
      ...
      (n.cursorWrapper = {
        dom: e,
        deco: Pe.widget(n.state.selection.from, e, { raw: !0, marks: n.markCursor }),
      });
...
var Dt = {
  ...
  pp = typeof navigator < 'u' && /Mac/.test(navigator.platform),
  mp =
    typeof navigator < 'u' &&
    /MSIE \d|Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(navigator.userAgent);
for (var Ne = 0; Ne < 10; Ne++) Dt[48 + Ne] = Dt[96 + Ne] = String(Ne);
for (var Ne = 1; Ne <= 24; Ne++) Dt[Ne + 111] = 'F' + Ne;
for (var Ne = 65; Ne <= 90; Ne++)
  (Dt[Ne] = String.fromCharCode(Ne + 32)), (Dr[Ne] = String.fromCharCode(Ne));
for (var Gs in Dt) Dr.hasOwnProperty(Gs) || (Dr[Gs] = Dt[Gs]);
function gp(n) {
  var e =
      (pp && n.metaKey && n.shiftKey && !n.ctrlKey && !n.altKey) ||
      (mp && n.shiftKey && n.key && n.key.length == 1) ||
      n.key == 'Unidentified',
    t = (!e && n.key) || (n.shiftKey ? Dr : Dt)[n.keyCode] || n.key || 'Unidentified';
  return (
    t == 'Esc' && (t = 'Escape'),
    t == 'Del' && (t = 'Delete'),
    t == 'Left' && (t = 'ArrowLeft'),
...
const yp = typeof navigator < 'u' && /Mac|iP(hone|[oa]d)/.test(navigator.platform),
  bp = typeof navigator < 'u' && /Win/.test(navigator.platform);
function kp(n) {
  let e = n.split(/-(?!$)/),
    t = e[e.length - 1];
  t == 'Space' && (t = ' ');
  ...
  for (let l = 0; l < e.length - 1; l++) {
    ...
    else if (/^mod$/i.test(a)) yp ? (o = !0) : (s = !0);
...
function vp(n) {
  return new Z({ props: { handleKeyDown: Ic(n) } });
}
function Ic(n) {
  let e = xp(n);
  return function (t, r) {
...
var Sp = Object.defineProperty,
  so = (n, e) => {
    for (var t in e) Sp(n, t, { get: e[t], enumerable: !0 });
  };
function Ms(n) {
    ...
    buildProps(n, e = !0) {
      const { rawCommands: t, editor: r, state: s } = this,
        ...
        o = {
          ...
          editor: r,
          view: i,
          state: Ms({ state: s, transaction: n }),
          dispatch: e ? () => {} : void 0,
...
var Mp =
    ...
    ({ editor: n, view: e }) => (
      requestAnimationFrame(() => {
        ...
        n.isDestroyed ||
          (e.dom.blur(),
          (t = window == null ? void 0 : window.getSelection()) == null || t.removeAllRanges());
      }),
      !0
    ),
  wp =
  ...
  Ap =
    ...
    ({ editor: t, tr: r }) => {
      ...
      return r.insert(o, i.content), r.setSelection(new R(r.doc.resolve(Math.max(o - 1, 0)))), !0;
    },
  Np =
    () =>
    ({ tr: n, dispatch: e }) => {
...
function $r(n, e, t = { strict: !0 }) {
  ...
  return r.length
    ? r.every((s) => (t.strict ? e[s] === n[s] : io(e[s]) ? e[s].test(n[s]) : e[s] === n[s]))
    : !0;
}
function $c(n, e, t = {}) {
  return n.find(
    (r) => r.type === e && $r(Object.fromEntries(Object.keys(t).map((s) => [s, r.attrs[s]])), t),
  );
}
function Dl(n, e, t = {}) {
  return !!$c(n, e, t);
...
function oo(n, e, t) {
  ...
  if (!$c([...r.node.marks], e, t)) return;
  let i = r.index,
    o = n.start() + r.offset,
    l = i + 1,
    a = o + r.node.nodeSize;
  for (; i > 0 && Dl([...n.parent.child(i - 1).marks], e, t); )
    (i -= 1), (o -= n.parent.child(i).nodeSize);
  for (; l < n.parent.childCount && Dl([...n.parent.child(l).marks], e, t); )
...
var Pp =
    ...
    ({ tr: t, state: r, dispatch: s }) => {
      const i = yt(n, r.schema),
        { doc: o, selection: l } = t,
        { $from: a, from: c, to: d } = l;
      if (s) {
        const u = oo(a, i, e);
        if (u && u.from <= c && u.to >= d) {
          const f = R.create(o, u.from, u.to);
          t.setSelection(f);
        }
      }
      return !0;
...
function Pc(n, e = null) {
  ...
  const s = t.from,
    i = r.to;
  return e === 'all'
    ? R.create(n, jt(0, s, i), jt(n.content.size, s, i))
    : R.create(n, jt(e, s, i), jt(e, s, i));
}
function $l() {
...
var Bp =
    ...
    ({ editor: t, view: r, tr: s, dispatch: i }) => {
      ...
      const o = () => {
        (Rr() || $l()) && r.dom.focus(),
          zp() && !Rr() && !$l() && r.dom.focus({ preventScroll: !0 }),
          requestAnimationFrame(() => {
            t.isDestroyed ||
              (r.focus(), e != null && e.scrollIntoView && t.commands.scrollIntoView());
          });
      };
      try {
      ...
      if (i && n === null && !Rc(t.state.selection)) return o(), !0;
      const l = Pc(s.doc, n) || t.state.selection,
        a = t.state.selection.eq(l);
      return (
        i && (a || s.setSelection(l), a && s.storedMarks && s.setStoredMarks(s.storedMarks), o()),
        !0
      );
    },
  _p = (n, e) => (t) => n.every((r, s) => e(r, { ...t, index: s })),
  Hp =
    (n, e) =>
    ({ tr: t, commands: r }) =>
...
function Xn(n, e, t) {
  if (n instanceof nt || n instanceof b) return n;
  t = { slice: !0, parseOptions: {}, ...t };
  const r = typeof n == 'object' && n !== null,
    s = typeof n == 'string';
  if (r)
    try {
      if (Array.isArray(n) && n.length > 0) return b.fromArray(n.map((l) => e.nodeFromJSON(l)));
      ...
      return (
        console.warn('[tiptap warn]: Invalid content.', 'Passed value:', n, 'Error:', i),
        Xn('', e, t)
      );
    }
  if (s) {
    if (t.errorOnInvalidContent) {
      ...
      if (
        (t.slice
          ? At.fromSchema(a).parseSlice(lr(n), t.parseOptions)
          : At.fromSchema(a).parse(lr(n), t.parseOptions),
    ...
    const i = At.fromSchema(e);
    return t.slice ? i.parseSlice(lr(n), t.parseOptions).content : i.parse(lr(n), t.parseOptions);
  }
  return Xn('', e, t);
}
function Fp(n, e, t) {
...
var Vp = (n) => !('type' in n),
    ...
    ({ tr: r, dispatch: s, editor: i }) => {
      ...
      if (s) {
        ...
        if (!t.errorOnInvalidContent && !i.options.enableContentCheck && i.options.emitContentError)
          try {
            Xn(e, i.schema, { parseOptions: c, errorOnInvalidContent: !0 });
          } catch (g) {
            a(g);
          }
        try {
          l = Xn(e, i.schema, {
            ...
            errorOnInvalidContent:
              (o = t.errorOnInvalidContent) != null ? o : i.options.enableContentCheck,
          });
        } catch (g) {
          return a(g), !1;
        }
        ...
        if (f) {
          ...
          const g = r.doc.resolve(d),
            y = g.node(),
            v = g.parentOffset === 0,
            T = y.isText || y.isTextblock,
            O = y.content.size > 0;
          v && T && O && (d = Math.max(0, d - 1)), r.replaceWith(d, u, m);
        }
        t.updateSelection && Fp(r, r.steps.length - 1, -1),
  ...
  Jp =
    ...
    ({ state: n, dispatch: e, tr: t }) => {
      try {
        const r = ys(n.doc, n.selection.$from.pos, -1);
...
function Qp(n) {
  ...
  for (let l = 0; l < e.length - 1; l += 1) {
    ...
    else if (/^mod$/i.test(a)) Rr() || zc() ? (o = !0) : (s = !0);
    else throw new Error(`Unrecognized modifier name: ${a}`);
  }
  return (
    r && (t = `Alt-${t}`),
...
function $t(n, e, t = {}) {
  const { from: r, to: s, empty: i } = n.selection,
    o = e ? ce(e, n.schema) : null,
    l = [];
  n.doc.nodesBetween(r, s, (u, f) => {
    if (u.isText) return;
    const h = Math.max(r, f),
      p = Math.min(s, f + u.nodeSize);
    l.push({ node: u, from: h, to: p });
  });
  const a = s - r,
    c = l
      .filter((u) => (o ? o.name === u.node.type.name : !0))
      .filter((u) => $r(u.node.attrs, t, { strict: !1 }));
...
var sm =
    ...
    ({ tr: t, state: r, dispatch: s }) => {
      let i = null,
        o = null;
      const l = Cs(typeof n == 'string' ? n : n.name, r.schema);
      if (!l) return !1;
      l === 'node' && (i = ce(n, r.schema)), l === 'mark' && (o = yt(n, r.schema));
      let a = !1;
      return (
        t.selection.ranges.forEach((c) => {
          r.doc.nodesBetween(c.$from.pos, c.$to.pos, (d, u) => {
            i && i === d.type && ((a = !0), s && t.setNodeMarkup(u, void 0, Rl(d.attrs, e))),
              o &&
                d.marks.length &&
                d.marks.forEach((f) => {
                  o === f.type &&
                    ((a = !0), s && t.addMark(u, u + d.nodeSize, o.create(Rl(f.attrs, e))));
                });
          });
        }),
        a
  ...
  um =
    ...
    ({ state: n, dispatch: e }) =>
      Sf(n, e);
function wi(n, e, t = {}, r = {}) {
  return Xn(n, e, { slice: !1, parseOptions: t, errorOnInvalidContent: r.errorOnInvalidContent });
}
var fm =
  ...
  ({ editor: s, tr: i, dispatch: o, commands: l }) => {
    ...
    if (r.preserveWhitespace !== 'full') {
      const c = wi(n, s.schema, r, { errorOnInvalidContent: e ?? s.options.enableContentCheck });
...
function W(n, e = void 0, ...t) {
  return Hc(n) ? (e ? n.bind(e)(...t) : n(...t)) : n;
}
function gm(n = {}) {
...
function Fc(n) {
  const e = [],
    { nodeExtensions: t, markExtensions: r } = yn(n),
    s = [...t, ...r],
    i = {
      default: null,
      validate: void 0,
  ...
  return (
    n.forEach((c) => {
      const d = { name: c.name, options: c.options, storage: c.storage, extensions: s },
        u = N(c, 'addGlobalAttributes', d);
      if (!u) return;
      u().forEach((h) => {
        let p;
    ...
    s.forEach((c) => {
      const d = { name: c.name, options: c.options, storage: c.storage },
        u = N(c, 'addAttributes', d);
      if (!u) return;
      const f = u();
    ...
    : {
        ...
        getAttrs: (t) => {
          ...
          const s = e.reduce((i, o) => {
            const l = o.attribute.parseHTML ? o.attribute.parseHTML(t) : bm(t.getAttribute(o.name));
...
function Bl(n) {
  ...
  return (
    ...
    ((t = n == null ? void 0 : n.attribute) == null ? void 0 : t.validate) !== void 0 &&
      (r.validate = n.attribute.validate),
    [n.name, r]
  );
}
function km(n, e) {
  var t;
  const r = Fc(n),
    { nodeExtensions: s, markExtensions: i } = yn(n),
    ...
    l = Object.fromEntries(
      s.map((c) => {
        const d = r.filter((y) => y.type === c.name),
          ...
          f = n.reduce((y, v) => {
            const T = N(v, 'extendNodeSchema', u);
            return { ...y, ...(T ? T(c) : {}) };
          }, {}),
          h = zl({
            ...f,
            content: W(N(c, 'content', u)),
            marks: W(N(c, 'marks', u)),
            group: W(N(c, 'group', u)),
            inline: W(N(c, 'inline', u)),
            atom: W(N(c, 'atom', u)),
            selectable: W(N(c, 'selectable', u)),
            draggable: W(N(c, 'draggable', u)),
            code: W(N(c, 'code', u)),
            whitespace: W(N(c, 'whitespace', u)),
            linebreakReplacement: W(N(c, 'linebreakReplacement', u)),
            defining: W(N(c, 'defining', u)),
            isolating: W(N(c, 'isolating', u)),
            attrs: Object.fromEntries(d.map(Bl)),
          }),
          p = W(N(c, 'parseHTML', u));
        p && (h.parseDOM = p.map((y) => Ll(y, d)));
        const m = N(c, 'renderHTML', u);
        m && (h.toDOM = (y) => m({ node: y, HTMLAttributes: Yn(y, d) }));
        const g = N(c, 'renderText', u);
    ...
    a = Object.fromEntries(
      i.map((c) => {
        const d = r.filter((g) => g.type === c.name),
          u = { name: c.name, options: c.options, storage: c.storage, editor: e },
          f = n.reduce((g, y) => {
            const v = N(y, 'extendMarkSchema', u);
            return { ...g, ...(v ? v(c) : {}) };
          }, {}),
          h = zl({
            ...f,
            inclusive: W(N(c, 'inclusive', u)),
            excludes: W(N(c, 'excludes', u)),
            group: W(N(c, 'group', u)),
            spanning: W(N(c, 'spanning', u)),
            code: W(N(c, 'code', u)),
            attrs: Object.fromEntries(d.map(Bl)),
          }),
          p = W(N(c, 'parseHTML', u));
        ...
        const m = N(c, 'renderHTML', u);
        return m && (h.toDOM = (g) => m({ mark: g, HTMLAttributes: Yn(g, d) })), [c.name, h];
      }),
    );
  return new ka({ topNode: o, nodes: l, marks: a });
}
function xm(n) {
...
function Kc(n, e) {
  ...
  return t === 'node' ? Sm(n, e) : t === 'mark' ? Bc(n, e) : {};
}
    ...
    n === e
      ...
      : t.nodesBetween(n, e, (s, i) => {
          !s ||
            ...
            r.push(...s.marks.map((o) => ({ from: i, to: i + s.nodeSize, mark: o })));
        }),
    r
  );
}
...
function Ci(n, e, t = {}) {
    ...
    (s.forEach(({ $from: u, $to: f }) => {
      ...
      n.doc.nodesBetween(h, p, (m, g) => {
        ...
        const y = Math.max(h, g),
          ...
          T = v - y;
        (o += T), l.push(...m.marks.map((O) => ({ mark: O, from: y, to: v })));
      });
    }),
    o === 0)
  )
  ...
  const a = l
      ...
      .filter((u) => $r(u.mark.attrs, t, { strict: !1 }))
...
function Em(n, e, t = {}) {
  if (!e) return $t(n, null, t) || Ci(n, null, t);
  const r = Cs(e, n.schema);
  return r === 'node' ? $t(n, e, t) : r === 'mark' ? Ci(n, e, t) : !1;
}
var Am = (n, e) => {
    const { $from: t, $to: r, $anchor: s } = n.selection;
    if (e) {
      const i = Ts((l) => l.type.name === e)(n.selection);
      if (!i) return !1;
...
function Es(n, { checkChildren: e = !0, ignoreWhitespace: t = !1 } = {}) {
  ...
  if (e) {
    ...
    return (
      n.content.forEach((i) => {
        s !== !1 && (Es(i, { ignoreWhitespace: t, checkChildren: e }) || (s = !1));
      }),
      s
    );
  }
...
function Om(n, e) {
  ...
  return { position: new Jc(t.pos), mapResult: t };
}
function Im(n) {
  return new Jc(n);
}
function Dm(n, e, t) {
  ...
  const { selection: s } = e;
  let i = null;
  if ((Rc(s) && (i = s.$cursor), i)) {
    const l = (r = n.storedMarks) != null ? r : i.marks();
    return (
      i.parent.type.allowsMarkType(t) && (!!t.isInSet(l) || !l.some((c) => c.type.excludes(t)))
    );
  }
  const { ranges: o } = s;
  ...
  Pm =
    ...
    ({ state: t, dispatch: r, chain: s }) => {
      ...
      return (
        ...
        i.isTextblock
          ? s()
              .command(({ commands: l }) => (Qo(i, { ...o, ...e })(t) ? !0 : l.clearNodes()))
              .command(({ state: l }) => Qo(i, { ...o, ...e })(l, r))
              .run()
...
var Hm =
    ...
    ({ tr: e, state: t, dispatch: r, editor: s }) => {
      const { selection: i, doc: o } = e,
        ...
        d = kr(c, l.node().type.name, l.node().attrs);
      if (i instanceof D && i.node.isBlock)
        return !l.parentOffset || !mt(o, l.pos)
          ? !1
          : (r && (n && Fl(t, s.extensionManager.splittableMarks), e.split(l.pos).scrollIntoView()),
            !0);
      if (!l.parent.isBlock) return !1;
      const u = a.parentOffset === a.parent.content.size,
        f = l.depth === 0 ? void 0 : hm(l.node(-1).contentMatchAt(l.indexAfter(-1)));
      let h = u && f ? [{ type: f, attrs: d }] : void 0,
        p = mt(e.doc, e.mapping.map(l.pos), 1, h);
      if (
        (!h &&
          !p &&
          mt(e.doc, e.mapping.map(l.pos), 1, f ? [{ type: f }] : void 0) &&
    ...
    ({ tr: t, state: r, dispatch: s, editor: i }) => {
      ...
      if (a.parent.content.size === 0 && a.node(-1).childCount === a.indexAfter(-1)) {
        ...
        if (s) {
          ...
          for (let P = a.depth - v; P >= a.depth - 3; P -= 1) y = b.from(a.node(P).copy(y));
          const T =
              a.indexAfter(-1) < a.node(-2).childCount
                ...
                : a.indexAfter(-2) < a.node(-3).childCount
                  ? 2
                  : 3,
            O = { ...kr(f, a.node().type.name, a.node().attrs), ...e },
            S = ((o = l.contentMatch.defaultType) == null ? void 0 : o.createAndFill(O)) || void 0;
          y = y.append(b.from(l.createAndFill(null, S) || void 0));
          const $ = a.before(a.depth - (v - 1));
          t.replace($, a.after(-T), new w(y, 4 - v, 0));
          let M = -1;
          t.doc.nodesBetween($, t.doc.content.size, (P, I) => {
            if (M > -1) return !1;
            P.isTextblock && P.content.size === 0 && (M = I + 1);
          }),
            M > -1 && t.setSelection(R.near(t.doc.resolve(M))),
            t.scrollIntoView();
        }
        return !0;
      }
      const h = c.pos === a.end() ? u.contentMatchAt(0).defaultType : null,
        p = { ...kr(f, u.type.name, u.attrs), ...e },
        m = { ...kr(f, a.node().type.name, a.node().attrs), ...e };
      ...
      const g = h
        ...
        : [{ type: l, attrs: p }];
      if (!mt(t.doc, a.pos, 2)) return !1;
      if (s) {
        const { selection: y, storedMarks: v } = r,
          { splittableMarks: T } = i.extensionManager,
          O = v || (y.$to.parentOffset && y.$from.marks());
        if ((t.split(a.pos, 2, g).scrollIntoView(), !O || !s)) return !0;
        const S = O.filter(($) => T.includes($.type.name));
        t.ensureMarks(S);
      }
      return !0;
    },
  ...
  Vm =
    (n, e, t, r = {}) =>
    ({ editor: s, tr: i, state: o, dispatch: l, chain: a, commands: c, can: d }) => {
      const { extensions: u, splittableMarks: f } = s.extensionManager,
        h = ce(n, o.schema),
        p = ce(e, o.schema),
        { selection: m, storedMarks: g } = o,
        { $from: y, $to: v } = m,
        T = y.blockRange(v),
        O = g || (m.$to.parentOffset && m.$from.marks());
      if (!T) return !1;
      const S = Ts(($) => Hl($.type.name, u))(m);
      ...
      return !t || !O || !l
        ...
        : a()
            .command(() => {
              const $ = d().wrapInList(h, r),
                M = O.filter((P) => f.includes(P.type.name));
              return i.ensureMarks(M), $ ? !0 : c.clearNodes();
            })
            .wrapInList(h, r)
            .command(() => Ys(i, h))
            .command(() => Qs(i, h))
  ...
  Km =
    ...
    ({ state: t, commands: r }) => {
      const s = ce(n, t.schema);
      return $t(t, s, e) ? r.lift(s) : r.wrapIn(s, e);
    },
  Um =
    () =>
    ({ state: n, dispatch: e }) => {
  ...
  Jm =
    ...
    ({ tr: t, state: r, dispatch: s }) => {
      ...
      if (d && o) {
        let { from: f, to: h } = l;
        const p = (i = c.marks().find((g) => g.type === a)) == null ? void 0 : i.attrs,
          m = oo(c, a, p);
            ...
            : r.doc.nodesBetween(d, u, (g, y) => {
                y < d &&
                  ...
                  y >= d &&
                    ...
                    (i &&
                      i === g.type &&
                      ((a = !0), s && t.setNodeMarkup(y, void 0, { ...g.attrs, ...e })),
                    o &&
                      g.marks.length &&
                      g.marks.forEach((v) => {
                        if (o === v.type && ((a = !0), s)) {
                          const T = Math.max(y, d),
                            O = Math.min(y + g.nodeSize, u);
                          t.addMark(T, O, o.create({ ...v.attrs, ...e }));
                        }
                      }));
              }),
            h &&
              (f !== void 0 && s && t.setNodeMarkup(f, void 0, { ...h.attrs, ...e }),
              o &&
                h.marks.length &&
                h.marks.forEach((g) => {
                  o === g.type && s && t.addMark(p, m, o.create({ ...g.attrs, ...e }));
                }));
        }),
        a
      );
  ...
  Zm = class {
    ...
    off(n, e) {
      const t = this.callbacks[n];
      return (
        t && (e ? (this.callbacks[n] = t.filter((r) => r !== e)) : delete this.callbacks[n]), this
      );
    }
    once(n, e) {
      const t = (...r) => {
...
function ar(n) {
  ...
  return (
    o.forEach((f) => {
      ...
      if (!h) return;
      const p = a.state.tr,
        m = Ms({ state: a.state, transaction: p }),
        g = { from: r - (h[0].length - i.length), to: s },
        { commands: y, chain: v, can: T } = new ws({ editor: t, state: m });
      f.handler({ state: m, range: g, match: h, commands: y, chain: v, can: T }) === null ||
        !p.steps.length ||
        (f.undoable && p.setMeta(l, { transform: p, from: r, to: s, text: i }),
        a.dispatch(p),
        (d = !0));
    }),
    d
    ...
    r = new Z({
        ...
        apply(s, i, o) {
          ...
          return (
            !!a &&
              setTimeout(() => {
                let { text: d } = a;
                typeof d == 'string' ? (d = d) : (d = ao(b.from(d), o.schema));
                const { from: u } = a,
                  f = u + d.length;
                ar({ editor: e, from: u, to: f, text: d, rules: t, plugin: r });
              }),
      ...
      props: {
        handleTextInput(s, i, o, l) {
          return ar({ editor: e, from: i, to: o, text: l, rules: t, plugin: r });
        },
        handleDOMEvents: {
          compositionend: (s) => (
            setTimeout(() => {
              const { $cursor: i } = s.state.selection;
              i && ar({ editor: e, from: i.pos, to: i.pos, text: '', rules: t, plugin: r });
            }),
            !1
          ),
        },
  ...
  return (
    cr(n) &&
      ...
      Object.keys(e).forEach((r) => {
        cr(e[r]) && cr(n[r]) ? (t[r] = Xc(n[r], e[r])) : (t[r] = e[r]);
      }),
    t
  );
}
var uo = class {
    ...
    get options() {
      return { ...(W(N(this, 'addOptions', { name: this.name })) || {}) };
    }
    get storage() {
      return { ...(W(N(this, 'addStorage', { name: this.name, options: this.options })) || {}) };
    }
    configure(n = {}) {
      const e = this.extend({ ...this.config, addOptions: () => Xc(this.options, n) });
      return (e.name = this.name), (e.parent = this.parent), e;
    }
    extend(n = {}) {
      const e = new this.constructor({ ...this.config, ...n });
      return (
        (e.parent = this), (this.child = e), (e.name = 'name' in n ? n.name : e.parent.name), e
      );
    }
  },
  zt = class Yc extends uo {
    constructor() {
...
function og(n) {
  const { editor: e, state: t, from: r, to: s, rule: i, pasteEvent: o, dropEvent: l } = n,
    { commands: a, chain: c, can: d } = new ws({ editor: e, state: t }),
    u = [];
  return (
    t.doc.nodesBetween(r, s, (h, p) => {
      var m, g, y, v, T;
      if (
        ...
        return;
      const O =
          (T = (v = (y = h.content) == null ? void 0 : y.size) != null ? v : h.nodeSize) != null
            ? T
            : 0,
        S = Math.max(r, p),
        $ = Math.min(s, p + O);
      if (S >= $) return;
      const M = h.isText ? h.text || '' : h.textBetween(S - p, $ - p, void 0, '￼');
      ig(M, i.find, o).forEach((I) => {
        if (I.index === void 0) return;
        const de = S + I.index + 1,
          Ve = de + I[0].length,
          _e = { from: t.tr.mapping.map(de), to: t.tr.mapping.map(Ve) },
          Ye = i.handler({
            state: t,
            range: _e,
            match: I,
    ...
    (d) =>
      new Z({
        ...
        appendTransaction: (u, f, h) => {
          ...
          if (v) {
            let { text: S } = y;
            typeof S == 'string' ? (S = S) : (S = ao(b.from(S), h.schema));
            const { from: $ } = y,
              M = $ + S.length,
              P = lg(S);
            return a({ rule: d, state: h, from: $, to: { b: M }, pasteEvt: P });
          }
          const T = f.doc.content.findDiffStart(h.doc.content),
            O = f.doc.content.findDiffEnd(h.doc.content);
          if (!(!rg(T) || !O || T === O.b))
            return a({ rule: d, state: h, from: T, to: O, pasteEvt: o });
        },
      }),
  );
}
var Ns = class {
  constructor(n, e) {
    (this.splittableMarks = []),
      ...
      (this.extensions = Vc(n)),
      (this.schema = km(this.extensions, e)),
  ...
  get plugins() {
    const { editor: n } = this;
    return Ln([...this.extensions].reverse()).flatMap((r) => {
      const s = {
          name: r.name,
          options: r.options,
      ...
      if (
        (r.type === 'mark' &&
          N(r, 'exitable', s) &&
          (l.ArrowRight = () => zt.handleExit({ editor: n, mark: r })),
        o)
      ) {
      ...
      if (_l(r, n.options.enableInputRules) && c) {
        const f = c();
        if (f && f.length) {
          const h = tg({ editor: n, rules: f }),
            p = Array.isArray(h) ? h : [h];
          i.push(...p);
        }
      }
      const d = N(r, 'addPasteRules', s);
      if (_l(r, n.options.enablePasteRules) && d) {
        const f = d();
        if (f && f.length) {
          const h = ag({ editor: n, rules: f });
          i.push(...h);
        }
      }
      const u = N(r, 'addProseMirrorPlugins', s);
      if (u) {
        const f = u();
        i.push(...f);
      }
  ...
  get attributes() {
    return Fc(this.extensions);
  }
  get nodeViews() {
    const { editor: n } = this,
      { nodeExtensions: e } = yn(this.extensions);
    return Object.fromEntries(
      e
  ...
  dispatchTransaction(n) {
    const { editor: e } = this;
    return Ln([...this.extensions].reverse()).reduceRight((r, s) => {
      const i = {
          name: s.name,
          options: s.options,
          storage: this.editor.extensionStorage[s.name],
          editor: e,
          type: Mn(s.name, this.schema),
        },
  ...
  transformPastedHTML(n) {
    const { editor: e } = this;
    return Ln([...this.extensions]).reduce(
      (r, s) => {
        const i = {
            name: s.name,
            options: s.options,
  ...
  get markViews() {
    const { editor: n } = this,
      { markExtensions: e } = yn(this.extensions);
    return Object.fromEntries(
      e
...
var re = class Qc extends uo {
    ...
    onUpdate({ transaction: n, appendedTransactions: e }) {
      ...
      const i = () => {
        ...
        if (
          (c =
            (a =
              (l = (o = this.editor.options.coreExtensionOptions) == null ? void 0 : o.delete) ==
              null
                ? void 0
              ...
              S =
                y > 0
                  ? (m = d.doc.nodeAt(y - 1)) == null
                    ? void 0
                    : m.marks.some((M) => M.eq(h.mark))
                  : !1,
              $ = (g = d.doc.nodeAt(v)) == null ? void 0 : g.marks.some((M) => M.eq(h.mark));
            this.editor.emit('delete', {
              type: 'mark',
              mark: h.mark,
              from: h.from,
              to: h.to,
              deletedRange: { from: T, to: O },
  ...
  rd = re.create({
    ...
    addProseMirrorPlugins() {
      return [
        new Z({ key: new me('editable'), props: { editable: () => this.editor.options.editable } }),
      ];
    },
  }),
  sd = new me('focusEvents'),
  id = re.create({
    name: 'focusEvents',
    addProseMirrorPlugins() {
      const { editor: n } = this;
            ...
            () =>
              o.command(({ tr: l }) => {
                const { selection: a, doc: c } = l,
                  ...
                  y = m && p.parent.childCount === 1 ? g === u.pos : _.atStart(c).from === f;
                return !d ||
                  !h.type.isTextblock ||
        ...
        new Z({
          ...
          appendTransaction: (n, e, t) => {
            ...
            const r = n.some((m) => m.docChanged) && !e.doc.eq(t.doc),
              s = n.some((m) => m.getMeta('preventClearDocument'));
            if (!r || s) return;
            const { empty: i, from: o, to: l } = e.selection,
              a = _.atStart(e.doc).from,
              c = _.atEnd(e.doc).to;
            if (i || !(o === a && l === c) || !Es(t.doc)) return;
            const f = t.tr,
              h = Ms({ state: t, transaction: f }),
              { commands: p } = new ws({ editor: this.editor, state: h });
    ...
    get children() {
      ...
      return (
        this.node.content.forEach((t, r) => {
          ...
          const c = new On(a, this.editor, s, s || o ? t : null);
    ...
    querySelectorAll(e, t = {}, r = !1) {
      ...
      return (
        this.children.forEach((o) => {
          (r && s.length > 0) ||
            (o.node.type.name === e && i.every((a) => t[a] === o.node.attrs[a]) && s.push(o),
            !(r && s.length > 0) && (s = s.concat(o.querySelectorAll(e, t, r))));
        }),
        s
      );
    }
...
var hg = class extends Zm {
  constructor(n = {}) {
    super(),
      ...
      (this.utils = { getUpdatedPosition: Om, createMappablePosition: Im }),
      this.setOptions(n),
      ...
      this.on('drop', ({ event: r, slice: s, moved: i }) => this.options.onDrop(r, s, i)),
      this.on('paste', ({ event: r, slice: s }) => this.options.onPaste(r, s)),
      this.on('delete', this.options.onDelete);
    const e = this.createDoc(),
      t = Pc(e, this.options.autofocus);
    (this.editorState = cn.create({ doc: e, schema: this.schema, selection: t || void 0 })),
  ...
  injectCSS() {
    this.options.injectCSS &&
      typeof document < 'u' &&
      (this.css = fg(ug, this.options.injectNonce));
  }
  setOptions(n = {}) {
  ...
  registerPlugin(n, e) {
    const t = Hc(e) ? e(n, [...this.state.plugins]) : [...this.state.plugins, n],
  ...
  createCommandManager() {
    this.commandManager = new ws({ editor: this });
  }
  createSchema() {
  ...
  createDoc() {
    let n;
    try {
      n = wi(this.options.content, this.schema, this.options.parseOptions, {
  ...
  dispatchTransaction(n) {
    ...
    const { state: e, transactions: t } = this.state.applyTransaction(n),
      ...
      s = t.includes(n),
      i = this.state;
    if ((this.emit('beforeTransaction', { editor: this, transaction: n, nextState: e }), !s))
      return;
...
`,
    ...
    return vm(this.state.doc, { blockSeparator: e, textSerializers: { ...Wc(this.schema), ...t } });
  }
  get isEmpty() {
...
function en(n) {
  return new As({
    ...
    handler: ({ state: e, range: t, match: r }) => {
      const s = W(n.getAttributes, void 0, r);
  ...
  return new As({
    ...
    handler: ({ state: e, range: t, match: r }) => {
      const s = e.doc.resolve(t.from),
        i = W(n.getAttributes, void 0, r) || {};
      if (!s.node(-1).canReplaceWith(s.index(-1), s.indexAfter(-1), n.type)) return null;
  ...
  return new As({
    ...
    handler: ({ state: e, range: t, match: r, chain: s }) => {
      ...
      d &&
        d.type === n.type &&
        Pt(o.doc, t.from - 1) &&
        (!n.joinPredicate || n.joinPredicate(r, d)) &&
        o.join(t.from - 1);
    },
    undoable: n.undoable,
  });
...
var gg = {};
so(gg, {
  createAtomBlockMarkdownSpec: () => yg,
  createBlockMarkdownSpec: () => bg,
  createInlineMarkdownSpec: () => vg,
  parseAttributes: () => fo,
  parseIndentedBlocks: () => Ei,
  renderNestedMarkdownContent: () => po,
...
function ho(n) {
  ...
  return (
    ...
    Object.entries(n).forEach(([t, r]) => {
      t === 'class' ||
        t === 'id' ||
        (r === !0 ? e.push(t) : r !== !1 && r != null && e.push(`${t}="${String(r)}"`));
    }),
    e.join(' ')
  );
}
        ...
        for (M.lastIndex = 0; ; ) {
          ...
          if (!((p = I[2]) != null && p.endsWith(':::'))) {
            if (Ve) O += 1;
              ...
              const _e = P.slice(0, de);
              $ = _e.trim();
              const Ye = u.slice(0, S + de + I[0].length);
              let we = [];
              if ($)
                if (l === 'block')
                  for (
                    we = h.blockTokens(_e),
                      we.forEach((ge) => {
                        ge.text &&
                          (!ge.tokens || ge.tokens.length === 0) &&
                          (ge.tokens = h.inlineTokens(ge.text));
                      });
                    we.length > 0;
                  ) {
                    const ge = we[we.length - 1];
                    if (ge.type === 'paragraph' && (!ge.text || ge.text.trim() === '')) we.pop();
                    else break;
                  }
                else we = h.inlineTokens($);
              return { type: e, raw: Ye, attributes: T, content: $, tokens: we };
            }
          }
        }
      },
...
function vg(n) {
  const {
      ...
      name: t,
      getContent: r,
      parseAttributes: s = kg,
      serializeAttributes: i = xg,
      defaultAttributes: o = {},
      selfClosing: l = !1,
      allowedAttributes: a,
    } = n,
  ...
  return {
    ...
    markdownTokenizer: {
      ...
      tokenize(f, h, p) {
        ...
        const T = s(v.trim());
        return { type: e, raw: g[0], content: y.trim(), attributes: T };
      },
    },
    renderMarkdown: (f) => {
      let h = '';
...
`;
    ...
    for (d += 1; d < l.length; ) {
      const S = l[d];
      if (S.trim() === '') {
        const M = l.slice(d + 1).findIndex((de) => de.trim() !== '');
        if (M === -1) break;
        if (
          (((s = (r = l[d + 1 + M].match(/^(\s*)/)) == null ? void 0 : r[1]) == null
            ? void 0
            : s.length) || 0) > m
        ) {
          y.push(S),
...
`),
      ...
      if (
        (((o = (i = S.match(/^(\s*)/)) == null ? void 0 : i[1]) == null ? void 0 : o.length) || 0) >
        m
      )
        y.push(S),
          (c = `${c}${S}
`),
    ...
    const T = y.slice(1);
    if (T.length > 0) {
      const S = T.map(($) => $.slice(m + u)).join(`
`);
      S.trim() && (e.customNestedParser ? (v = e.customNestedParser(S)) : (v = t.blockTokens(S)));
    }
    const O = e.createToken(p, v);
    a.push(O);
  }
...
function Sg(n, e, t = {}) {
  ...
  s.descendants((l, a) => {
    ...
    if (
      ...
      i.removeMark(c, d, n.type), i.addMark(c, d, h);
    }
  }),
    i.docChanged && e.view.dispatch(i);
}
var Me = class dd extends uo {
  constructor() {
...
function Rt(n) {
  return new sg({
    ...
    handler: ({ state: e, range: t, match: r, pasteEvent: s }) => {
      const i = W(n.getAttributes, void 0, r, s);
      ...
      if (l) {
        ...
        f < t.to && o.delete(f, t.to),
          ...
          (c = t.from + d + l.length),
          o.addMark(t.from + d, c, n.type.create(i || {})),
...
var Pr = (n, e) => {
  ...
  wg = Me.create({
    ...
    renderHTML({ HTMLAttributes: n }) {
      return Pr('blockquote', { ...ie(this.options.HTMLAttributes, n), children: Pr('slot', {}) });
    },
    parseMarkdown: (n, e) => {
      var t;
...
`)
    ...
    addInputRules() {
      return [bn({ find: Mg, type: this.type })];
    },
  }),
  Cg = /(?:^|\s)(\*\*(?!\s+\*\*)((?:[^*]+))\*\*(?!\s+\*\*))$/,
  Tg = /(?:^|\s)(\*\*(?!\s+\*\*)((?:[^*]+))\*\*(?!\s+\*\*))/g,
  Eg = /(?:^|\s)(__(?!\s+__)((?:[^_]+))__(?!\s+__))$/,
  Ag = /(?:^|\s)(__(?!\s+__)((?:[^_]+))__(?!\s+__))/g,
  Ng = zt.create({
    name: 'bold',
    addOptions() {
      return { HTMLAttributes: {} };
    ...
    renderHTML({ HTMLAttributes: n }) {
      return Pr('strong', { ...ie(this.options.HTMLAttributes, n), children: Pr('slot', {}) });
    },
    ...
    addInputRules() {
      return [en({ find: Cg, type: this.type }), en({ find: Eg, type: this.type })];
    },
    addPasteRules() {
      return [Rt({ find: Tg, type: this.type }), Rt({ find: Ag, type: this.type })];
    },
  }),
  Og = /(^|[^`])`([^`]+)`(?!`)$/,
  Ig = /(^|[^`])`([^`]+)`(?!`)/g,
  Dg = zt.create({
    ...
    renderHTML({ HTMLAttributes: n }) {
      return ['code', ie(this.options.HTMLAttributes, n), 0];
    },
    ...
    addInputRules() {
      return [en({ find: Og, type: this.type })];
    },
    addPasteRules() {
      return [Rt({ find: Ig, type: this.type })];
    },
  }),
  Zs = 4,
  $g = /^```([a-z]+)?[\s\n]$/,
      ...
      return {
        language: {
          ...
          parseHTML: (n) => {
            ...
            if (!t) return null;
            const i = [...(((e = n.firstElementChild) == null ? void 0 : e.classList) || [])]
    ...
    addKeyboardShortcuts() {
      return {
        ...
        Tab: ({ editor: n }) => {
          ...
          const t = (e = this.options.tabSize) != null ? e : Zs,
            { state: r } = n,
            { selection: s } = r,
            { $from: i, empty: o } = s;
...
`);
                  ...
                  const v = ((a = h[p].match(/^ */)) == null ? void 0 : a[0]) || '',
                    T = Math.min(v.length, t);
                  if (T === 0) return !0;
                  let O = d;
                  for (let $ = 0; $ < p; $ += 1) O += h[$].length + 1;
                  return l.delete(O, O + T), c - O <= T && l.setSelection(R.create(l.doc, O)), !0;
                })
              : n.commands.command(({ tr: l }) => {
                  const { from: a, to: c } = s,
                    f = r.doc
...
`);
        ...
        ArrowDown: ({ editor: n }) => {
          ...
          return l === void 0
            ? !1
            : r.nodeAt(l)
              ? n.commands.command(({ tr: c }) => (c.setSelection(_.near(r.resolve(l))), !0))
              : n.commands.exitCode();
        },
      };
    },
    addInputRules() {
      return [
        Ti({ find: $g, type: this.type, getAttributes: (n) => ({ language: n[1] }) }),
        Ti({ find: Rg, type: this.type, getAttributes: (n) => ({ language: n[1] }) }),
      ];
    },
    addProseMirrorPlugins() {
      return [
...
`,
              ...
              return (
                ...
                o.selection.$from.parent.type !== this.type &&
                  o.setSelection(R.near(o.doc.resolve(Math.max(0, o.selection.from - 2)))),
                o.setMeta('paste', !0),
                n.dispatch(o),
                !0
              );
...
`,
  ...
  Bg = Me.create({
    ...
    parseMarkdown: (n, e) =>
      e.createNode('heading', { level: n.depth || 1 }, e.parseInline(n.tokens || [])),
    renderMarkdown: (n, e) => {
      var t;
  ...
  _g = Me.create({
    ...
    addCommands() {
      return {
        setHorizontalRule:
          () =>
          ({ chain: n, state: e }) => {
            if (!mg(e, e.schema.nodes[this.name])) return !1;
            const { selection: t } = e,
              { $to: r } = t,
              s = n();
            return (
                  ...
                  if (l) {
                    ...
                    if (a.nodeAfter)
                      a.nodeAfter.isTextblock
                        ? o.setSelection(R.create(o.doc, a.pos + 1))
                        : a.nodeAfter.isBlock
                          ? o.setSelection(D.create(o.doc, a.pos))
                          : o.setSelection(R.create(o.doc, a.pos));
                    else {
                      const d =
                          i.schema.nodes[this.options.nextNodeType] ||
                          a.parent.type.contentMatch.defaultType,
                        u = d == null ? void 0 : d.create();
                      u && (o.insert(c, u), o.setSelection(R.create(o.doc, c + 1)));
                    }
                    o.scrollIntoView();
                  }
                  return !0;
    ...
    addInputRules() {
      return [pg({ find: /^(?:---|—-|___\s|\*\*\*\s)$/, type: this.type })];
    },
  }),
  Hg = /(?:^|\s)(\*(?!\s+\*)((?:[^*]+))\*(?!\s+\*))$/,
  Fg = /(?:^|\s)(\*(?!\s+\*)((?:[^*]+))\*(?!\s+\*))/g,
  Vg = /(?:^|\s)(_(?!\s+_)((?:[^_]+))_(?!\s+_))$/,
  jg = /(?:^|\s)(_(?!\s+_)((?:[^_]+))_(?!\s+_))/g,
  Wg = zt.create({
    name: 'italic',
    addOptions() {
      return { HTMLAttributes: {} };
    ...
    addInputRules() {
      return [en({ find: Hg, type: this.type }), en({ find: Vg, type: this.type })];
    },
    addPasteRules() {
      return [Rt({ find: Fg, type: this.type }), Rt({ find: jg, type: this.type })];
    },
  });
const Kg =
...
He.prototype = {
  ...
  tr(n, e, t, r) {
    r = r || He.groups;
    let s;
    return e && e.j ? (s = e) : ((s = new He(e)), t && r && Wt(e, t, r)), this.jr.push([n, s]), s;
  },
  ts(n, e, t, r) {
    let s = this;
    const i = n.length;
    ...
    if (
      ...
      if (r)
        if (o.t && typeof o.t == 'string') {
          const a = Object.assign(Xg(o.t, r), t);
          Wt(i, a, r);
        } else t && Wt(i, t, r);
      o.t = i;
    }
...
const B = (n, e, t, r, s) => n.ta(e, t, r, s),
  ee = (n, e, t, r, s) => n.tr(e, t, r, s),
  Vl = (n, e, t, r, s) => n.ts(e, t, r, s),
  x = (n, e, t, r, s) => n.tt(e, t, r, s),
  ft = 'WORD',
  Di = 'UWORD',
  fd = 'ASCIINUMERICAL',
  hd = 'ALPHANUMERICAL',
  ...
  _r = 'CLOSEPAREN',
  Hr = 'OPENANGLEBRACKET',
  Fr = 'CLOSEANGLEBRACKET',
  Vr = 'FULLWIDTHLEFTPAREN',
  jr = 'FULLWIDTHRIGHTPAREN',
  Wr = 'LEFTCORNERBRACKET',
  Kr = 'RIGHTCORNERBRACKET',
  Ur = 'LEFTWHITECORNERBRACKET',
  qr = 'RIGHTWHITECORNERBRACKET',
  Jr = 'FULLWIDTHLESSTHAN',
  Gr = 'FULLWIDTHGREATERTHAN',
  Xr = 'AMPERSAND',
  Yr = 'APOSTROPHE',
  Qr = 'ASTERISK',
  vt = 'AT',
...
var gd = Object.freeze({
  ...
  EQUALS: rs,
  EXCLAMATION: bo,
  FULLWIDTHGREATERTHAN: Gr,
  FULLWIDTHLEFTPAREN: Vr,
  FULLWIDTHLESSTHAN: Jr,
  FULLWIDTHMIDDLEDOT: pd,
  FULLWIDTHRIGHTPAREN: jr,
  HYPHEN: Ue,
  LEFTCORNERBRACKET: Wr,
  LEFTWHITECORNERBRACKET: Ur,
  LOCALHOST: Qn,
  NL: go,
  NUM: mo,
  OPENANGLEBRACKET: Hr,
  ...
  QUERY: Fn,
  QUOTE: ko,
  RIGHTCORNERBRACKET: Kr,
  RIGHTWHITECORNERBRACKET: qr,
  SCHEME: xr,
  SEMI: xo,
  SLASH: st,
  SLASH_SCHEME: an,
...
function Zg(n = []) {
  ...
  ur == null && (ur = Wl(Kg)),
    ...
    x(t, '\\', Zr),
    x(t, '・', pd);
  const r = ee(t, ut, mo, { [Ai]: !0 });
  ee(r, ut, r);
  const s = ee(r, dt, fd, { [zn]: !0 }),
    i = ee(r, wn, hd, { [In]: !0 }),
    o = ee(t, dt, ft, { [Ni]: !0 });
  ee(o, ut, s), ee(o, dt, o), ee(s, ut, s), ee(s, dt, s);
  const l = ee(t, wn, Di, { [Oi]: !0 });
  ee(l, dt), ee(l, ut, i), ee(l, wn, l), ee(i, ut, i), ee(i, dt), ee(i, wn, i);
  const a = x(t, ri, go, { [ei]: !0 }),
    c = x(t, jl, Pi, { [ei]: !0 }),
    d = ee(t, ni, Pi, { [ei]: !0 });
  x(t, si, d),
    x(c, ri, a),
    ...
    ee(d, ni, d),
    x(d, si, d);
  const u = ee(t, ti, md, { [ud]: !0 });
  x(u, '#'), ee(u, ti, u), x(u, Yg, u);
  const f = x(u, Qg);
  x(f, '#'), ee(f, ti, u);
  const h = [
      [dt, o],
  ...
  for (let m = 0; m < ur.length; m++) bt(t, ur[m], $i, ft, h);
  for (let m = 0; m < fr.length; m++) bt(t, fr[m], Ri, Di, p);
  Wt($i, { tld: !0, ascii: !0 }, e),
    Wt(Ri, { utld: !0, alpha: !0 }, e),
    bt(t, 'file', xr, ft, h),
    bt(t, 'mailto', xr, ft, h),
    bt(t, 'http', an, ft, h),
    bt(t, 'https', an, ft, h),
    bt(t, 'ftp', an, ft, h),
    bt(t, 'ftps', an, ft, h),
    Wt(xr, { scheme: !0, ascii: !0 }, e),
    Wt(an, { slashscheme: !0, ascii: !0 }, e),
  ...
  return (
    Vl(t, 'localhost', Qn, { ascii: !0 }),
    (t.jd = new He(cs)),
    { start: t, tokens: Object.assign({ groups: e }, gd) }
  );
}
function yd(n, e) {
  const t = ey(e.replace(/[A-Z]/g, (l) => l.toLowerCase())),
    r = t.length,
    s = [];
  let i = 0,
    o = 0;
  for (; o < r; ) {
    ...
    for (; o < r && (a = l.go(t[o])); )
      (l = a),
        l.accepts() ? ((u = 0), (f = 0), (d = l)) : u >= 0 && ((u += t[o].length), f++),
        (c += t[o].length),
        (i += t[o].length),
        o++;
    (i -= u), (o -= f), (c -= u), s.push({ t: d.t, v: e.slice(i - c, i), s: i - c, e: i });
  }
  return s;
}
function ey(n) {
  ...
  for (; r < t; ) {
    let s = n.charCodeAt(r),
      i,
      o =
        s < 55296 || s > 56319 || r + 1 === t || (i = n.charCodeAt(r + 1)) < 56320 || i > 57343
          ? n[r]
          : n.slice(r, r + 2);
    e.push(o), (r += o.length);
  }
...
vo.prototype = {
  ...
  get(n, e, t) {
    ...
    return (
      s &&
      (typeof s == 'object'
        ? ((s = t.t in s ? s[t.t] : Zn[n]), typeof s == 'function' && r && (s = s(e, t)))
...
bd.prototype = {
  ...
  render(n) {
    ...
    return (
      ...
      c && (o.rel = c),
      d && Object.assign(o, d),
      { tagName: s, attributes: o, content: i, eventListeners: u }
    );
  },
};
function Os(n, e) {
...
function ny({ groups: n }) {
  const e = n.domain.concat([
    ...
    r = [Xr, Yr, Qr, Zr, es, ts, ns, rs, Ue, Bn, _n, Hn, ss, is, ls, Fn, st, cs, Vn, as],
    s = Ke(),
    i = x(s, Vn);
  ...
  const o = Ke(),
    l = Ke(),
    a = Ke();
  B(s, n.domain, o), B(s, n.scheme, l), B(s, n.slashscheme, a), B(o, r, i), B(o, n.domain, o);
  const c = x(o, vt);
  x(i, vt, c), x(l, vt, c), x(a, vt, c);
  const d = x(i, rt);
  B(d, r, i), B(d, n.domain, i);
  const u = Ke();
  B(c, n.domain, u), B(u, n.domain, u);
  const f = x(u, rt);
  B(f, n.domain, u);
  const h = Ke(Ul);
  B(f, n.tld, h), B(f, n.utld, h), x(c, Qn, h);
  const p = x(u, Ue);
  x(p, Ue, p), B(p, n.domain, u), B(h, n.domain, u), x(h, rt, f), x(h, Ue, p);
  const m = x(h, wt);
  B(m, n.numeric, Ul);
  const g = x(o, Ue),
    y = x(o, rt);
  x(g, Ue, g), B(g, n.domain, o), B(y, r, i), B(y, n.domain, o);
  const v = Ke(hr);
  B(y, n.tld, v),
    B(y, n.utld, v),
    B(v, n.domain, o),
  ...
  const S = Ke(hr),
    $ = Ke();
  B(S, e, S), B(S, t, $), B($, e, S), B($, t, $), x(v, st, S), x(O, st, S);
  const M = x(l, wt),
    P = x(a, wt),
    I = x(P, st),
    de = x(I, st);
  ...
  for (let _e = 0; _e < Ve.length; _e++) {
    ...
    B(ge, e, oe);
    const C = Ke();
    B(ge, t), B(oe, e, oe), B(oe, t, C), B(C, e, oe), B(C, t, C), x(oe, we, S), x(C, we, S);
  }
  return x(s, Qn, v), x(s, go, ty), { start: s, tokens: gd };
}
function ry(n, e, t) {
  let r = t.length,
    s = 0,
  ...
  for (; s < r; ) {
    ...
    for (; s < r && (c = a || l.go(t[s].t)); )
      (a = null), (l = c), l.accepts() ? ((f = 0), (u = l)) : f >= 0 && f++, s++, d++;
    if (f < 0) (s -= d), s < r && (o.push(t[s]), s++);
    else {
      o.length > 0 && (i.push(ii(ql, e, o)), (o = [])), (s -= f), (d -= f);
      const h = u.t,
        p = t.slice(s - d, s);
      i.push(ii(h, e, p));
    }
  }
  return o.length > 0 && i.push(ii(ql, e, o)), i;
}
function ii(n, e, t) {
  const r = t[0].s,
    s = t[t.length - 1].e,
...
const sy = (typeof console < 'u' && console && console.warn) || (() => {}),
  iy =
...
function Jl(n, e = !1) {
  if (
    (J.initialized &&
      sy(`linkifyjs: already initialized - will not register custom scheme "${n}" ${iy}`),
...
function ly() {
  J.scanner = Zg(J.customSchemes);
  for (let n = 0; n < J.tokenQueue.length; n++) J.tokenQueue[n][1]({ scanner: J.scanner });
  J.parser = ny(J.scanner.tokens);
  for (let n = 0; n < J.pluginQueue.length; n++)
    J.pluginQueue[n][1]({ scanner: J.scanner, parser: J.parser });
  return (J.initialized = !0), J;
}
function So(n) {
  return J.initialized || ly(), ry(J.parser.start, n, yd(J.scanner.start, n));
}
So.scan = yd;
function kd(n, e = null, t = null) {
  ...
  return new Z({
    ...
    appendTransaction: (e, t, r) => {
      ...
      const { tr: o } = r,
        l = _c(t.doc, [...e]);
      if (
        (Uc(l).forEach(({ newRange: c }) => {
          const d = pm(r.doc, c, (h) => h.isTextblock);
          let u, f;
          if (d.length > 1)
          ...
          if (u && f) {
            const h = f.split(ay).filter(Boolean);
            if (h.length <= 0) return !1;
            const p = h[h.length - 1],
              m = u.pos + f.lastIndexOf(p);
            if (!p) return !1;
            const g = So(p).map((y) => y.toObject(n.defaultProtocol));
            if (!uy(g)) return !1;
            g.filter((y) => y.isLink)
              ...
              .forEach((y) => {
                co(y.from, y.to, r.doc).some((v) => v.mark.type === n.type) ||
                  o.addMark(y.from, y.to, n.type.create({ href: y.href }));
              });
          }
        }),
        !!o.steps.length)
  ...
  return new Z({
    ...
    props: {
      handleClick: (e, t, r) => {
        ...
        let l = !1;
        if (
          (n.enableClickSelection && (l = n.editor.commands.extendMarkRange(n.type.name)),
          n.openOnClick)
        ) {
          const a = Kc(e.state, n.type.name),
            c = (s = o.href) != null ? s : a.href,
            d = (i = o.target) != null ? i : a.target;
  ...
  return new Z({
    ...
    props: {
      handlePaste: (e, t, r) => {
        ...
        const c = kd(a, { defaultProtocol: n.defaultProtocol }).find(
...
var xd = zt.create({
    ...
    addOptions() {
      return {
        ...
        isAllowedUri: (n, e) => !!_t(n, e.protocols),
        validate: (n) => !!n,
        shouldAutoLink: (n) => {
          ...
          getAttrs: (n) => {
            ...
            return !e ||
              !this.options.isAllowedUri(e, {
                defaultValidate: (t) => !!_t(t, this.options.protocols),
    ...
    renderHTML({ HTMLAttributes: n }) {
      return this.options.isAllowedUri(n.href, {
        defaultValidate: (e) => !!_t(e, this.options.protocols),
        protocols: this.options.protocols,
        defaultProtocol: this.options.defaultProtocol,
      })
        ? ['a', ie(this.options.HTMLAttributes, n), 0]
        : ['a', ie(this.options.HTMLAttributes, { ...n, href: '' }), 0];
    },
    markdownTokenName: 'link',
    parseMarkdown: (n, e) =>
      e.applyMark('link', e.parseInline(n.tokens || []), { href: n.href, title: n.title || null }),
    renderMarkdown: (n, e) => {
      var t, r, s, i;
        ...
        setLink:
          ...
          ({ chain: e }) => {
            ...
            return this.options.isAllowedUri(t, {
              defaultValidate: (r) => !!_t(r, this.options.protocols),
              protocols: this.options.protocols,
              defaultProtocol: this.options.defaultProtocol,
            })
  ...
  yy = (n, e) => {
    for (var t in e) gy(n, t, { get: e[t], enumerable: !0 });
  },
  by = 'listItem',
  Gl = 'textStyle',
  Xl = /^\s*([-+*])\s$/,
  vd = Me.create({
    ...
    parseMarkdown: (n, e) =>
      n.type !== 'list' || n.ordered
        ? []
        : { type: 'bulletList', content: n.items ? e.parseChildren(n.items) : [] },
    renderMarkdown: (n, e) =>
      n.content
        ? e.renderChildren(
            n.content,
...
`,
          ...
          ({ commands: n, chain: e }) =>
            this.options.keepAttributes
              ? e()
                  ...
                  .updateAttributes(by, this.editor.getAttributes(Gl))
                  .run()
    ...
    addInputRules() {
      let n = bn({ find: Xl, type: this.type });
      return (
        (this.options.keepMarks || this.options.keepAttributes) &&
          (n = bn({
            ...
            getAttributes: () => this.editor.getAttributes(Gl),
            editor: this.editor,
          })),
        [n]
      );
      ...
      if (n.tokens && n.tokens.length > 0)
        if (n.tokens.some((o) => o.type === 'paragraph')) s = r(n.tokens);
          ...
          if (o && o.type === 'text' && o.tokens && o.tokens.length > 0) {
            if (
              ((s = [{ type: 'paragraph', content: e.parseInline(o.tokens) }]), n.tokens.length > 1)
            ) {
...
yy(ky, {
  ...
  hasListBefore: () => Md,
  hasListItemAfter: () => xy,
  hasListItemBefore: () => wd,
  listItemHasSubList: () => Cd,
  nextListIsDeeper: () => Td,
  nextListIsHigher: () => Ed,
});
var rr = (n, e) => {
    ...
    let s = null,
      ...
      o = t.pos,
      l = null;
    for (; i > 0 && l === null; ) (s = t.node(i)), s.type === r ? (l = i) : ((i -= 1), (o -= 1));
  ...
  Li = (n, e, t) => {
    ...
    if (!$t(n.state, e) || !Nm(n.state)) return !1;
    const r = rr(e, n.state);
    if (!r) return !1;
    const i = n.state.doc.resolve(r.$pos.pos - 2).node(r.depth),
      o = Cd(e, n.state, i);
    return wd(e, n.state) && !o ? n.commands.joinItemBackward() : n.chain().liftListItem(e).run();
  },
  Td = (n, e) => {
    const t = wo(n, e),
      r = rr(n, e);
  ...
  zi = (n, e) => {
    if (!$t(n.state, e) || !Am(n.state, e)) return !1;
        ...
        Delete: ({ editor: n }) => {
          ...
          return (
            this.options.listTypes.forEach(({ itemName: t }) => {
              n.state.schema.nodes[t] !== void 0 && zi(n, t) && (e = !0);
            }),
            e
          );
        },
        ...
        Backspace: ({ editor: n }) => {
          ...
          return (
            this.options.listTypes.forEach(({ itemName: t, wrapperNames: r }) => {
              n.state.schema.nodes[t] !== void 0 && Li(n, t, r) && (e = !0);
            }),
            e
          );
        },
...
`),
      ...
      s.push({ type: 'list_item', raw: o.raw, tokens: c }), (i = u);
    } else i += 1;
  }
  return s;
}
...
var wy = 'listItem',
  ...
  Od = Me.create({
    ...
    addAttributes() {
      return {
        start: {
          default: 1,
          parseHTML: (n) =>
            n.hasAttribute('start') ? parseInt(n.getAttribute('start') || '', 10) : 1,
        },
    ...
    renderHTML({ HTMLAttributes: n }) {
      const { start: e, ...t } = n;
      return e === 1
        ? ['ol', ie(this.options.HTMLAttributes, t), 0]
        : ['ol', ie(this.options.HTMLAttributes, n), 0];
    },
    markdownTokenName: 'list',
    parseMarkdown: (n, e) => {
      if (n.type !== 'list' || !n.ordered) return [];
      const t = n.start || 1,
        r = n.items ? My(n.items, e) : [];
      return t !== 1
...
`),
        ...
        toggleOrderedList:
          ...
          ({ commands: n, chain: e }) =>
            this.options.keepAttributes
              ? e()
                  .toggleList(this.name, this.options.itemTypeName, this.options.keepMarks)
                  .updateAttributes(wy, this.editor.getAttributes(Ql))
                  .run()
              : n.toggleList(this.name, this.options.itemTypeName, this.options.keepMarks),
      };
    },
  ...
  Ty = Me.create({
    ...
    renderHTML({ node: n, HTMLAttributes: e }) {
      return [
        'li',
        ie(this.options.HTMLAttributes, e, { 'data-type': this.name }),
        [
          'label',
          ['input', { type: 'checkbox', checked: n.attrs.checked ? 'checked' : null }],
          ['span'],
        ],
        ['div', 0],
      ];
      ...
      return ({ node: n, HTMLAttributes: e, getPos: t, editor: r }) => {
          ...
          l.addEventListener('change', (u) => {
            ...
            r.isEditable &&
              ...
              !r.isEditable &&
                ...
                (this.options.onReadOnlyChecked(n, f) || (l.checked = !l.checked));
          }),
        ...
        return {
          ...
          update: (u) => {
            ...
            (s.dataset.checked = u.attrs.checked), (l.checked = u.attrs.checked), c(u);
  ...
  Ey = Me.create({
    ...
    renderHTML({ HTMLAttributes: n }) {
      return ['ul', ie(this.options.HTMLAttributes, n, { 'data-type': this.name }), 0];
    },
    ...
    markdownTokenizer: {
      ...
      tokenize(n, e, t) {
        const r = (i) => {
            ...
            return o ? [{ type: 'taskList', raw: o.raw, items: o.items }] : t.blockTokens(i);
          },
          s = Ei(
            n,
            {
...
re.create({
  ...
  addExtensions() {
    const n = [];
    return (
      this.options.bulletList !== !1 && n.push(vd.configure(this.options.bulletList)),
      this.options.listItem !== !1 && n.push(Sd.configure(this.options.listItem)),
      this.options.listKeymap !== !1 && n.push(Ad.configure(this.options.listKeymap)),
      this.options.orderedList !== !1 && n.push(Od.configure(this.options.orderedList)),
      this.options.taskItem !== !1 && n.push(Ty.configure(this.options.taskItem)),
      this.options.taskList !== !1 && n.push(Ey.configure(this.options.taskList)),
      n
    );
  },
});
var pr = '&nbsp;',
  ...
  Ay = Me.create({
    ...
    parseMarkdown: (n, e) => {
      ...
      return t.length === 1 &&
        t[0].type === 'text' &&
        (t[0].raw === pr || t[0].text === pr || t[0].raw === oi || t[0].text === oi) &&
        r.length === 1 &&
        r[0].type === 'text' &&
        (r[0].text === pr || r[0].text === oi)
    ...
    renderMarkdown: (n, e, t) => {
      ...
      if (i.length === 0) {
        const o = Array.isArray(
          ...
          : [];
        return ((s = t == null ? void 0 : t.previousNode) == null ? void 0 : s.type) ===
          'paragraph' && o.length === 0
          ? pr
          : '';
      }
  ...
  Iy = zt.create({
    ...
    addInputRules() {
      return [en({ find: Ny, type: this.type })];
    },
    addPasteRules() {
      return [Rt({ find: Oy, type: this.type })];
    },
  }),
  Dy = Me.create({
    name: 'text',
  ...
  Id = zt.create({
    ...
    markdownTokenizer: {
      ...
      tokenize(n, e, t) {
        ...
        if (!s) return;
        const i = s[2].trim();
        return { type: 'underline', raw: s[0], text: i, tokens: t.inlineTokens(i) };
      },
    },
    addCommands() {
      return {
...
class ne extends _ {
  ...
  map(e, t) {
    let r = e.resolve(t.map(this.head));
    return ne.valid(r) ? new ne(r) : _.near(r);
  }
  content() {
    return w.empty;
  }
  ...
  static valid(e) {
    let t = e.parent;
    if (t.inlineContent || !Ly(e) || !zy(e)) return !1;
...
class Co {
  ...
  resolve(e) {
    ...
    return ne.valid(t) ? new ne(t) : _.near(t);
  }
}
function Dd(n) {
...
function Ly(n) {
  for (let e = n.depth; e >= 0; e--) {
    ...
    for (let s = r.child(t - 1); ; s = s.lastChild) {
      if ((s.childCount == 0 && !s.inlineContent) || Dd(s.type)) return !0;
...
function mr(n, e) {
  ...
  return function (r, s, i) {
    ...
    return c ? (s && s(r.tr.setSelection(new ne(c))), !0) : !1;
  };
}
function Hy(n, e, t) {
  if (!n || !n.editable) return !1;
  let r = n.state.doc.resolve(e);
  if (!ne.valid(r)) return !1;
  let s = n.posAtCoords({ left: t.clientX, top: t.clientY });
  return s && s.inside > -1 && D.isSelectable(n.state.doc.nodeAt(s.inside))
    ? !1
    : (n.dispatch(n.state.tr.setSelection(new ne(r))), !0);
}
function Fy(n, e) {
  if (e.inputType != 'insertCompositionText' || !(n.state.selection instanceof ne)) return !1;
  let { $from: t } = n.state.selection,
    r = t.parent.contentMatchAt(t.index()).findWrapping(n.state.schema.nodes.text);
  if (!r) return !1;
  let s = b.empty;
  for (let o = r.length - 1; o >= 0; o--) s = b.from(r[o].createAndFill(null, s));
  let i = n.state.tr.replace(t.pos, t.pos, new w(s, 0, 0));
  return i.setSelection(R.near(i.doc.resolve(t.pos + 1))), n.dispatch(i), !1;
}
function Vy(n) {
  ...
  return (
    ...
    Q.create(n.doc, [Pe.widget(n.selection.head, e, { key: 'gapcursor' })])
  );
}
var ds = 200,
  be = function () {};
be.prototype.append = function (e) {
  return e.length
    ? ((e = be.from(e)),
      (!this.length && e) ||
        (e.length < ds && this.leafAppend(e)) ||
        (this.length < ds && e.leafPrepend(this)) ||
        this.appendInner(e))
    : this;
};
...
be.prototype.slice = function (e, t) {
  return (
    ...
    e >= t ? be.empty : this.sliceInner(Math.max(0, e), Math.min(this.length, t))
  );
};
...
be.from = function (e) {
  return e instanceof be ? e : e && e.length ? new $d(e) : be.empty;
};
var $d = (function (n) {
  function e(r) {
  ...
  return (
    ...
    (e.prototype.forEachInner = function (s, i, o, l) {
      for (var a = i; a < o; a++) if (s(this.values[a], l + a) === !1) return !1;
    }),
    (e.prototype.forEachInvertedInner = function (s, i, o, l) {
      for (var a = i - 1; a >= o; a--) if (s(this.values[a], l + a) === !1) return !1;
    }),
    (e.prototype.leafAppend = function (s) {
      if (this.length + s.length <= ds) return new e(this.values.concat(s.flatten()));
    }),
    (e.prototype.leafPrepend = function (s) {
      if (this.length + s.length <= ds) return new e(s.flatten().concat(this.values));
    }),
  ...
  return (
    ...
    (e.prototype.forEachInner = function (r, s, i, o) {
      ...
      if (
        ...
        (i > l &&
          this.right.forEachInner(r, Math.max(s - l, 0), Math.min(this.length, i) - l, o + l) ===
            !1)
      )
        return !1;
    }),
    (e.prototype.forEachInvertedInner = function (r, s, i, o) {
      var l = this.left.length;
      if (
        (s > l && this.right.forEachInvertedInner(r, s - l, Math.max(i, l) - l, o + l) === !1) ||
        (i < l && this.left.forEachInvertedInner(r, Math.min(s, l), i, o) === !1)
      )
        return !1;
    }),
...
class et {
  ...
  popEvent(e, t) {
    ...
    return (
      this.items.forEach(
        (u, f) => {
          if (!u.step) {
            s || ((s = this.remapping(r, f + 1)), (i = s.maps.length)), i--, d.push(u);
            return;
          }
          if (s) {
            d.push(new it(u.map));
            let h = u.step.map(s.slice(i)),
              p;
            h &&
              o.maybeStep(h).doc &&
              ((p = o.mapping.maps[o.mapping.maps.length - 1]),
              c.push(new it(p, void 0, void 0, c.length + d.length))),
              i--,
              p && s.appendMap(p, i);
          } else o.maybeStep(u.step);
          if (u.selection)
            return (
              (l = s ? u.selection.map(s.slice(i)) : u.selection),
              (a = new et(
  ...
  addTransform(e, t, r, s) {
    ...
    let c = o - r.depth;
    return c > Uy && ((l = Ky(l, c)), (o -= c)), new et(l.append(i), o);
  }
  remapping(e, t) {
    let r = new Kn();
    return (
  ...
  addMaps(e) {
    return this.eventCount == 0
      ? this
      : new et(this.items.append(e.map((t) => new it(t))), this.eventCount);
  }
  rebased(e, t) {
    ...
    this.items.forEach((f) => {
      ...
      } else r.push(new it(p));
    }, s);
    let c = [];
    for (let f = t; f < o; f++) c.push(new it(i.maps[f]));
    let d = this.items.slice(0, s).append(c).append(r),
      u = new et(d, l);
  ...
  compress(e = this.items.length) {
    ...
    return (
        ...
        (o, l) => {
          if (l >= e) s.push(o), o.selection && i++;
            ...
            if ((r--, c && t.appendMap(c, r), a)) {
              ...
              d && i++;
              let u = new it(c.invert(), a, d),
                f,
                h = s.length - 1;
              (f = s.length && s[h].merge(u)) ? (s[h] = f) : s.push(u);
            }
          } else o.map && r--;
        },
        this.items.length,
      ...
      new et(be.from(s.reverse()), i)
    );
  }
}
et.empty = new et(be.empty, 0);
function Ky(n, e) {
  let t;
  return (
    n.forEach((r, s) => {
...
class it {
  ...
  merge(e) {
    if (this.step && e.step && !e.selection) {
      ...
      if (t) return new it(t.getMap().invert(), t, this.selection);
    }
  }
}
class St {
...
function qy(n, e, t, r) {
  ...
  t.getMeta(Xy) && (n = new St(n.done, n.undone, null, 0, -1));
  let o = t.getMeta('appendedTransaction');
  if (t.steps.length == 0) return n;
  if (o && o.getMeta(Gt))
    return o.getMeta(Gt).redo
      ? new St(
          n.done.addTransform(t, void 0, r, vr(e)),
          n.undone,
          ea(t.mapping.maps),
          n.prevTime,
          n.prevComposition,
      ...
      : new St(
          n.done,
          n.undone.addTransform(t, void 0, r, vr(e)),
          null,
          n.prevTime,
          n.prevComposition,
        );
  if (t.getMeta('addToHistory') !== !1 && !(o && o.getMeta('addToHistory') === !1)) {
    let l = t.getMeta('composition'),
      a =
        ...
        (!o &&
          n.prevComposition != l &&
          (n.prevTime < (t.time || 0) - r.newGroupDelay || !Jy(t, n.prevRanges))),
      c = o ? li(n.prevRanges, t.mapping) : ea(t.mapping.maps);
    return new St(
      n.done.addTransform(t, a ? e.selection.getBookmark() : void 0, r, vr(e)),
      et.empty,
      c,
      t.time,
      l ?? n.prevComposition,
...
function Jy(n, e) {
  ...
  return (
    n.mapping.maps[0].forEach((r, s) => {
      for (let i = 0; i < e.length; i += 2) r <= e[i + 1] && s >= e[i] && (t = !0);
    }),
    t
  );
}
...
function Gy(n, e, t) {
  let r = vr(e),
    s = Gt.get(e).spec.config,
    i = (t ? n.undone : n.done).popEvent(e, r);
  if (!i) return null;
  let o = i.selection.resolve(i.transform.doc),
    l = (t ? n.done : n.undone).addTransform(i.transform, e.selection.getBookmark(), s, r),
    a = new St(t ? l : i.remaining, t ? i.remaining : l, null, 0, -1);
...
const Gt = new me('history'),
  Xy = new me('closeHistory');
function Yy(n = {}) {
  return (
    ...
    new Z({
      ...
      state: {
        init() {
          return new St(et.empty, et.empty, null, 0, -1);
        },
        apply(e, t, r) {
          return qy(t, r, e, n);
        },
      ...
      props: {
        handleDOMEvents: {
          beforeinput(e, t) {
            let r = t.inputType,
              s = r == 'historyUndo' ? Pd : r == 'historyRedo' ? Ld : null;
          ...
          decorations: ({ doc: n, selection: e }) => {
            ...
            return (
              n.descendants((a, c) => {
                ...
                i.push(Pe.node(c, c + a.nodeSize, { class: this.options.className }));
              }),
              Q.create(n, i)
            );
          },
...
var Zy = re.create({
    ...
    extendNodeSchema(n) {
      ...
      return { allowGapCursor: (e = W(N(n, 'allowGapCursor', t))) != null ? e : null };
    },
  }),
  na = 'placeholder';
function e0(n) {
...
var t0 = re.create({
  ...
  addProseMirrorPlugins() {
    const n = this.options.dataAttribute ? `data-${e0(this.options.dataAttribute)}` : `data-${na}`;
    return [
      new Z({
            ...
            return (
              e.descendants((l, a) => {
                ...
                if ((c || !this.options.showOnlyCurrent) && d) {
                  ...
                  const f = Pe.node(a, a + l.nodeSize, {
                    class: u.join(' '),
                    [n]:
        ...
        props: {
          decorations(t) {
            return t.selection.empty ||
              ...
              ? null
              : Q.create(t.doc, [
                  Pe.inline(t.selection.from, t.selection.to, { class: e.className }),
                ]);
          },
        },
      }),
...
var r0 = re.create({
    ...
    addProseMirrorPlugins() {
      ...
      const e = new me(this.name),
        ...
        r = Object.entries(this.editor.schema.nodes)
          .map(([, s]) => s)
          .filter((s) => (this.options.notAfter || []).concat(t).includes(s.name));
      return [
        new Z({
          key: e,
          appendTransaction: (s, i, o) => {
            const { doc: l, tr: a, schema: c } = o,
              ...
              u = l.content.size,
              f = c.nodes[t];
            if (!s.some((h) => h.getMeta(n0)) && d) return a.insert(u, f.create());
          },
          state: {
            init: (s, i) => {
  ...
  i0 = re.create({
    ...
    addExtensions() {
      ...
      const s = [];
      return (
        this.options.bold !== !1 && s.push(Ng.configure(this.options.bold)),
        this.options.blockquote !== !1 && s.push(wg.configure(this.options.blockquote)),
        this.options.bulletList !== !1 && s.push(vd.configure(this.options.bulletList)),
        this.options.code !== !1 && s.push(Dg.configure(this.options.code)),
        this.options.codeBlock !== !1 && s.push(Pg.configure(this.options.codeBlock)),
        this.options.document !== !1 && s.push(Lg.configure(this.options.document)),
        this.options.dropcursor !== !1 && s.push(Qy.configure(this.options.dropcursor)),
        this.options.gapcursor !== !1 && s.push(Zy.configure(this.options.gapcursor)),
        this.options.hardBreak !== !1 && s.push(zg.configure(this.options.hardBreak)),
        this.options.heading !== !1 && s.push(Bg.configure(this.options.heading)),
        this.options.undoRedo !== !1 && s.push(s0.configure(this.options.undoRedo)),
        this.options.horizontalRule !== !1 && s.push(_g.configure(this.options.horizontalRule)),
        this.options.italic !== !1 && s.push(Wg.configure(this.options.italic)),
        this.options.listItem !== !1 && s.push(Sd.configure(this.options.listItem)),
        this.options.listKeymap !== !1 &&
          s.push(Ad.configure((n = this.options) == null ? void 0 : n.listKeymap)),
        this.options.link !== !1 &&
          s.push(xd.configure((e = this.options) == null ? void 0 : e.link)),
        this.options.orderedList !== !1 && s.push(Od.configure(this.options.orderedList)),
        this.options.paragraph !== !1 && s.push(Ay.configure(this.options.paragraph)),
        this.options.strike !== !1 && s.push(Iy.configure(this.options.strike)),
        this.options.text !== !1 && s.push(Dy.configure(this.options.text)),
        this.options.underline !== !1 &&
          s.push(Id.configure((t = this.options) == null ? void 0 : t.underline)),
        this.options.trailingNode !== !1 &&
          s.push(r0.configure((r = this.options) == null ? void 0 : r.trailingNode)),
        s
      );
    },
  }),
  ...
  d0 = zt.create({
      ...
      return this.options.multicolor
        ? {
            color: {
              ...
              renderHTML: (n) =>
                n.color
                  ? { 'data-color': n.color, style: `background-color: ${n.color}; color: inherit` }
                  : {},
            },
          }
        : {};
    ...
    addInputRules() {
      return [en({ find: a0, type: this.type })];
    },
    addPasteRules() {
      return [Rt({ find: c0, type: this.type })];
    },
  }),
  u0 = d0,
  f0 = re.create({
...
const p0 = Me.create({
    ...
    addAttributes() {
      return {
        current: {
          default: 100,
          parseHTML: (n) => parseInt(n.dataset.current, 10) || 100,
          renderHTML: (n) => n.current,
        },
        max: {
          default: 100,
          parseHTML: (n) => parseInt(n.dataset.max, 10) || 100,
          renderHTML: (n) => n.max,
        },
      };
    },
    ...
    renderHTML({ HTMLAttributes: n }) {
      const e = n.current || 100,
        t = n.max || 100,
        r = Math.max(0, Math.min(100, (e / t) * 100));
      let s = 'bg-green-500';
      return (
        r <= 0
          ? (s = 'bg-gray-600')
        ...
        [
          'span',
          {
            ...
            'data-max': t,
            class:
              'inline-flex items-center gap-2 px-2 py-1 rounded bg-zinc-800 text-white text-sm font-medium cursor-pointer hover:bg-zinc-700 transition-colors',
          },
          [
            ['span', { class: 'text-zinc-400' }, 'PV'],
            ['span', { class: 'font-bold' }, `${e}/${t}`],
            [
              'div',
              { class: 'w-16 h-2 bg-zinc-600 rounded overflow-hidden' },
              [['div', { class: `h-full ${s} transition-all`, style: `width: ${r}%` }, '']],
            ],
          ],
        ]
      );
      ...
      return {
        insertHp:
          ...
          ({ commands: e }) =>
            e.insertContent({
              type: this.name,
              attrs: { current: n.current || 100, max: n.max || 100 },
            }),
      };
    },
  }),
  m0 = Me.create({
    ...
    addAttributes() {
      return {
        current: {
          default: 0,
          parseHTML: (n) => parseInt(n.dataset.current, 10) || 0,
          renderHTML: (n) => n.current,
        },
        currency: {
          default: 'po',
          parseHTML: (n) => n.dataset.currency || 'po',
          renderHTML: (n) => n.currency,
        },
      };
    },
    parseHTML() {
    ...
    renderHTML({ HTMLAttributes: n }) {
      ...
      return [
        ...
        [
          ...
          ['span', { class: 'font-bold' }, e.toLocaleString('pt-BR')],
          ['span', { class: 'text-amber-300' }, r[t] || t],
        ],
      ];
    },
    addCommands() {
      return {
        insertMoney:
          ...
          ({ commands: e }) =>
            e.insertContent({
              type: this.name,
              attrs: { current: n.current || 0, currency: n.currency || 'po' },
            }),
      };
    },
  }),
  g0 = Me.create({
    ...
    addAttributes() {
      return {
        name: {
          default: 'FOR',
          parseHTML: (n) => n.dataset.name || 'FOR',
          renderHTML: (n) => n.name,
        },
        value: {
          default: 10,
          parseHTML: (n) => parseInt(n.dataset.value, 10) || 10,
          renderHTML: (n) => n.value,
        },
        mod: {
          default: 0,
          parseHTML: (n) => parseInt(n.dataset.mod, 10) || 0,
          renderHTML: (n) => n.mod,
        },
      };
    },
    ...
    renderHTML({ HTMLAttributes: n }) {
      ...
      return [
        ...
        [
          ['strong', { class: 'text-zinc-400' }, `${e}:`],
          ['span', { class: 'font-bold text-lg' }, t],
          r !== 0 ? ['span', { class: 'text-zinc-400' }, `(${s}${r})`] : '',
        ].filter(Boolean),
      ];
    },
    addCommands() {
      return {
        insertStat:
          ...
          ({ commands: e }) =>
            e.insertContent({
              type: this.name,
              attrs: { name: n.name || 'FOR', value: n.value || 10, mod: n.mod || 0 },
            }),
      };
    },
  }),
  y0 = Me.create({
    ...
    addAttributes() {
      return {
        name: {
          default: 'Items',
          parseHTML: (n) => n.dataset.name || 'Items',
          renderHTML: (n) => n.name,
        },
        current: {
          default: 0,
        ...
        max: {
          default: 10,
          parseHTML: (n) => parseInt(n.dataset.max, 10) || 10,
          renderHTML: (n) => n.max,
        },
      };
    },
    ...
    renderHTML({ HTMLAttributes: n }) {
      ...
      return [
        'span',
        {
          ...
          'data-max': r,
          class:
            'inline-flex items-center gap-2 px-2 py-1 rounded bg-blue-900/50 text-blue-200 text-sm',
        },
        [
          ['strong', { class: 'text-blue-400' }, `${e}:`],
          ['span', { class: 'font-bold' }, `${t}`],
          ['span', { class: 'text-blue-300' }, `/ ${r}`],
        ],
      ];
    },
    addCommands() {
      return {
        insertCount:
          ...
          ({ commands: e }) =>
            e.insertContent({
              type: this.name,
              attrs: { name: n.name || 'Items', current: n.current || 0, max: n.max || 10 },
            }),
      };
    },
  }),
  b0 = Me.create({
    ...
    addAttributes() {
      return {
        ...
        total: {
          default: 1e3,
          parseHTML: (n) => parseInt(n.dataset.total, 10) || 1e3,
          renderHTML: (n) => n.total,
        },
      };
    },
    parseHTML() {
    ...
    renderHTML({ HTMLAttributes: n }) {
      ...
      return [
        'span',
        {
          ...
          'data-total': t,
          class:
            'inline-flex items-center gap-2 px-2 py-1 rounded bg-purple-900/50 text-purple-200 text-sm',
        },
        [
          ['span', { class: 'text-purple-400' }, '★'],
          ['span', { class: 'font-bold' }, e.toLocaleString('pt-BR')],
          ['span', { class: 'text-purple-300' }, `/ ${t.toLocaleString('pt-BR')} XP`],
          ['span', { class: 'text-xs text-purple-400' }, `(${Math.round(r)}%)`],
        ],
      ];
    },
    addCommands() {
      return {
        insertXp:
          ...
          ({ commands: e }) =>
            e.insertContent({
              type: this.name,
              attrs: { current: n.current || 0, total: n.total || 1e3 },
            }),
      };
    },
  });
var k0 = Be('<div><!></div>');
function x0(n, e) {
  kn(e, !0), dn(e, 'value', 11, '');
  var t = k0(),
    r = V(t);
  fs(r, () => e.children),
    j(t),
    us((s) => ms(t, 1, s), [() => hs(ps('w-full', e.class))]),
    L(n, t),
    xn();
}
var v0 = Be('<div><!></div>');
...
var M0 = Be('<button type="button"><!></button>');
function Cn(n, e) {
  kn(e, !0);
  let t = dn(e, 'activeValue', 15, ''),
    r = he(() => t() === e.value);
  var s = M0(),
    i = V(s);
  fs(i, () => e.children),
...
var C0 = Be('<!> <!> <!> <!> <!>', 1),
  T0 = Be(
    '<div class="grid grid-cols-2 gap-4"><div class="space-y-2"><label class="text-sm font-medium text-foreground">HP Atual</label> <!></div> <div class="space-y-2"><label class="text-sm font-medium text-foreground">HP Máximo</label> <!></div></div> <p class="text-xs text-muted-foreground">Exibe uma barra de pontos de vida interativa</p>',
    1,
  ),
  E0 = Be(
    '<div class="space-y-2"><label class="text-sm font-medium text-foreground">Nome do Atributo</label> <!></div> <div class="grid grid-cols-2 gap-4"><div class="space-y-2"><label class="text-sm font-medium text-foreground">Valor</label> <!></div> <div class="space-y-2"><label class="text-sm font-medium text-foreground">Modificador</label> <!></div></div>',
    1,
  ),
  A0 = Be(
    '<div class="grid grid-cols-2 gap-4"><div class="space-y-2"><label class="text-sm font-medium text-foreground">Quantidade</label> <!></div> <div class="space-y-2"><label class="text-sm font-medium text-foreground">Moeda</label> <select class="h-10 w-full rounded-md border bg-popover px-3 py-2 text-foreground border-input"><option>Ouro (PO)</option><option>Prata (PP)</option><option>Cobre (PC)</option><option>Platina (PE)</option></select></div></div>',
  ),
  N0 = Be(
    '<div class="space-y-2"><label class="text-sm font-medium text-foreground">Nome</label> <!></div> <div class="grid grid-cols-2 gap-4"><div class="space-y-2"><label class="text-sm font-medium text-foreground">Atual</label> <!></div> <div class="space-y-2"><label class="text-sm font-medium text-foreground">Máximo</label> <!></div></div>',
    1,
  ),
  O0 = Be(
    '<div class="grid grid-cols-2 gap-4"><div class="space-y-2"><label class="text-sm font-medium text-foreground">XP Atual</label> <!></div> <div class="space-y-2"><label class="text-sm font-medium text-foreground">XP Total</label> <!></div></div>',
  ),
  I0 = Be('<!> <!> <!> <!> <!> <!>', 1),
  D0 = Be(
    '<div class="fixed inset-0 z-50 flex items-center justify-center"><button class="absolute inset-0 bg-black/50" aria-label="Fechar"></button> <div class="relative bg-popover border rounded-lg shadow-xl w-[450px] max-h-[80vh] overflow-auto"><div class="p-4 border-b border-border"><h2 class="text-lg font-semibold text-foreground">Inserir Shortcode RPG</h2> <p class="text-sm text-muted-foreground">Escolha o tipo de dado interativo</p></div> <!> <div class="p-4 border-t border-border flex justify-end gap-2"><!> <!></div></div></div>',
  );
function $0(n, e) {
  kn(e, !0);
  let t = Te('hp'),
  ...
  function m() {
    switch (k(t)) {
      case 'hp':
        e.onInsert('hp', { current: k(r), max: k(s) });
        break;
      case 'stat':
        e.onInsert('stat', { name: k(i), value: k(o), mod: k(l) });
        break;
      case 'money':
        e.onInsert('money', { current: k(a), currency: k(c) });
        break;
      case 'count':
        e.onInsert('count', { name: k(d), current: k(u), max: k(f) });
        break;
      case 'xp':
        e.onInsert('xp', { current: k(h), total: k(p) });
        break;
    }
  }
  var g = D0(),
      ...
      Tn(Ye, {
        ...
        children: (oe, C) => {
          ...
          var ue = A(F, 2),
            se = A(V(ue), 2),
            fe = V(se);
          fe.value = fe.__value = 'po';
          var q = A(fe);
          q.value = q.__value = 'pp';
          var Re = A(q);
          Re.value = Re.__value = 'pc';
          var K = A(Re);
          (K.value = K.__value = 'pe'),
            j(se),
            j(ue),
            j(E),
            Jd(
  ...
  Y($, {
    ...
    j(v),
    j(g),
    _i('click', y, function (...M) {
      var P;
      (P = e.onClose) == null || P.apply(this, M);
    }),
    L(n, g),
    xn();
}
Bi(['click']);
var R0 = Be(
    '<div class="flex gap-1"><input type="url" placeholder="URL..." class="h-8 px-2 text-sm rounded border bg-background w-32"/> <!> <!></div>',
  ),
  P0 = Be(
    '<div class="flex flex-wrap items-center gap-1 p-2 border-b bg-muted/50"><div class="flex gap-1"><!> <!> <!></div> <div class="w-px h-6 bg-border"></div> <div class="flex gap-1"><!> <!> <!> <!> <!> <!></div> <div class="w-px h-6 bg-border"></div> <div class="flex gap-1"><!> <!> <!></div> <div class="w-px h-6 bg-border"></div> <div class="flex gap-1"><!> <!> <!></div> <div class="w-px h-6 bg-border"></div> <!> <div class="w-px h-6 bg-border"></div> <div class="flex gap-1"><!> <!></div> <div class="w-px h-6 bg-border"></div> <!></div>',
  ),
  L0 = Be(
    '<div class="rounded-lg border bg-card"><!> <div class="prose prose-invert max-w-none p-4 min-h-[200px] focus:outline-none"></div></div> <!>',
    1,
  );
function G0(n, e) {
  kn(e, !0);
  let t = dn(e, 'content', 15, ''),
    r = dn(e, 'editable', 3, !0),
    s = dn(e, 'placeholder', 3, ''),
    i,
    o = Te(null),
    l = Te(!1),
    a = Te(''),
    ...
    i &&
      te(
        ...
        new hg({
          ...
          extensions: [
            o0,
            l0.configure({ placeholder: s() || ' ' }),
            u0,
            my.configure({ openOnClick: !1 }),
            h0,
            $y,
            p0,
            m0,
  ...
  function d() {
    var C;
    (C = k(o)) == null || C.chain().focus().toggleBold().run();
  }
  function u() {
    var C;
    (C = k(o)) == null || C.chain().focus().toggleItalic().run();
  }
  function f() {
    var C;
    (C = k(o)) == null || C.chain().focus().toggleUnderline().run();
  }
  function h() {
    var C;
    (C = k(o)) == null || C.chain().focus().toggleStrike().run();
  }
  function p() {
    var C;
    (C = k(o)) == null || C.chain().focus().toggleBulletList().run();
  }
  function m() {
    var C;
    (C = k(o)) == null || C.chain().focus().toggleOrderedList().run();
  }
  function g() {
    var C;
    (C = k(o)) == null || C.chain().focus().toggleBlockquote().run();
  }
  function y() {
    var C;
    (C = k(o)) == null || C.chain().focus().toggleCode().run();
  }
  function v(C) {
    var E;
    (E = k(o)) == null || E.chain().focus().toggleHeading({ level: C }).run();
  }
  function T(C) {
    var E;
    (E = k(o)) == null || E.chain().focus().setTextAlign(C).run();
  }
  function O() {
    var C;
    (C = k(o)) == null || C.chain().focus().toggleHighlight().run();
  }
  function S() {
    var C, E;
    k(a)
      ? (C = k(o)) == null ||
        C.chain()
          ...
          .setLink({ href: k(a) })
          .run()
      : (E = k(o)) == null || E.chain().focus().unsetLink().run(),
      te(c, !1),
      te(a, '');
  }
  function $() {
    var C;
    (C = k(o)) == null || C.chain().focus().undo().run();
  }
  function M() {
    var C;
    (C = k(o)) == null || C.chain().focus().redo().run();
  }
  function P(C, E) {
    let F = '';
    switch (C) {
      case 'hp':
        F = `<span data-type="hp" data-current="${E.current || 100}" data-max="${E.max || 100}">[hp current="${E.current || 100}" max="${E.max || 100}"]</span> `;
        break;
      case 'stat':
        F = `<span data-type="stat" data-name="${E.name || 'FOR'}" data-value="${E.value || 10}" data-mod="${E.mod || 0}">[stat "${E.name || 'FOR'}" ${E.value || 10}]</span> `;
        break;
      case 'money':
        F = `<span data-type="money" data-current="${E.current || 0}" data-currency="${E.currency || 'po'}">[money ${E.current || 0} ${E.currency || 'po'}]</span> `;
        break;
      case 'count':
        F = `<span data-type="count" data-name="${E.name || 'Items'}" data-current="${E.current || 0}" data-max="${E.max || 10}">[count "${E.name || 'Items'}" current="${E.current || 0}" max="${E.max || 10}"]</span> `;
        break;
      case 'xp':
        F = `<span data-type="xp" data-current="${E.current || 0}" data-total="${E.total || 1e3}">[xp ${E.current || 0}/${E.total || 1e3}]</span> `;
        break;
    }
    F && k(o) && k(o).chain().focus().insertContent(F).run(), te(l, !1);
  }
  const I = he(
    () =>
      (C, E = {}) =>
        k(o) ? k(o).isActive(C, E) : !1,
  );
  var de = L0(),
    Ve = G(de),
    _e = V(Ve);
  {
    var Ye = (C) => {
      var E = P0(),
        ...
        Ce = V(F);
      {
        let z = he(() => (k(I)('heading', { level: 1 }) ? 'default' : 'ghost'));
        Y(Ce, {
          size: 'sm',
          get variant() {
            return k(z);
      ...
      var ue = A(Ce, 2);
      {
        let z = he(() => (k(I)('heading', { level: 2 }) ? 'default' : 'ghost'));
        Y(ue, {
          size: 'sm',
          get variant() {
            return k(z);
      ...
      var se = A(ue, 2);
      {
        let z = he(() => (k(I)('heading', { level: 3 }) ? 'default' : 'ghost'));
        Y(se, {
          size: 'sm',
          get variant() {
            return k(z);
      ...
      var fe = A(F, 4),
        q = V(fe);
      {
        let z = he(() => (k(I)('bold') ? 'default' : 'ghost'));
        Y(q, {
          size: 'sm',
          get variant() {
            return k(z);
      ...
      var Re = A(q, 2);
      {
        let z = he(() => (k(I)('italic') ? 'default' : 'ghost'));
        Y(Re, {
          size: 'sm',
          get variant() {
            return k(z);
      ...
      var K = A(Re, 2);
      {
        let z = he(() => (k(I)('underline') ? 'default' : 'ghost'));
        Y(K, {
          size: 'sm',
          get variant() {
            return k(z);
      ...
      var nn = A(K, 2);
      {
        let z = he(() => (k(I)('strike') ? 'default' : 'ghost'));
        Y(nn, {
          size: 'sm',
          get variant() {
            return k(z);
      ...
      var To = A(nn, 2);
      {
        let z = he(() => (k(I)('highlight') ? 'default' : 'ghost'));
        Y(To, {
          size: 'sm',
          get variant() {
            return k(z);
      ...
      var zd = A(To, 2);
      {
        let z = he(() => (k(I)('code') ? 'default' : 'ghost'));
        Y(zd, {
          size: 'sm',
          get variant() {
            return k(z);
      ...
      var Is = A(fe, 4),
        Eo = V(Is);
      {
        let z = he(() => (k(I)('bulletList') ? 'default' : 'ghost'));
        Y(Eo, {
          size: 'sm',
          get variant() {
            return k(z);
      ...
      var Ao = A(Eo, 2);
      {
        let z = he(() => (k(I)('orderedList') ? 'default' : 'ghost'));
        Y(Ao, {
          size: 'sm',
          get variant() {
            return k(z);
      ...
      var Bd = A(Ao, 2);
      {
        let z = he(() => (k(I)('blockquote') ? 'default' : 'ghost'));
        Y(Bd, {
          size: 'sm',
          get variant() {
            return k(z);
      ...
      var Ds = A(Is, 4),
        No = V(Ds);
      {
        let z = he(() => (k(I)({ textAlign: 'left' }) ? 'default' : 'ghost'));
        Y(No, {
          size: 'sm',
          get variant() {
            return k(z);
      ...
      var Oo = A(No, 2);
      {
        let z = he(() => (k(I)({ textAlign: 'center' }) ? 'default' : 'ghost'));
        Y(Oo, {
          size: 'sm',
          get variant() {
            return k(z);
      ...
      var _d = A(Oo, 2);
      {
        let z = he(() => (k(I)({ textAlign: 'right' }) ? 'default' : 'ghost'));
        Y(_d, {
          size: 'sm',
          get variant() {
            return k(z);
      ...
      var Io = A(Ds, 4);
      {
        var Hd = (z) => {
            ...
            Y(Wd, {
              ...
              j(H),
              _i('keydown', X, (Bt) => Bt.key === 'Enter' && S()),
              Xd(
                X,
                () => k(a),
                (Bt) => te(a, Bt),
          ...
          Fd = (z) => {
            {
              let H = he(() => (k(I)('link') ? 'default' : 'ghost'));
              Y(z, {
                size: 'sm',
                get variant() {
                  return k(H);
