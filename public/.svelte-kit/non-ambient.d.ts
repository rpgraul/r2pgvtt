...
declare module "$app/types" {
	...
	export interface AppTypes {
		RouteId(): "/" | "/auth" | "/auth/callback" | "/auth/login" | "/auth/superuser" | "/converter" | "/dm-screen" | "/drawing-mode" | "/games" | "/games/[id]" | "/games/[id]/settings" | "/join" | "/join/[invite_code]" | "/sheet-mode" | "/text-mode";
		RouteParams(): {
			"/games/[id]": { id: string };
		...
		Pathname(): "/" | "/auth/callback" | "/auth/login" | "/auth/superuser" | "/converter" | "/dm-screen" | "/drawing-mode" | "/games" | `/games/${string}` & {} | `/games/${string}/settings` & {} | `/join/${string}` & {} | "/sheet-mode" | "/text-mode";
