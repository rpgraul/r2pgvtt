import { a as Me, f as Ne } from './wRaPAkex.js';
import {
  j as Ie,
  x as Ee,
  b9 as he,
...
import { B as er } from './CctNoNeD.js';
import { c as rr, a as tr, d as or, f as nr, n as sr, g as ir } from './CnkBgILj.js';
import { p as J, r as ar } from './DQIjwT0e.js';
function lr(e, r, ...t) {
  var o = new er(e);
  Ie(() => {
    const n = r() ?? null;
    o.ensure(n, n && ((s) => n(s, ...t)));
  }, Ee);
}
function cr(e, r) {
  var t = void 0,
...
function me(e) {
  ...
  if (typeof e == 'string' || typeof e == 'number') o += e;
    ...
    if (Array.isArray(e)) {
      var n = e.length;
      for (r = 0; r < n; r++) e[r] && (t = me(e[r])) && (o && (o += ' '), (o += t));
  ...
  if ((r && (o = o ? o + ' ' + r : r), t)) {
    for (var n of Object.keys(t))
      if (t[n]) o = o ? o + ' ' + n : n;
        ...
        for (var s = n.length, a = 0; (a = o.indexOf(n, a)) >= 0; ) {
          var i = a + s;
          (a === 0 || ue.includes(o[a - 1])) && (i === o.length || ue.includes(o[i]))
            ? (o = (a === 0 ? '' : o.substring(0, a)) + o.substring(i + 1))
            : (a = i);
        }
  }
  return o === '' ? null : o;
  ...
  if (r) {
    ...
    if ((Array.isArray(r) ? ((o = r[0]), (n = r[1])) : (o = r), e)) {
      ...
      var s = !1,
        ...
        i = !1,
        l = [];
      o && l.push(...Object.keys(o).map(Q)), n && l.push(...Object.keys(n).map(Q));
      var u = 0,
        f = -1;
      const m = e.length;
      for (var b = 0; b < m; b++) {
        ...
        if (
          ...
          if (d === ':' && f === -1) f = b;
            ...
            if (f !== -1) {
              var C = Q(e.substring(u, f).trim());
              if (!l.includes(C)) {
                d !== ';' && b++;
                var x = e.substring(u, b).trim();
                t += ' ' + x + ';';
              }
            }
            (u = b + 1), (f = -1);
    ...
    return o && (t += fe(o)), n && (t += fe(n, !0)), (t = t.trim()), t === '' ? null : t;
  }
  return e == null ? null : String(e);
}
function pr(e, r, t, o, n, s) {
  var a = e.__className;
  if (G || a !== t || a === void 0) {
    var i = ur(t, o, s);
    (!G || i !== e.getAttribute('class')) &&
      (i == null ? e.removeAttribute('class') : r ? (e.className = i) : e.setAttribute('class', i)),
      (e.__className = t);
  } else if (s && n !== s)
    for (var l in s) {
      var u = !!s[l];
...
function br(e, r, t, o) {
  ...
  if (G || n !== r) {
    ...
    o &&
      (Array.isArray(o)
        ? (D(e, t == null ? void 0 : t[0], o[0]),
          D(e, t == null ? void 0 : t[1], o[1], 'important'))
        : D(e, t, o));
  return o;
}
function K(e, r, t = !1) {
  if (e.multiple) {
    if (r == null) return;
    if (!Ge(r)) return Pe();
    for (var o of e.options) o.selected = r.includes(q(o));
    return;
  }
  for (o of e.options) {
    var n = q(o);
...
function ct(e, r, t = r) {
  ...
  je(e, 'change', (s) => {
    var a = s ? '[selected]' : ':checked',
      i;
    if (e.multiple) i = [].map.call(e.querySelectorAll(a), q);
    else {
      var l = e.querySelector(a) ?? e.querySelector('option:not([disabled])');
      i = l && q(l);
    }
    t(i), (e.__value = i), Z !== null && o.add(Z);
  }),
    oe(() => {
      var s = r();
...
function dt(e, r) {
  var t = ne(e);
  t.value === (t.value = r ?? void 0) ||
    (e.value === r && (r !== 0 || e.nodeName !== yr)) ||
    (e.value = r ?? '');
}
function xr(e, r) {
...
function Y(e, r, t, o) {
  ...
  (G &&
    ...
    r === 'src' || r === 'srcset' || (r === 'href' && e.nodeName === gr))) ||
    (n[r] !== (n[r] = t) &&
      (r === 'loading' && (e[Ve] = t),
      t == null
        ? e.removeAttribute(r)
        : typeof t != 'string' && ke(e).includes(r)
          ? (e[r] = t)
          : e.setAttribute(r, t)));
}
function Ar(e, r, t, o, n = !1, s = !1) {
  if (G && n && e.nodeName === hr) {
    var a = e,
      i = a.type === 'checkbox' ? 'defaultChecked' : 'defaultValue';
    i in t || wr(a);
  }
  var l = ne(e),
    u = l[xe],
  ...
  var d = r || {},
    C = e.nodeName === vr;
  for (var x in r) x in t || (t[x] = null);
  t.class ? (t.class = dr(t.class)) : t[V] && (t.class = null),
    t[B] && (t.style ?? (t.style = null));
  var m = ke(e);
  for (const h in t) {
    let y = t[h];
    if (C && h === 'value' && y == null) {
      (e.value = e.__value = ''), (d[h] = y);
      continue;
    }
    if (h === 'class') {
      var g = e.namespaceURI === 'http://www.w3.org/1999/xhtml';
      pr(e, g, y, o, r == null ? void 0 : r[V], t[V]), (d[h] = y), (d[V] = t[V]);
      continue;
    }
    if (h === 'style') {
      br(e, y, r == null ? void 0 : r[B], t[B]), (d[h] = y), (d[B] = t[B]);
      continue;
    }
    var p = d[h];
    if (!(y === p && !(y === void 0 && e.hasAttribute(h)))) {
      d[h] = y;
      var _ = h[0] + h[1];
      if (_ !== '$$')
        if (_ === 'on') {
          ...
          let k = h.slice(2);
          var N = ir(k);
          if ((rr(k) && ((k = k.slice(0, -7)), (S.capture = !0)), !N && p)) {
            if (y != null) continue;
            e.removeEventListener(k, d[z], S), (d[z] = null);
          }
          if (N) tr(k, e, y), or([k]);
          else if (y != null) {
            let j = function (v) {
        ...
        } else if (h === 'style') Y(e, h, y);
        else if (h === 'autofocus') Fe(e, !!y);
        else if (!u && (h === '__value' || (h === 'value' && y != null))) e.value = e.__value = y;
        else if (h === 'selected' && C) xr(e, y);
        else {
          var A = h;
          f || (A = sr(A));
          var P = A === 'defaultValue' || A === 'defaultChecked';
          if (y == null && !u && !P)
            if (((l[h] = null), A === 'value' || A === 'checked')) {
              let S = e;
              const z = r === void 0;
              if (A === 'value') {
                let k = S.defaultValue;
                S.removeAttribute(A), (S.defaultValue = k), (S.value = S.__value = z ? k : null);
              } else {
                let k = S.defaultChecked;
                S.removeAttribute(A), (S.defaultChecked = k), (S.checked = z ? k : !1);
              }
            } else e.removeAttribute(h);
          else
            P || (m.includes(A) && (u || typeof y != 'string'))
              ? ((e[A] = y), A in l && (l[A] = He))
              : typeof y != 'function' && Y(e, A, y);
        }
    }
  }
  return b && de(!0), d;
}
function kr(e, r, t = [], o = [], n = [], s, a = !1, i = !1) {
  Oe(n, t, o, (l) => {
    var u = void 0,
      f = {},
      b = e.nodeName === mr,
    ...
    if (
      (he(() => {
        var x = r(...l.map(We)),
          m = Ar(e, u, x, s, a, i);
        d && b && 'value' in x && K(e, x.value);
        for (let p of Object.getOwnPropertySymbols(f)) x[p] || re(f[p]);
        for (let p of Object.getOwnPropertySymbols(x)) {
          var g = x[p];
          p.description === qe &&
            (!u || g !== u[p]) &&
            (f[p] && re(f[p]), (f[p] = ve(() => cr(e, () => g)))),
            (m[p] = g);
        }
        u = m;
      }),
...
function ne(e) {
  return (
    e.__attributes ??
    (e.__attributes = { [xe]: e.nodeName.includes('-'), [Ae]: e.namespaceURI === Be })
  );
}
var pe = new Map();
function ke(e) {
  ...
  for (var o, n = e, s = Element.prototype; s !== n; ) {
    o = $e(n);
    for (var a in o) o[a].set && t.push(a);
    n = Ue(n);
  }
  return t;
}
const se = '-',
  Cr = (e) => {
    ...
    return {
      getClassGroupId: (a) => {
        const i = a.split(se);
        return i[0] === '' && i.length !== 1 && i.shift(), Ce(i, r) || Sr(a);
      },
  ...
  Ce = (e, r) => {
    ...
    const t = e[0],
      o = r.nextPart.get(t),
      n = o ? Ce(e.slice(1), o) : void 0;
    if (n) return n;
    if (r.validators.length === 0) return;
    const s = e.join(se);
    return (a = r.validators.find(({ validator: i }) => i(s))) == null ? void 0 : a.classGroupId;
  },
  be = /^\[(.+)\]$/,
  Sr = (e) => {
    if (be.test(e)) {
  ...
  _r = (e) => {
    ...
    return (
      Tr(Object.entries(e.classGroups), t).forEach(([s, a]) => {
        te(a, o, s, r);
      }),
      o
    );
      ...
      ? e.map(([t, o]) => {
          const n = o.map((s) =>
            typeof s == 'string'
              ? r + s
              : typeof s == 'object'
                ? Object.fromEntries(Object.entries(s).map(([a, i]) => [r + a, i]))
                : s,
          );
          return [t, n];
        })
  ...
  Nr = (e) => {
    const { separator: r, experimentalParseClassName: t } = e,
      ...
      a = (i) => {
        ...
        const d = l.length === 0 ? i : i.substring(f),
          C = d.startsWith(Se),
          x = C ? d.substring(1) : d,
          m = b && b > f ? b - f : void 0;
        return {
  ...
  Er = (e) => ({ cache: Mr(e.cacheSize), parseClassName: Nr(e), ...Cr(e) }),
  Gr = /\s+/,
  Pr = (e, r) => {
...
function Rr() {
  let e = 0,
    ...
    t,
    o = '';
  for (; e < arguments.length; ) (r = arguments[e++]) && (t = _e(r)) && (o && (o += ' '), (o += t));
  return o;
}
const _e = (e) => {
  ...
  let r,
    t = '';
  for (let o = 0; o < e.length; o++) e[o] && (r = _e(e[o])) && (t && (t += ' '), (t += r));
  return t;
};
function Lr(e, ...r) {
  let t,
    ...
    s = a;
  function a(l) {
    const u = r.reduce((f, b) => b(f), e());
    return (t = Er(u)), (o = t.cache.get), (n = t.cache.set), (s = i), i(l);
  }
  function i(l) {
    const u = o(l);
    if (u) return u;
...
const w = (e) => {
  ...
  M = (e) => R(e) || Or.has(e) || jr.test(e),
  I = (e) => L(e, 'length', Jr),
  R = (e) => !!e && !Number.isNaN(Number(e)),
  ee = (e) => L(e, 'number', R),
  U = (e) => !!e && Number.isInteger(Number(e)),
  $r = (e) => e.endsWith('%') && R(e.slice(0, -1)),
  c = (e) => ze.test(e),
  E = (e) => Vr.test(e),
  Fr = new Set(['length', 'size', 'percentage']),
  Hr = (e) => L(e, Fr, Te),
  Kr = (e) => L(e, 'position', Te),
  Yr = new Set(['image', 'url']),
  Xr = (e) => L(e, Yr, Dr),
  Zr = (e) => L(e, '', Qr),
  W = () => !0,
  L = (e, r, t) => {
  ...
  et = () => {
    const e = w('colors'),
      ...
      O = () => ['', '0', c],
      ce = () => ['auto', 'avoid', 'all', 'avoid-page', 'page', 'left', 'right', 'column'],
      T = () => [R, c];
    return {
      cacheSize: 500,
      separator: ':',
      theme: {
        ...
        gradientColorStopPositions: [$r, I],
        inset: j(),
        margin: j(),
        opacity: T(),
        padding: v(),
      ...
      classGroups: {
        ...
        grow: [{ grow: O() }],
        shrink: [{ shrink: O() }],
        order: [{ order: ['first', 'last', 'none', U, c] }],
        'grid-cols': [{ 'grid-cols': [W] }],
        'col-start-end': [{ col: ['auto', { span: ['full', U, c] }, c] }],
        'col-start': [{ 'col-start': F() }],
        'col-end': [{ 'col-end': F() }],
        'grid-rows': [{ 'grid-rows': [W] }],
        'row-start-end': [{ row: ['auto', { span: [U, c] }, c] }],
        ...
        'max-w': [
          { 'max-w': [c, r, 'none', 'full', 'min', 'max', 'fit', 'prose', { screen: [E] }, E] },
        ],
        ...
        'line-clamp': [{ 'line-clamp': ['none', R, ee] }],
        leading: [{ leading: ['none', 'tight', 'snug', 'normal', 'relaxed', 'loose', M, c] }],
        ...
        'text-decoration-thickness': [{ decoration: ['auto', 'from-font', M, I] }],
        'underline-offset': [{ 'underline-offset': ['auto', M, c] }],
        ...
        'bg-position': [{ bg: [...ae(), Kr] }],
        'bg-repeat': [{ bg: ['no-repeat', { repeat: ['', 'x', 'y', 'round', 'space'] }] }],
        'bg-size': [{ bg: ['auto', 'cover', 'contain', Hr] }],
        'bg-image': [
          { bg: ['none', { 'gradient-to': ['t', 'tr', 'r', 'br', 'b', 'bl', 'l', 'tl'] }, Xr] },
        ],
        'bg-color': [{ bg: [e] }],
        ...
        'outline-offset': [{ 'outline-offset': [M, c] }],
        'outline-w': [{ outline: [M, I] }],
        ...
        contrast: [{ contrast: [l] }],
        'drop-shadow': [{ 'drop-shadow': ['', 'none', E, c] }],
...
var ot = Ne('<button><!></button>');
function ut(e, r) {
  Xe(r, !0);
  let t = J(r, 'variant', 3, 'default'),
    o = J(r, 'size', 3, 'default'),
    n = J(r, 'class', 3, ''),
    s = ar(r, ['$$slots', '$$events', '$$legacy', 'variant', 'size', 'class', 'children']);
  const a = {
  ...
  var u = Je(l);
  lr(u, () => r.children ?? Qe), De(l), Me(e, l), Ze();
}
export {
  ut as B,
  lr as a,
