...
import { c as V } from './GyiQ32Z2.js';
const W = {
  get(e, r) {
...
const X = {
  ...
  set(e, r, s) {
    ...
    return e.special[r](s), m(e.version), !0;
  },
  getOwnPropertyDescriptor(e, r) {
    if (!e.exclude.includes(r) && r in e.props)
      return { enumerable: !0, configurable: !0, value: e.props[r] };
...
function ee(e, r) {
  return new Proxy({ props: e, exclude: r, special: {}, version: M(0), parent_effect: S }, X);
}
const F = {
  get(e, r) {
...
function H(e, r, s, n) {
  ...
  if (t) {
    var L = D in e || E in e;
    a = ((x = h(e, r)) == null ? void 0 : x.set) ?? (L && r in e ? (u) => (e[r] = u) : void 0);
  }
  var o,
    b = !1;
  t ? ([o, b] = V(() => e[r])) : (o = e[r]),
    o === void 0 && n !== void 0 && ((o = w()), a && (i && K(), a(o)));
  var l;
  if (
    (i
      ? (l = () => {
          var u = e[r];
          return u === void 0 ? w() : ((v = !0), u);
        })
      : (l = () => {
          var u = e[r];
  ...
  if (a) {
    var T = e.$$legacy;
    return function (u, d) {
      return arguments.length > 0 ? ((!i || !d || T || b) && a(d ? l() : u), u) : l();
    };
  }
  var P = !1,
    c = ((s & q) !== 0 ? z : C)(() => ((P = !1), l()));
  ...
  return function (u, d) {
    if (arguments.length > 0) {
      const O = d ? _(c) : i && t ? Y(u) : u;
      return y(c, O), (P = !0), f !== void 0 && (f = O), u;
    }
    return (B && P) || (g.f & j) !== 0 ? c.v : _(c);
  };
}
export { ee as l, H as p, k as r, re as s };
