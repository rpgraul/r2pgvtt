import {
  box
} from "./chunk-YAZW4K7X.js";
import {
  MediaQuery
} from "./chunk-ZFT3MUSV.js";
import "./chunk-2APAILOV.js";
...
import {
  ...
  prop,
  set_attribute
} from "./chunk-EEJWA6UK.js";
import "./chunk-U7P2NEEE.js";
import {
  append,
  comment,
  from_html
} from "./chunk-YYEX7VQH.js";
import {
  on
} from "./chunk-AUSLSB2Z.js";
import {
  FILENAME,
  HMR,
  add_svelte_meta,
  ...
  user_effect,
  user_pre_effect
} from "./chunk-XN3RWHDP.js";
import "./chunk-XGCWAT63.js";
import {
  true_default
} from "./chunk-HNWPC2PS.js";
import "./chunk-OIX6GFKX.js";
...
var PersistedState = class {
  constructor(key, initialValue, options = {}) {
    ...
    __privateAdd(this, _version, tag(state(0), "PersistedState.#version"));
...
var UserPrefersMode = class {
  constructor() {
    ...
    __privateAdd(this, _persisted, tag(state(proxy(__privateMethod(this, _UserPrefersMode_instances, makePersisted_fn).call(this))), "UserPrefersMode.#persisted"));
    effect_root(() => {
...
var SystemPrefersMode = class {
  constructor() {
    ...
    __privateAdd(this, _current2, tag(state(proxy(__privateGet(this, _defaultValue2))), "SystemPrefersMode.#current"));
...
var CustomTheme = class {
  constructor() {
    ...
    __privateAdd(this, _persisted2, tag(state(proxy(__privateMethod(this, _CustomTheme_instances, makePersisted_fn2).call(this))), "CustomTheme.#persisted"));
    effect_root(() => {
...
if (import.meta.hot) {
  Mode_watcher_lite = hmr(Mode_watcher_lite);
  import.meta.hot.accept((module) => {
    Mode_watcher_lite[HMR].update(module.default);
  });
}
...
function Mode_watcher_full($$anchor, $$props) {
  ...
  head("1funsus", ($$anchor2) => {
    ...
    html(node_1, () => `<script${trueNonce() ? ` nonce=${trueNonce()}` : ""}>(` + setInitialMode.toString() + `)(` + JSON.stringify($$props.initConfig) + `);<\/script>`, void 0, void 0, void 0, true);
    append($$anchor2, fragment);
  });
  return pop($$exports);
}
if (import.meta.hot) {
  Mode_watcher_full = hmr(Mode_watcher_full);
  import.meta.hot.accept((module) => {
    Mode_watcher_full[HMR].update(module.default);
  });
}
...
if (import.meta.hot) {
  Mode_watcher = hmr(Mode_watcher);
  import.meta.hot.accept((module) => {
    Mode_watcher[HMR].update(module.default);
  });
}
